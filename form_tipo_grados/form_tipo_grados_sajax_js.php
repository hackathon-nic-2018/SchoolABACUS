  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_grados" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate tipo_grado_id_
  function do_ajax_form_tipo_grados_validate_tipo_grado_id_(iNumLinha)
  {
    var nomeCampo_tipo_grado_id_ = "tipo_grado_id_" + iNumLinha;
    var var_tipo_grado_id_ = scAjaxGetFieldText(nomeCampo_tipo_grado_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_grados_validate_tipo_grado_id_(var_tipo_grado_id_, iNumLinha, var_script_case_init, do_ajax_form_tipo_grados_validate_tipo_grado_id__cb);
  } // do_ajax_form_tipo_grados_validate_tipo_grado_id_

  function do_ajax_form_tipo_grados_validate_tipo_grado_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_grado_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_grado_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "tipo_grado_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_grado_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_grados_validate_tipo_grado_id__cb

  // ---------- Validate descripcion_
  function do_ajax_form_tipo_grados_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_grados_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_tipo_grados_validate_descripcion__cb);
  } // do_ajax_form_tipo_grados_validate_descripcion_

  function do_ajax_form_tipo_grados_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_grados_validate_descripcion__cb

  // ---------- Validate colegio_id_
  function do_ajax_form_tipo_grados_validate_colegio_id_(iNumLinha)
  {
    var nomeCampo_colegio_id_ = "colegio_id_" + iNumLinha;
    var var_colegio_id_ = scAjaxGetFieldSelect(nomeCampo_colegio_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_grados_validate_colegio_id_(var_colegio_id_, iNumLinha, var_script_case_init, do_ajax_form_tipo_grados_validate_colegio_id__cb);
  } // do_ajax_form_tipo_grados_validate_colegio_id_

  function do_ajax_form_tipo_grados_validate_colegio_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_grados_validate_colegio_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipo_grados_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipo_grados_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipo_grados_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipo_grados_add_new_line_cb);
  } // do_ajax_form_tipo_grados_add_new_line

  function do_ajax_form_tipo_grados_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tipo_grados_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipo_grados_backup_line(iNumLinha)
  {
    var var_colegio_id_ = scAjaxGetFieldSelect("colegio_id_" + iNumLinha);
    var var_tipo_grado_id_ = scAjaxGetFieldText("tipo_grado_id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_grados_backup_line(var_colegio_id_, var_tipo_grado_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipo_grados_backup_line_cb);
  } // do_ajax_form_tipo_grados_backup_line

  function do_ajax_form_tipo_grados_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipo_grados_backup_line_cb

  function do_ajax_form_tipo_grados_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipo_grados_cancel_insert

  function do_ajax_form_tipo_grados_cancel_update(iSeqVert)
  {
    do_ajax_form_tipo_grados_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipo_grados_cancel_update

  function do_ajax_form_tipo_grados_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipo_grados_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipo_grados_table_refresh()
  {
    var var_colegio_id_ = document.F2.colegio_id_.value;
    var var_tipo_grado_id_ = document.F2.tipo_grado_id_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_grados_table_refresh(var_colegio_id_, var_tipo_grado_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_grados_table_refresh_cb);
  } //  do_ajax_form_tipo_grados_table_refresh

  function do_ajax_form_tipo_grados_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipo_grado_id_.value = scAjaxGetKeyValue("tipo_grado_id_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipo_grados_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipo_grados_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipo_grados_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_tipo_grados_submit_form(var_tipo_grado_id_, var_descripcion_, var_colegio_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_grados_submit_form_cb);
  } // do_ajax_form_tipo_grados_submit_form

  function do_ajax_form_tipo_grados_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("tipo_grado_id_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_tipo_grados_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_grados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipo_grados_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("tipo_grado_id_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipo_grados_navigate_form(var_colegio_id_, var_tipo_grado_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_grados_navigate_form_cb);
  } // do_ajax_form_tipo_grados_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_grados']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_grados_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipo_grado_id_.value = scAjaxGetKeyValue("tipo_grado_id_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_tipo_grados_navigate_form_cb
  function sc_hide_form_tipo_grados_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tipo_grados_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "tipo_grado_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "colegio_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["tipo_grado_id_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
{
?>
    ajax_read_only["tipo_grado_id_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["tipo_grado_id_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["tipo_grado_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_grado_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_grado_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_grado_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_grado_id_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_grado_id_'])) ? $this->nmgp_cmp_readonly['tipo_grado_id_'] : 'on';
?>
    scAjaxFieldRead("tipo_grado_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("tipo_grado_id_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["tipo_grado_id_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["colegio_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_grado_id_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["tipo_grado_id_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["colegio_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["tipo_grado_id_" + iRow] = "off";
      ...
      $("#hidden_field_data_tipo_grado_id_" + iRow).removeClass("scFormErrorLine");
