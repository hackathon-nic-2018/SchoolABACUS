...
class grid_curso_asignaturas_por_docente_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_periodo_id;
   var $array_total_docente_id;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_periodo_id = array();
      $this->array_total_docente_id = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['phantomjs_export_process'] = false;

		return $chartFiles;
	} // generateChartImages

	function zipChartImages() {
		$chartImages = $this->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList) {
		require_once $this->Ini->path_third . '/zipfile/zipfile.php';

		$tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_curso_asignaturas_por_docente']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_curso_asignaturas_por_docente']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['contr_total_geral'] == "OK")
      {
          $this->array_total_periodo_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total']['periodo_id'];
          $this->array_total_docente_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total']['docente_id'];
      }
      else
      {
          $this->array_total_periodo_id = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total']['periodo_id'] = $this->array_total_periodo_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total']['docente_id'] = $this->array_total_docente_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       $Lab_periodo_id = "Periodo";
       $Lab_docente_id = "Docente";
       $this->comp_field = array(
           $Lab_periodo_id,
           $Lab_docente_id,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_order']['agrupacion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_order']['agrupacion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_order']['agrupacion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['summarizing_fields_display']['agrupacion'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_periodo_id as $i_periodo_id => $d_periodo_id) {
           if (!in_array($i_periodo_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_periodo_id[2] ] = $d_periodo_id[1];
               $this->comp_label[0][ $d_periodo_id[2] ] = $d_periodo_id[1];
           }
           foreach ($this->array_total_docente_id[$i_periodo_id] as $i_docente_id => $d_docente_id) {
               if (!in_array($i_docente_id, $this->comp_label[1][ $d_periodo_id[2] ], true)) {
                   $this->comp_index[1][ $d_docente_id[2] ] = $d_docente_id[1];
                   $this->comp_label[1][ $d_periodo_id[2] ][ $d_docente_id[2] ] = $d_docente_id[1];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'periodo_id', 'prot' => ''),
           array('name' => 'docente_id', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_periodo_id => $l_periodo_id) {
           if (isset($this->array_total_periodo_id[$i_periodo_id])) {
               $this->comp_group[$i_periodo_id] = array();
           }
           foreach ($this->comp_label[1][$i_periodo_id] as $i_docente_id => $l_docente_id) {
               if (isset($this->array_total_docente_id[$i_periodo_id][$i_docente_id])) {
                   $this->comp_group[$i_periodo_id][$i_docente_id] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_periodo_id;
       }
       elseif (1 == $level) {
           $return = $this->array_total_docente_id;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_curso_asignaturas_por_docente@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_curso_asignaturas_por_docente_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_curso_asignaturas_por_docente_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      {
         $this->monta_html_ini();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_curso_asignaturas_por_docente_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] = "print";
      ...
      $this->Total   = new grid_curso_asignaturas_por_docente_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_agrupacion("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_periodo_id);
      ksort($this->array_total_docente_id);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_curso_asignaturas_por_docente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_curso_asignaturas_por_docente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_curso_asignaturas_por_docente_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['ajax_nav'] && !$this->Ini->sc_export_ajax)
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_curso_asignaturas_por_docente_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_curso_asignaturas_por_docente_config_pivot.php?nome_apl=grid_curso_asignaturas_por_docente&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
      ...
      $nm_saida->saida("<input type=\"hidden\" name=\"script_case_session\" value=\"" . NM_encode_input(session_id()) . "\" />\r\n");
      $nm_saida->saida("</form> \r\n");
      $nm_saida->saida("<form name=\"FRES_chart_export_view\" method=\"get\" target=\"_blank\"></form>\r\n");
   ...
   $nm_saida->saida("</form> \r\n");
      ...
      $nm_saida->saida("           $('#TB_window').remove();\r\n");
      $nm_saida->saida("           $('body').append(\"<div id='TB_window'></div>\");\r\n");
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__cor_print=\" + cor + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("               $('#TB_window').remove();\r\n");
   $nm_saida->saida("               $('body').append(\"<div id='TB_window'></div>\");\r\n");
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("      else\r\n");
      $nm_saida->saida("      {\r\n");
      $nm_saida->saida("          window.location = \"" . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g + '&chart_level=' + chart_level;\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_curso_asignaturas_por_docente_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_curso_asignaturas_por_docente/grid_curso_asignaturas_por_docente_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_curso_asignaturas_por_docente']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_periodo_id, $quebra_docente_id, $quebra_periodo_id_orig, $quebra_docente_id_orig)
   {
      //----- Periodo
      if (!isset($this->array_total_periodo_id[$quebra_periodo_id_orig]))
      {
         $this->array_total_periodo_id[$quebra_periodo_id_orig][0] = 1;
         $this->array_total_periodo_id[$quebra_periodo_id_orig][1] = $quebra_periodo_id;
         $this->array_total_periodo_id[$quebra_periodo_id_orig][2] = $quebra_periodo_id_orig;
      }
      else
      {
         $this->array_total_periodo_id[$quebra_periodo_id_orig][0]++;
      }
      //----- Docente
      if (!isset($this->array_total_docente_id[$quebra_periodo_id_orig][$quebra_docente_id_orig]))
      {
         $this->array_total_docente_id[$quebra_periodo_id_orig][$quebra_docente_id_orig][0] = 1;
         $this->array_total_docente_id[$quebra_periodo_id_orig][$quebra_docente_id_orig][1] = $quebra_docente_id;
         $this->array_total_docente_id[$quebra_periodo_id_orig][$quebra_docente_id_orig][2] = $quebra_docente_id_orig;
      }
      else
      {
         $this->array_total_docente_id[$quebra_periodo_id_orig][$quebra_docente_id_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'periodo_id');
     $campos_order = $this->Ini->Get_date_order_groupby("periodo_id", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'docente_id');
     $campos_order = $this->Ini->Get_date_order_groupby("docente_id", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->periodo_id = $rs_res->fields[0] ;  
            $this->docente_id = $rs_res->fields[1] ;  
            $this->curso_id = $rs_res->fields[2] ;  
            $this->asignatura_id = $rs_res->fields[3] ;  
            $this->colegio_id = $rs_res->fields[4] ;  
            $this->comentarios = $rs_res->fields[5] ;  
            $this->look_periodo_id = $this->periodo_id; 
            $this->Lookup->lookup_periodo_id($this->look_periodo_id, $this->periodo_id, $_SESSION['vglo_colegio']) ; 
            $this->look_docente_id = $this->docente_id; 
            $this->Lookup->lookup_docente_id($this->look_docente_id, $this->docente_id, $_SESSION['vglo_colegio']) ; 
            $this->periodo_id_orig = $this->periodo_id;
            $this->docente_id_orig = $this->docente_id;
            $this->periodo_id = $this->look_periodo_id ;
            $this->docente_id = $this->look_docente_id ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->periodo_id, $this->docente_id, $this->periodo_id_orig,  $this->docente_id_orig);
            }
   }
//
