...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_curso_asignaturas_por_docente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_curso_asignaturas_por_docente"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_curso_asignaturas_por_docente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_curso_asignaturas_por_docente']['embutida_filho'] as $ind => $sc_init)
          {
