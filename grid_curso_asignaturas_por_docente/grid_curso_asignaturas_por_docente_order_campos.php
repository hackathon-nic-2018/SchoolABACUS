...
<?php
   ...
   $Ord_Cmp = new grid_curso_asignaturas_por_docente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_curso_asignaturas_por_docente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['periodo_id'] = "periodo_id";
   $tab_converte["periodo_id"]   = "periodo_id";
   $tab_labels["periodo_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["periodo_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["periodo_id"] : "Periodo";
   $tab_ger_campos['docente_id'] = "on";
   $tab_def_campos['docente_id'] = "docente_id";
   $tab_converte["docente_id"]   = "docente_id";
   $tab_labels["docente_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["docente_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["docente_id"] : "Docente";
   $tab_ger_campos['curso_id'] = "on";
   $tab_def_campos['curso_id'] = "curso_id";
   $tab_converte["curso_id"]   = "curso_id";
   $tab_labels["curso_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["curso_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["curso_id"] : "Curso";
   $tab_ger_campos['asignatura_id'] = "on";
   $tab_def_campos['asignatura_id'] = "asignatura_id";
   $tab_converte["asignatura_id"]   = "asignatura_id";
   $tab_labels["asignatura_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["asignatura_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['labels']["asignatura_id"] : "Asignatura";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_curso_asignaturas_por_docente_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_curso_asignaturas_por_docente']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
