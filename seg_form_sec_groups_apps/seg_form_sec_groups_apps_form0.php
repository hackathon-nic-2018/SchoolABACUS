...
<?php
    ...
    if (($opcao_botoes != "novo") && ('total' != $this->form_paginacao)) {
        $sCondStyle = ($this->nmgp_botoes['first'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "binicio_off", "scBtnFn_sys_format_ini()", "scBtnFn_sys_format_ini()", "sc_b_ini_off_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-2", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-3", "", "");?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ('total' != $this->form_paginacao)) {
        $sCondStyle = ($this->nmgp_botoes['back'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna_off", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_off_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-4", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-5", "", "");?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ('total' != $this->form_paginacao)) {
        $sCondStyle = ($this->nmgp_botoes['forward'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bavanca_off", "scBtnFn_sys_format_ava()", "scBtnFn_sys_format_ava()", "sc_b_avc_off_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-6", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-7", "", "");?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && ('total' != $this->form_paginacao)) {
        $sCondStyle = ($this->nmgp_botoes['last'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bfinal_off", "scBtnFn_sys_format_fim()", "scBtnFn_sys_format_fim()", "sc_b_fim_off_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "");?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "app_name")
      {
      ...
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_name\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_name\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_name\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-app_name\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'app_name')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a> <span class="scFormRequiredOddMult">*</span> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_access")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_access\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_access\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_access\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_access\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_access')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_access_-control" /> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_insert")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_insert\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_insert\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_insert\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_insert\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_insert')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_insert_-control" /> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_delete")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_delete\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_delete\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_delete\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_delete\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_delete')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_delete_-control" /> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_update")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_update\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_update\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_update\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_update\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_update')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_update_-control" /> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_export")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_export\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_export\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_export\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_export\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_export')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_export_-control" /> </TD>
   <?php } ?>
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_groups_apps']['ordem_cmp'] == "priv_print")
      {
      ...
      elseif ($this->Ini->Label_sort_pos == "right_field")
      {
          $link_img = $SC_Label . "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_print\" />";
      }
      elseif ($this->Ini->Label_sort_pos == "left_field")
      {
          $link_img = "<IMG SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_print\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "right_cell")
      {
          $link_img = "<IMG style=\"float: right\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_print\" />" . $SC_Label;
      }
      elseif ($this->Ini->Label_sort_pos == "left_cell")
      {
          $link_img = "<IMG style=\"float: left\" SRC=\"" . $this->Ini->path_img_global . "/" . $nome_img . "\" BORDER=\"0\" class=\"sc-ui-img-order-column\" id=\"sc-id-img-order-priv_print\" />" . $SC_Label;
      }
      ?>
<a href="javascript:nm_move('ordem', 'priv_print')" class="scFormLabelLink scFormLabelLinkOddMult"><?php echo $link_img ?></a><br /><input type="checkbox" id="sc-ui-checkbox-priv_print_-control" /> </TD>
   <?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOddMult css_app_name__line" id="hidden_field_data_app_name_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_app_name_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_app_name__line" style="vertical-align: top;padding: 0px"><span id="id_read_on_app_name_<?php echo $sc_seq_vert ?> css_app_name__line" style="<?php echo $sStyleReadLab_app_name_; ?>"><?php echo $this->form_encode_input($this->app_name_); ?></span><span id="id_read_off_app_name_<?php echo $sc_seq_vert ?>" style="<?php echo $sStyleReadInp_app_name_; ?>"><span id="id_ajax_label_app_name_<?php echo $sc_seq_vert; ?>"><?php echo $app_name_?></span>
</span><input type="hidden" name="app_name_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($app_name_); ?>">
...
$priv_insert__look = "";
 if (in_array("Y", $this->priv_insert__1))  { $priv_insert__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_insert_<?php echo $sc_seq_vert ; ?>" class="css_priv_insert__line" style="<?php echo $sStyleReadLab_priv_insert_; ?>"><?php echo $this->form_encode_input($priv_insert__look); ?></span><span id="id_read_off_priv_insert_<?php echo $sc_seq_vert ; ?>" class="css_priv_insert__line" style="<?php echo $sStyleReadInp_priv_insert_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_insert_" . $sc_seq_vert . "\" style=\"display: inline-block\" class=\"css_priv_insert__line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
$priv_delete__look = "";
 ...
 if (empty($priv_delete__look)) { $priv_delete__look = $this->priv_delete_; }
?>
<span id="id_read_on_priv_delete_<?php echo $sc_seq_vert ; ?>" class="css_priv_delete__line" style="<?php echo $sStyleReadLab_priv_delete_; ?>"><?php echo $this->form_encode_input($priv_delete__look); ?></span><span id="id_read_off_priv_delete_<?php echo $sc_seq_vert ; ?>" class="css_priv_delete__line" style="<?php echo $sStyleReadInp_priv_delete_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_delete_" . $sc_seq_vert . "\" style=\"display: inline-block\" class=\"css_priv_delete__line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
$priv_update__look = "";
 ...
 if (empty($priv_update__look)) { $priv_update__look = $this->priv_update_; }
?>
<span id="id_read_on_priv_update_<?php echo $sc_seq_vert ; ?>" class="css_priv_update__line" style="<?php echo $sStyleReadLab_priv_update_; ?>"><?php echo $this->form_encode_input($priv_update__look); ?></span><span id="id_read_off_priv_update_<?php echo $sc_seq_vert ; ?>" class="css_priv_update__line" style="<?php echo $sStyleReadInp_priv_update_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_update_" . $sc_seq_vert . "\" style=\"display: inline-block\" class=\"css_priv_update__line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
$priv_export__look = "";
 if (in_array("Y", $this->priv_export__1))  { $priv_export__look .= "" . $this->Ini->Nm_lang['lang_opt_yes'] . "<br />";} 
?>
<span id="id_read_on_priv_export_<?php echo $sc_seq_vert ; ?>" class="css_priv_export__line" style="<?php echo $sStyleReadLab_priv_export_; ?>"><?php echo $this->form_encode_input($priv_export__look); ?></span><span id="id_read_off_priv_export_<?php echo $sc_seq_vert ; ?>" class="css_priv_export__line" style="<?php echo $sStyleReadInp_priv_export_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_export_" . $sc_seq_vert . "\" style=\"display: inline-block\" class=\"css_priv_export__line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
$priv_print__look = "";
 ...
 if (empty($priv_print__look)) { $priv_print__look = $this->priv_print_; }
?>
<span id="id_read_on_priv_print_<?php echo $sc_seq_vert ; ?>" class="css_priv_print__line" style="<?php echo $sStyleReadLab_priv_print_; ?>"><?php echo $this->form_encode_input($priv_print__look); ?></span><span id="id_read_off_priv_print_<?php echo $sc_seq_vert ; ?>" class="css_priv_print__line" style="<?php echo $sStyleReadInp_priv_print_; ?>"><?php echo "<div id=\"idAjaxCheckbox_priv_print_" . $sc_seq_vert . "\" style=\"display: inline-block\" class=\"css_priv_print__line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "balterarsel", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-9", "", "");?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bvoltar", "scBtnFn_sys_format_sai()", "scBtnFn_sys_format_sai()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-11", "", "");?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_ini() {
		...
		if ($("#sc_b_ini_off_t.sc-unique-btn-2").length && $("#sc_b_ini_off_t.sc-unique-btn-2").is(":visible")) {
			nm_move ('inicio');
			 return;
		}
	}
	function scBtnFn_sys_format_ret() {
		if ($("#sc_b_ret_t.sc-unique-btn-3").length && $("#sc_b_ret_t.sc-unique-btn-3").is(":visible")) {
			nm_move ('retorna');
			 return;
		}
		if ($("#sc_b_ret_off_t.sc-unique-btn-4").length && $("#sc_b_ret_off_t.sc-unique-btn-4").is(":visible")) {
			nm_move ('retorna');
			 return;
		}
	}
	function scBtnFn_sys_format_ava() {
		if ($("#sc_b_avc_t.sc-unique-btn-5").length && $("#sc_b_avc_t.sc-unique-btn-5").is(":visible")) {
			nm_move ('avanca');
			 return;
		}
		if ($("#sc_b_avc_off_t.sc-unique-btn-6").length && $("#sc_b_avc_off_t.sc-unique-btn-6").is(":visible")) {
			nm_move ('avanca');
			 return;
		}
	}
	function scBtnFn_sys_format_fim() {
		if ($("#sc_b_fim_t.sc-unique-btn-7").length && $("#sc_b_fim_t.sc-unique-btn-7").is(":visible")) {
			nm_move ('final');
			 return;
		}
		if ($("#sc_b_fim_off_t.sc-unique-btn-8").length && $("#sc_b_fim_off_t.sc-unique-btn-8").is(":visible")) {
			nm_move ('final');
			 return;
		}
	}
