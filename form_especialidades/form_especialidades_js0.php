...
<input type="hidden" name="especialidad_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['especialidad_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_especialidades"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_especialidades_submit_form(y, z); 
} 
<?php
}
?>
