...
$old_error_handler = set_error_handler("form_especialidades_scriptcase_error_handler");

function form_especialidades_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_especialidades']['contr_erro']) && $_SESSION['scriptcase']['form_especialidades']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_especialidades->contr_form_especialidades->Apl_com_erro = true;
            if ($inicial_form_especialidades->contr_form_especialidades->NM_ajax_flag)
            {
                $inicial_form_especialidades->contr_form_especialidades->NM_ajax_info['errList']['geral_form_especialidades'][] = $msg;
                return;
            }
            form_especialidades_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_especialidades_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_especialidades'])  && '' != $_SESSION['scriptcase']['error_icon']['form_especialidades'])  ? $_SESSION['scriptcase']['error_icon']['form_especialidades']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_especialidades']) && '' != $_SESSION['scriptcase']['error_span_title']['form_especialidades']) ? $_SESSION['scriptcase']['error_span_title']['form_especialidades'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_especialidades']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_especialidades']) ? $_SESSION['scriptcase']['error_icon_title']['form_especialidades'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_especialidades']['error_buffer'] .= ob_get_flush();
}
