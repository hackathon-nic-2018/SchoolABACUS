...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_usuarios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_usuarios"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_usuarios'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_filho'] as $ind => $sc_init)
          {
