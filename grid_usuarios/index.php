...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "015019"; 
      $this->nm_autor_alt    = "erick"; 
      $this->nm_dt_ult_alt   = "20181130"; 
      $this->nm_hr_ult_alt   = "015030"; 
...
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_usuarios']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['grid_usuarios']['actual_lang']) || $_SESSION['scriptcase']['grid_usuarios']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['grid_usuarios']['actual_lang'] = $this->str_lang;
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['grid_search_add']['seq'] = $_POST['seq'];
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dyn_search_aut_comp']['cmp'] = $_GET['field'];
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['opcao'] = $_GET['origem'];
          $nmgp_opcao = $_GET['origem'];
      }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['compact_mode']    = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "form_usuarios";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_usuarios_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_usuarios_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/form_usuarios_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/form_usuarios_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["form_usuarios"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '';
      $this->sc_lig_target["A_@scinf__@scinf_form_usuarios"] = '';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_usuarios"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["grid_usuarios"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_form_usuarios =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('form_usuarios') . "/" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir']))
      {
...
// 
      ...
      if (isset($_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['grid_usuarios']['session_timeout']);
...
// 
      ...
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao'], $this->root . $this->path_prod, 'school_abacus'); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['grid_usuarios']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_usuarios']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_usuarios'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       {
                           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
          if (isset($vglo_colegio)) 
          {
              ...
              nm_limpa_str_grid_usuarios($_SESSION["vglo_colegio"]);
          }
      } 
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_pai'] = "";
      } 
      $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_usuarios_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida_ibase'] = true;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']['label'] = "" . $this->Ini->Nm_lang['lang_othr_grid_title'] . " usuarios";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_grid_usuarios_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['scroll_navigate_header_row'] = 1;
          }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_All_Groupby'] = array('sc_free_total' => 'grid');
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Labels_GB'] = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['conf_chart_level'] = "S";
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "usuario_nombre";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "tipo_usuario";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "usuario_correo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "activo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "clave";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['usr_cmp_sel']['clave'] = "off";
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opc_liga']['paginacao'];
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
...
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_grid_usuarios_html_" . session_id() . ".html";
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['ajax_nav'])
         {
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['opcao'] != "ajax_detalhe")  
             {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pdf_det'])
            {
            ...
            exec($str_execcmd2);
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['contr_total_geral']  = '';
            // ----- PDF log
...
<?php
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       foreach ($tmp as $cada_f)
       {
           ...
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']);
               continue;
           }
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word)
  {
      ...
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['word_file']);
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> usuarios :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_school_abacus.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_apl_default_school_abacus.txt"));
           if (isset($apl_def[0]) && $apl_def[0] != "grid_usuarios") {
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir'] = $path_aplicacao . "/" . $apl_def[0] . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? strtoupper($apl_def[1]) : "";
               $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['redir_tp'] = $Redir_tp;
           }
       }
       if (is_file($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt")) {
           $lang_atu = file_get_contents($root . $_SESSION['scriptcase']['grid_usuarios']['glo_nm_path_imag_temp'] . "/sc_actual_lang_" . $_SERVER['SERVER_NAME'] . ".txt");
           $_SESSION['scriptcase']['grid_usuarios']['session_timeout']['lang'] = $lang_atu;
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['grid_usuarios']['master_pai']) && $_SESSION['sc_session'][$init_filho]['grid_usuarios']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['master_pai']))
   {
       ...
       $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['grid_usuarios']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['grid_usuarios']['embutida_form_full'] : false;
   ...
   elseif (isset($script_case_init))
   {
       ...
       unset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form_full']);
   ...
   $_SESSION['sc_session']['grid_usuarios']['show_skip_charts_option'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   ...
   { 
       ...
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['mostra_edit'] = "S";
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           {
               $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['grid_usuarios']['embutida_form_full'])
           {
