...
class grid_usuarios_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'][$field] = $cada_dado['value']; 
              }
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_usuarios_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_usuarios_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_usuarios_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_tipo_usuario')
      {
          $tipo_usuario = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_tipo_usuario($tipo_usuario);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_usuario_nombre')
      {
          $usuario_nombre = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_usuario_nombre($usuario_nombre);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_clave')
      {
          $clave = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_clave($clave);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> usuarios</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_usuarios/grid_usuarios_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_usuarios_ajax_search.js"></script>
 <script type="text/javascript" src="grid_usuarios_ajax.js"></script>
 <script type="text/javascript">
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_tipo_usuario_cond#NMF#' + search_get_sel_txt('SC_tipo_usuario_cond') + '@NMF@';
  str_out += 'SC_tipo_usuario#NMF#' + search_get_text('SC_tipo_usuario') + '@NMF@';
  str_out += 'id_ac_tipo_usuario#NMF#' + search_get_text('id_ac_tipo_usuario') + '@NMF@';
  ...
  str_out += 'SC_usuario_nombre_cond#NMF#' + search_get_sel_txt('SC_usuario_nombre_cond') + '@NMF@';
  str_out += 'SC_usuario_nombre#NMF#' + search_get_text('SC_usuario_nombre') + '@NMF@';
  str_out += 'id_ac_usuario_nombre#NMF#' + search_get_text('id_ac_usuario_nombre') + '@NMF@';
  str_out += 'SC_clave_cond#NMF#' + search_get_sel_txt('SC_clave_cond') + '@NMF@';
  str_out += 'SC_clave#NMF#' + search_get_text('SC_clave') + '@NMF@';
  str_out += 'id_ac_clave#NMF#' + search_get_text('id_ac_clave') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   ...
   $("#id_ac_usuario_nombre").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_usuario_nombre",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_usuario_nombre").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_usuario_nombre").val( $(this).val() );
       }
     }
   });
   $("#id_ac_tipo_usuario").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_tipo_usuario",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_tipo_usuario").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_tipo_usuario").val( $(this).val() );
       }
     }
   });
   $("#id_ac_clave").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_clave",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> usuarios</div>
...
<?php
   ...
   {
      global 
             $tipo_usuario_cond, $tipo_usuario, $tipo_usuario_autocomp,
             $usuario_cond, $usuario, $usuario_autocomp,
             $usuario_nombre_cond, $usuario_nombre, $usuario_nombre_autocomp,
             $clave_cond, $clave, $clave_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tipo_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['tipo_usuario']; 
          $tipo_usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['tipo_usuario_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_cond']; 
          $usuario_nombre = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_nombre']; 
          $usuario_nombre_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_nombre_cond']; 
          $clave = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['clave']; 
          $clave_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['clave_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['NM_operador']; 
      } 
      if (!isset($tipo_usuario_cond) || empty($tipo_usuario_cond))
      {
         $tipo_usuario_cond = "qp";
      }
      if (!isset($usuario_cond) || empty($usuario_cond))
      {
         $usuario_cond = "qp";
      }
      if (!isset($usuario_nombre_cond) || empty($usuario_nombre_cond))
      {
         $usuario_nombre_cond = "qp";
      }
      if (!isset($clave_cond) || empty($clave_cond))
      {
         $clave_cond = "qp";
      }
      ...
      $str_hide_tipo_usuario = (in_array($tipo_usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usuario = (in_array($usuario_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usuario_nombre = (in_array($usuario_nombre_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_clave = (in_array($clave_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($tipo_usuario) || $tipo_usuario == "")
      {
          $tipo_usuario = "";
      }
      if (isset($tipo_usuario) && !empty($tipo_usuario))
      {
         $tmp_pos = strpos($tipo_usuario, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $tipo_usuario = substr($tipo_usuario, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($usuario_nombre) || $usuario_nombre == "")
      {
          $usuario_nombre = "";
      }
      if (isset($usuario_nombre) && !empty($usuario_nombre))
      {
         $tmp_pos = strpos($usuario_nombre, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $usuario_nombre = substr($usuario_nombre, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($clave, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $clave = substr($clave, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipo_usuario'])) ? $this->New_label['tipo_usuario'] : "Tipo Usuario"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_tipo_usuario_cond" name="tipo_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_usuario'), this, 'tipo_usuario')">
       <OPTION value="qp" <?php if ("qp" == $tipo_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $tipo_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $tipo_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $tipo_usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipo_usuario" <?php echo $str_hide_tipo_usuario?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['tipo_usuario'])) ? $this->New_label['tipo_usuario'] : "Tipo Usuario";
 $nmgp_tab_label .= "tipo_usuario?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($tipo_usuario != "")
      ...
      {
          $sAutocompValue = $tipo_usuario;
      }
?>
<INPUT  type="text" id="SC_tipo_usuario" name="tipo_usuario" value="<?php echo NM_encode_input($tipo_usuario) ?>" size=1 alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_tipo_usuario" name="tipo_usuario_autocomp" size="1" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 1, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['usuario'])) ? $this->New_label['usuario'] : "Usuario"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_usuario_cond" name="usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario'), this, 'usuario')">
       <OPTION value="qp" <?php if ("qp" == $usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usuario_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usuario" <?php echo $str_hide_usuario?> valign="top">
...
?>
<INPUT  type="text" id="SC_usuario" name="usuario" value="<?php echo NM_encode_input($usuario) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['usuario_nombre'])) ? $this->New_label['usuario_nombre'] : "Usuario Nombre"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_usuario_nombre_cond" name="usuario_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario_nombre'), this, 'usuario_nombre')">
       <OPTION value="qp" <?php if ("qp" == $usuario_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $usuario_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $usuario_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $usuario_nombre_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usuario_nombre" <?php echo $str_hide_usuario_nombre?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['usuario_nombre'])) ? $this->New_label['usuario_nombre'] : "Usuario Nombre";
 $nmgp_tab_label .= "usuario_nombre?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($usuario_nombre != "")
      ...
      {
          $sAutocompValue = $usuario_nombre;
      }
?>
<INPUT  type="text" id="SC_usuario_nombre" name="usuario_nombre" value="<?php echo NM_encode_input($usuario_nombre) ?>" size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_usuario_nombre" name="usuario_nombre_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['clave'])) ? $this->New_label['clave'] : "Clave"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_clave_cond" name="clave_cond" onChange="nm_campos_between(document.getElementById('id_vis_clave'), this, 'clave')">
       <OPTION value="qp" <?php if ("qp" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $clave_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_clave" <?php echo $str_hide_clave?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['clave'])) ? $this->New_label['clave'] : "Clave";
 $nmgp_tab_label .= "clave?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($clave != "")
      ...
      {
          $sAutocompValue = $clave;
      }
?>
<INPUT  type="text" id="SC_clave" name="clave" value="<?php echo NM_encode_input($clave) ?>" size=50 alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_clave" name="clave_autocomp" size="50" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 250, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_usuarios_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_usuarios']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_usuarios']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_tipo_usuario'), document.F1.tipo_usuario_cond, 'tipo_usuario');
   document.F1.tipo_usuario.value = "";
   document.F1.tipo_usuario_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_usuario_nombre'), document.F1.usuario_nombre_cond, 'usuario_nombre');
   document.F1.usuario_nombre.value = "";
   document.F1.usuario_nombre_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_clave'), document.F1.clave_cond, 'clave');
   document.F1.clave.value = "";
   document.F1.clave_autocomp.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_tipo_usuario_cond'] = 'cond';
      $tp_fields['SC_tipo_usuario'] = 'text_aut';
      $tp_fields['id_ac_tipo_usuario'] = 'text_aut';
      $tp_fields['SC_usuario_cond'] = 'cond';
      $tp_fields['SC_usuario'] = 'text_aut';
      $tp_fields['id_ac_usuario'] = 'text_aut';
      $tp_fields['SC_usuario_nombre_cond'] = 'cond';
      $tp_fields['SC_usuario_nombre'] = 'text_aut';
      $tp_fields['id_ac_usuario_nombre'] = 'text_aut';
      $tp_fields['SC_clave_cond'] = 'cond';
      $tp_fields['SC_clave'] = 'text_aut';
      $tp_fields['id_ac_clave'] = 'text_aut';
   ...
   {
      global $tipo_usuario_cond, $tipo_usuario, $tipo_usuario_autocomp,
             $usuario_cond, $usuario, $usuario_autocomp,
             $usuario_nombre_cond, $usuario_nombre, $usuario_nombre_autocomp,
             $clave_cond, $clave, $clave_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $C_formatado = false;
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq'] = array();
      if (!empty($tipo_usuario_autocomp) && empty($tipo_usuario))
      {
          $tipo_usuario = $tipo_usuario_autocomp;
      }
      if (!empty($usuario_autocomp) && empty($usuario))
      {
          $usuario = $usuario_autocomp;
      }
      if (!empty($usuario_nombre_autocomp) && empty($usuario_nombre))
      {
          $usuario_nombre = $usuario_nombre_autocomp;
      }
      if (!empty($clave_autocomp) && empty($clave))
      {
          $clave = $clave_autocomp;
      }
      $tipo_usuario_cond_salva = $tipo_usuario_cond; 
      if (!isset($tipo_usuario_input_2) || $tipo_usuario_input_2 == "")
      {
          $tipo_usuario_input_2 = $tipo_usuario;
      }
      ...
      $usuario_nombre_cond_salva = $usuario_nombre_cond; 
      if (!isset($usuario_nombre_input_2) || $usuario_nombre_input_2 == "")
      {
          $usuario_nombre_input_2 = $usuario_nombre;
      }
      $clave_cond_salva = $clave_cond; 
      if (!isset($clave_input_2) || $clave_input_2 == "")
      {
          $clave_input_2 = $clave;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['tipo_usuario'] = $tipo_usuario; 
      if (is_array($tipo_usuario) && !empty($tipo_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $tipo_usuario;
      }
      elseif ($tipo_usuario_cond_salva == "nu" || $tipo_usuario_cond_salva == "nn" || $tipo_usuario_cond_salva == "ep" || $tipo_usuario_cond_salva == "ne" ||  !empty($tipo_usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $tipo_usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['tipo_usuario_cond'] = $tipo_usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "tipo_usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $tipo_usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['tipo_usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario'] = $usuario; 
      if (is_array($usuario) && !empty($usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $usuario;
      }
      elseif ($usuario_cond_salva == "nu" || $usuario_cond_salva == "nn" || $usuario_cond_salva == "ep" || $usuario_cond_salva == "ne" ||  !empty($usuario))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $usuario;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "usuario"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $usuario_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['usuario'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_nombre'] = $usuario_nombre; 
      if (is_array($usuario_nombre) && !empty($usuario_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $usuario_nombre;
      }
      elseif ($usuario_nombre_cond_salva == "nu" || $usuario_nombre_cond_salva == "nn" || $usuario_nombre_cond_salva == "ep" || $usuario_nombre_cond_salva == "ne" ||  !empty($usuario_nombre))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $usuario_nombre;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['usuario_nombre_cond'] = $usuario_nombre_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "usuario_nombre"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $usuario_nombre_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['usuario_nombre'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['clave'] = $clave; 
      if (is_array($clave) && !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0] = $clave;
      }
      elseif ($clave_cond_salva == "nu" || $clave_cond_salva == "nn" || $clave_cond_salva == "ep" || $clave_cond_salva == "ne" ||  !empty($clave))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['val'][0][0] = $clave;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['clave_cond'] = $clave_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['cmp'] = "clave"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid]['opc'] = $clave_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['grid_pesq']['clave'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['tipo_usuario'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['tipo_usuario'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['tipo_usuario'] = $tipo_usuario;
      }
      $usuario_look = substr($this->Db->qstr($usuario), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct usuario from " . $this->Ini->nm_tabela . " where colegio_id = " . $_SESSION['vglo_colegio'] . " and usuario = '$usuario_look' order by usuario"; 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['usuario_nombre'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['usuario_nombre'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['usuario_nombre'] = $usuario_nombre;
      }
      $clave_look = substr($this->Db->qstr($clave), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct clave from " . $this->Ini->nm_tabela . " where colegio_id = " . $_SESSION['vglo_colegio'] . " and clave = '$clave_look' order by clave"; 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['clave'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['clave'] = $clave;
      }

      //----- $tipo_usuario
      $this->Date_part = false;
      if (isset($tipo_usuario) || $tipo_usuario_cond == "nu" || $tipo_usuario_cond == "nn" || $tipo_usuario_cond == "ep" || $tipo_usuario_cond == "ne")
      {
         $this->monta_condicao("tipo_usuario", $tipo_usuario_cond, $tipo_usuario, "", "tipo_usuario");
      }
      ...
      //----- $usuario_nombre
      $this->Date_part = false;
      if (isset($usuario_nombre) || $usuario_nombre_cond == "nu" || $usuario_nombre_cond == "nn" || $usuario_nombre_cond == "ep" || $usuario_nombre_cond == "ne")
      {
         $this->monta_condicao("usuario_nombre", $usuario_nombre_cond, $usuario_nombre, "", "usuario_nombre");
      }

      //----- $clave
      $this->Date_part = false;
      if (isset($clave) || $clave_cond == "nu" || $clave_cond == "nn" || $clave_cond == "ep" || $clave_cond == "ne")
      {
         $this->monta_condicao("clave", $clave_cond, $clave, "", "clave");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq'] = $this->comando;
       }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['where_pesq_ant'] = $this->comando . $this->comando_fim;
