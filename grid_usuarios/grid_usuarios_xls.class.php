...
class grid_usuarios_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Tit_doc    = "grid_usuarios" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      { 
          ...
          if ($Cada_col == "usuario_nombre" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
          ...
          if ($Cada_col == "tipo_usuario" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
          ...
          if ($Cada_col == "clave" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              if (!NM_is_utf8($SC_Label))
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['embutida'])
      { 
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->usuario_nombre = html_entity_decode($this->usuario_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuario_nombre = strip_tags($this->usuario_nombre);
         if (!NM_is_utf8($this->usuario_nombre))
         {
             $this->usuario_nombre = sc_convert_encoding($this->usuario_nombre, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuario_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tipo_usuario
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->look_tipo_usuario = html_entity_decode($this->look_tipo_usuario, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_tipo_usuario = strip_tags($this->look_tipo_usuario);
         if (!NM_is_utf8($this->look_tipo_usuario))
         {
             $this->look_tipo_usuario = sc_convert_encoding($this->look_tipo_usuario, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_tipo_usuario, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario_correo
   function NM_export_usuario_correo()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->usuario_correo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- activo
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->look_activo = html_entity_decode($this->look_activo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_activo = strip_tags($this->look_activo);
         if (!NM_is_utf8($this->look_activo))
         {
             $this->look_activo = sc_convert_encoding($this->look_activo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_activo, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- clave
   ...
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         $this->clave = html_entity_decode($this->clave, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->clave = strip_tags($this->clave);
         if (!NM_is_utf8($this->clave))
         {
             $this->clave = sc_convert_encoding($this->clave, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->clave, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- usuario
   ...
   //----- usuario_nombre
   function NM_sub_cons_usuario_nombre()
   {
         $this->usuario_nombre = html_entity_decode($this->usuario_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->usuario_nombre = strip_tags($this->usuario_nombre);
         if (!NM_is_utf8($this->usuario_nombre))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_nombre;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tipo_usuario
   function NM_sub_cons_tipo_usuario()
   {
         $this->look_tipo_usuario = html_entity_decode($this->look_tipo_usuario, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_tipo_usuario = strip_tags($this->look_tipo_usuario);
         if (!NM_is_utf8($this->look_tipo_usuario))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_tipo_usuario;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- usuario_correo
   function NM_sub_cons_usuario_correo()
   {
         if (!NM_is_utf8($this->usuario_correo))
         {
             $this->usuario_correo = sc_convert_encoding($this->usuario_correo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->usuario_correo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_activo()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_activo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_clave()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->clave;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> usuarios :: Excel</TITLE>
