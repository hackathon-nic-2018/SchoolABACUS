...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "colegio_id";$Nm_numeric[] = "colegio_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipo_usuario_cond" name="tipo_usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo_usuario'), this, 'tipo_usuario')">
      ...
      <br><span id="id_hide_tipo_usuario"  <?php echo $str_hide_tipo_usuario?>><?php
      if ($tipo_usuario != "")
      {
      $tipo_usuario_look = substr($this->Db->qstr($tipo_usuario), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_usuario_cond" name="usuario_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario'), this, 'usuario')">
      ...
      <br><span id="id_hide_usuario"  <?php echo $str_hide_usuario?>><?php
      if ($usuario != "")
      {
      $usuario_look = substr($this->Db->qstr($usuario), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usuario_nombre_cond" name="usuario_nombre_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario_nombre'), this, 'usuario_nombre')">
      ...
      <br><span id="id_hide_usuario_nombre"  <?php echo $str_hide_usuario_nombre?>><?php
      if ($usuario_nombre != "")
      {
      $usuario_nombre_look = substr($this->Db->qstr($usuario_nombre), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_clave_cond" name="clave_cond" onChange="nm_campos_between(document.getElementById('id_vis_clave'), this, 'clave')">
      ...
      <br><span id="id_hide_clave"  <?php echo $str_hide_clave?>><?php
      if ($clave != "")
      {
      $clave_look = substr($this->Db->qstr($clave), 1, -1); 
      $nmgp_def_dados = array(); 
