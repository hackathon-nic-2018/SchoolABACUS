...
class grid_usuarios_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_usuarios.rtf";
   }
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_name']);
      }
   ...
   function NM_export_usuario_nombre()
   {
         ...
         $this->usuario_nombre = str_replace('<', '&lt;', $this->usuario_nombre);
         $this->usuario_nombre = str_replace('>', '&gt;', $this->usuario_nombre);
         $this->Texto_tag .= "<td>" . $this->usuario_nombre . "</td>\r\n";
   }
   //----- tipo_usuario
   function NM_export_tipo_usuario()
   {
         ...
         $this->look_tipo_usuario = str_replace('<', '&lt;', $this->look_tipo_usuario);
         $this->look_tipo_usuario = str_replace('>', '&gt;', $this->look_tipo_usuario);
         $this->Texto_tag .= "<td>" . $this->look_tipo_usuario . "</td>\r\n";
   }
   //----- usuario_correo
   ...
   function NM_export_clave()
   {
         ...
         $this->clave = str_replace('>', '&gt;', $this->clave);
         $this->Texto_tag .= "<td>" . $this->clave . "</td>\r\n";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> usuarios :: RTF</TITLE>
