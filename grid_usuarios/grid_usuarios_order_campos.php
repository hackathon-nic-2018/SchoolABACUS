...
<?php
   ...
   $Ord_Cmp = new grid_usuarios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_usuarios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['usuario_nombre'] = "usuario_nombre";
   $tab_converte["usuario_nombre"]   = "usuario_nombre";
   $tab_labels["usuario_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["usuario_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["usuario_nombre"] : "Usuario Nombre";
   $tab_ger_campos['tipo_usuario'] = "on";
   $tab_def_campos['tipo_usuario'] = "tipo_usuario";
   $tab_converte["tipo_usuario"]   = "tipo_usuario";
   $tab_labels["tipo_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["tipo_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["tipo_usuario"] : "Tipo Usuario";
   $tab_ger_campos['usuario_correo'] = "on";
   $tab_def_campos['usuario_correo'] = "usuario_correo";
   $tab_converte["usuario_correo"]   = "usuario_correo";
   $tab_labels["usuario_correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["usuario_correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["usuario_correo"] : "Usuario Correo";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_converte["activo"]   = "activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_usuarios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_usuarios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_usuarios_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_usuarios']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
