...
class grid_asignaturas_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Tit_doc    = "grid_asignaturas" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['embutida'])
      { 
   ...
   function NM_export_asignatura_id()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->asignatura_id))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->asignatura_id);
         $this->Xls_col++;
   }
   //----- descripcion
   ...
   function NM_export_especialidad_id()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_especialidad_id))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_especialidad_id);
         $this->Xls_col++;
   }
   //----- reportar_gobierno
   function NM_export_reportar_gobierno()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_reportar_gobierno, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- colegio_id
   ...
   function NM_export_descripcion_detallada()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->descripcion_detallada, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- asignatura_id
   function NM_sub_cons_asignatura_id()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->asignatura_id;
   ...
   //----- reportar_gobierno
   function NM_sub_cons_reportar_gobierno()
   {
         $this->look_reportar_gobierno = html_entity_decode($this->look_reportar_gobierno, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_reportar_gobierno = strip_tags($this->look_reportar_gobierno);
         if (!NM_is_utf8($this->look_reportar_gobierno))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_reportar_gobierno;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- descripcion_detallada
   function NM_sub_cons_descripcion_detallada()
   {
         $this->descripcion_detallada = html_entity_decode($this->descripcion_detallada, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->descripcion_detallada = strip_tags($this->descripcion_detallada);
         if (!NM_is_utf8($this->descripcion_detallada))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->descripcion_detallada;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> asignaturas :: Excel</TITLE>
