...
class grid_asignaturas_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asignaturas']['arr_export']['data'];
