...
<?php
   ...
   $Ord_Cmp = new grid_asignaturas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_asignaturas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["asignatura_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["asignatura_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["asignatura_id"] : "Código";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_converte["descripcion"]   = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["descripcion"] : "Descripción";
   $tab_ger_campos['especialidad_id'] = "on";
   $tab_def_campos['especialidad_id'] = "especialidad_id";
   $tab_converte["especialidad_id"]   = "especialidad_id";
   $tab_labels["especialidad_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["especialidad_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["especialidad_id"] : "Especialidad";
   $tab_ger_campos['reportar_gobierno'] = "on";
   $tab_def_campos['reportar_gobierno'] = "reportar_gobierno";
   $tab_converte["reportar_gobierno"]   = "reportar_gobierno";
   $tab_labels["reportar_gobierno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["reportar_gobierno"])) ? $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['labels']["reportar_gobierno"] : "Reportar Gobierno";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> asignaturas</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_asignaturas_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_asignaturas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
