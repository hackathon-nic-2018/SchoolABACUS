<?php
class form_turnos_form extends form_turnos_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " turnos"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " turnos"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_turnos/form_turnos_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_turnos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_turnos_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['recarga'];
}
...
<?php
 include_once("form_turnos_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_turnos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_turnos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="scFormLabelOddMult"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['turno_id_']) && $this->nmgp_cmp_hidden['turno_id_'] == 'off') { $sStyleHidden_turno_id_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['turno_id_']) || $this->nmgp_cmp_hidden['turno_id_'] == 'on') {
      if (!isset($this->nm_new_label['turno_id_'])) {
          $this->nm_new_label['turno_id_'] = "Código"; } ?>

    <TD class="scFormLabelOddMult css_turno_id__label" id="hidden_field_label_turno_id_" style="<?php echo $sStyleHidden_turno_id_; ?>" > <?php echo $this->nm_new_label['turno_id_'] ?> </TD>
   <?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['colegio_id_']) && $this->nmgp_cmp_hidden['colegio_id_'] == 'off') { $sStyleHidden_colegio_id_ = 'display: none'; }
    ...
    <TD class="scFormLabelOddMult css_colegio_id__label" id="hidden_field_label_colegio_id_" style="<?php echo $sStyleHidden_colegio_id_; ?>" > <?php echo $this->nm_new_label['colegio_id_'] ?> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_turnos);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_turnos = $this->form_vert_form_turnos;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_turnos))
   {
       $sc_seq_vert = 0;
   }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['turno_id_']))
           {
               $this->nmgp_cmp_readonly['turno_id_'] = 'on';
           }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['colegio_id_']))
           {
               $this->nmgp_cmp_readonly['colegio_id_'] = 'on';
           }
   foreach ($this->form_vert_form_turnos as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['turno_id_'] = true;
           $this->nmgp_cmp_readonly['descripcion_'] = true;
           $this->nmgp_cmp_readonly['colegio_id_'] = true;
       }
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['turno_id_']) || $this->nmgp_cmp_readonly['turno_id_'] != "on") {$this->nmgp_cmp_readonly['turno_id_'] = false;}
        ...
        $this->turno_id_ = $this->form_vert_form_turnos[$sc_seq_vert]['turno_id_']; 
       $turno_id_ = $this->turno_id_; 
       $sStyleHidden_turno_id_ = '';
       if (isset($sCheckRead_turno_id_))
       {
           unset($sCheckRead_turno_id_);
       }
       if (isset($this->nmgp_cmp_readonly['turno_id_']))
       {
           $sCheckRead_turno_id_ = $this->nmgp_cmp_readonly['turno_id_'];
       }
       if (isset($this->nmgp_cmp_hidden['turno_id_']) && $this->nmgp_cmp_hidden['turno_id_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['turno_id_']);
           $sStyleHidden_turno_id_ = 'display: none;';
       }
       $bTestReadOnly_turno_id_ = true;
       $sStyleReadLab_turno_id_ = 'display: none;';
       $sStyleReadInp_turno_id_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["turno_id_"]) &&  $this->nmgp_cmp_readonly["turno_id_"] == "on"))
       {
           $bTestReadOnly_turno_id_ = false;
           unset($this->nmgp_cmp_readonly['turno_id_']);
           $sStyleReadLab_turno_id_ = '';
           $sStyleReadInp_turno_id_ = 'display: none;';
       }
       $this->descripcion_ = $this->form_vert_form_turnos[$sc_seq_vert]['descripcion_']; 
       ...
       $this->colegio_id_ = $this->form_vert_form_turnos[$sc_seq_vert]['colegio_id_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_turnos_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_turnos_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_turnos_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_turnos_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_turnos_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_turnos_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['turno_id_']) && $this->nmgp_cmp_hidden['turno_id_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="turno_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($turno_id_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_turno_id__line" id="hidden_field_data_turno_id_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_turno_id_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_turno_id__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_turno_id_ && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["turno_id_"]) &&  $this->nmgp_cmp_readonly["turno_id_"] == "on")) { 

 ?>
<input type="hidden" name="turno_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($turno_id_) . "\"><span id=\"id_ajax_label_turno_id_" . $sc_seq_vert . "\">" . $turno_id_ . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_turno_id_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-turno_id_<?php echo $sc_seq_vert ?> css_turno_id__line" style="<?php echo $sStyleReadLab_turno_id_; ?>"><?php echo $this->form_encode_input($this->turno_id_); ?></span><span id="id_read_off_turno_id_<?php echo $sc_seq_vert ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_turno_id_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_turno_id__obj" style="" id="id_sc_field_turno_id_<?php echo $sc_seq_vert ?>" type=text name="turno_id_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($turno_id_) ?>"
 size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['turno_id_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['turno_id_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['turno_id_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_turno_id_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_turno_id_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
        if (isset($sCheckRead_turno_id_))
       {
           $this->nmgp_cmp_readonly['turno_id_'] = $sCheckRead_turno_id_;
       }
       if ('display: none;' == $sStyleHidden_turno_id_)
       {
           $this->nmgp_cmp_hidden['turno_id_'] = 'off';
       }
       if (isset($sCheckRead_descripcion_))
       {
   ...
   { 
       ...
       $this->form_vert_form_turnos = $guarda_form_vert_form_turnos;
   } 
   if ($Table_refresh) 
   { 
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_turnos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_turnos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_turnos");
 parent.scAjaxDetailHeight("form_turnos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			do_ajax_form_turnos_add_new_line(); return false;
			 return;
		}
