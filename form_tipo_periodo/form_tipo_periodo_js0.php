...
<input type="hidden" name="tipo_periodo_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tipo_periodo_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tipo_periodo"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_tipo_periodo_submit_form(y, z); 
} 
<?php
}
?>
