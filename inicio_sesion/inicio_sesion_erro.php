...
$old_error_handler = set_error_handler("inicio_sesion_scriptcase_error_handler");

function inicio_sesion_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['inicio_sesion']['contr_erro']) && $_SESSION['scriptcase']['inicio_sesion']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_inicio_sesion->contr_inicio_sesion->Apl_com_erro = true;
            if ($inicial_inicio_sesion->contr_inicio_sesion->NM_ajax_flag)
            {
                $inicial_inicio_sesion->contr_inicio_sesion->NM_ajax_info['errList']['geral_inicio_sesion'][] = $msg;
                return;
            }
            inicio_sesion_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function inicio_sesion_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['inicio_sesion'])  && '' != $_SESSION['scriptcase']['error_icon']['inicio_sesion'])  ? $_SESSION['scriptcase']['error_icon']['inicio_sesion']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['inicio_sesion']) && '' != $_SESSION['scriptcase']['error_span_title']['inicio_sesion']) ? $_SESSION['scriptcase']['error_span_title']['inicio_sesion'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['inicio_sesion']) && '' != $_SESSION['scriptcase']['error_icon_title']['inicio_sesion']) ? $_SESSION['scriptcase']['error_icon_title']['inicio_sesion'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['inicio_sesion']['error_buffer'] .= ob_get_flush();
}
