...
<input type="hidden" id="sc-mobile-lock" value='true' />
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>inicio_sesion/inicio_sesion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("inicio_sesion_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('inicio_sesion_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['recarga'];
}
?>
...
<?php
 include_once("inicio_sesion_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['inicio_sesion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['inicio_sesion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_links_label" id="hidden_field_label_links" style="<?php echo $sStyleHidden_links; ?>"><span id="id_label_links"><?php echo $this->nm_new_label['links']; ?></span></TD>
    <TD class="scFormDataOdd css_links_line" id="hidden_field_data_links" style="<?php echo $sStyleHidden_links; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_links_line" style="vertical-align: top;padding: 0px">
...
<input type="hidden" name="links_sc_target_name" value = "">
 ...
 <a href="javascript:nm_menu_link_links('', '_self')">Grupo Abacus</a>
<?php  } ?>
</td><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none; position: absolute" id="id_error_display_links_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_links_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { ?>
<span id="id_read_on_pswd" class="sc-ui-readonly-pswd css_pswd_line" style="<?php echo $sStyleReadLab_pswd; ?>"><?php echo $this->form_encode_input($this->pswd); ?></span><span id="id_read_off_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_pswd; ?>">
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['inicio_sesion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("inicio_sesion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("inicio_sesion");
 parent.scAjaxDetailHeight("inicio_sesion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
