...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_links' + iSeqRow).bind('blur', function() { sc_inicio_sesion_links_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_inicio_sesion_links_onfocus(this, iSeqRow) });
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_inicio_sesion_login_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_inicio_sesion_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_inicio_sesion_pswd_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_inicio_sesion_pswd_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_inicio_sesion_links_onblur(oThis, iSeqRow) {
  do_ajax_inicio_sesion_validate_links();
  scCssBlur(oThis);
}

function sc_inicio_sesion_links_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_inicio_sesion_login_onblur(oThis, iSeqRow) {
  do_ajax_inicio_sesion_validate_login();
  scCssBlur(oThis);
}

function sc_inicio_sesion_login_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_inicio_sesion_pswd_onblur(oThis, iSeqRow) {
  do_ajax_inicio_sesion_validate_pswd();
  scCssBlur(oThis);
}

function sc_inicio_sesion_pswd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_inicio_sesion_form" + pageNo).hide();
}
