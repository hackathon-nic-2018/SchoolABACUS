  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_calificaciones_detalle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate linea_
  function do_ajax_form_tipo_calificaciones_detalle_validate_linea_(iNumLinha)
  {
    var nomeCampo_linea_ = "linea_" + iNumLinha;
    var var_linea_ = scAjaxGetFieldText(nomeCampo_linea_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_validate_linea_(var_linea_, iNumLinha, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_validate_linea__cb);
  } // do_ajax_form_tipo_calificaciones_detalle_validate_linea_

  function do_ajax_form_tipo_calificaciones_detalle_validate_linea__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "linea_" + iLineNumber;
    }
    else
    {
      sFieldValid = "linea_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "linea_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "linea_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_detalle_validate_linea__cb

  // ---------- Validate descripcion_
  function do_ajax_form_tipo_calificaciones_detalle_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_validate_descripcion__cb);
  } // do_ajax_form_tipo_calificaciones_detalle_validate_descripcion_

  function do_ajax_form_tipo_calificaciones_detalle_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_detalle_validate_descripcion__cb

  // ---------- Validate calificacion_maxima_
  function do_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima_(iNumLinha)
  {
    var nomeCampo_calificacion_maxima_ = "calificacion_maxima_" + iNumLinha;
    var var_calificacion_maxima_ = scAjaxGetFieldText(nomeCampo_calificacion_maxima_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima_(var_calificacion_maxima_, iNumLinha, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima__cb);
  } // do_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima_

  function do_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_maxima_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_maxima_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_maxima_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_maxima_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_detalle_validate_calificacion_maxima__cb

  // ---------- Validate colegio_id_
  function do_ajax_form_tipo_calificaciones_detalle_validate_colegio_id_(iNumLinha)
  {
    var nomeCampo_colegio_id_ = "colegio_id_" + iNumLinha;
    var var_colegio_id_ = scAjaxGetFieldSelect(nomeCampo_colegio_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_validate_colegio_id_(var_colegio_id_, iNumLinha, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_validate_colegio_id__cb);
  } // do_ajax_form_tipo_calificaciones_detalle_validate_colegio_id_

  function do_ajax_form_tipo_calificaciones_detalle_validate_colegio_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_detalle_validate_colegio_id__cb

  // ---------- Validate tipo_calificacion_id_
  function do_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id_(iNumLinha)
  {
    var nomeCampo_tipo_calificacion_id_ = "tipo_calificacion_id_" + iNumLinha;
    var var_tipo_calificacion_id_ = scAjaxGetFieldSelect(nomeCampo_tipo_calificacion_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id_(var_tipo_calificacion_id_, iNumLinha, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id__cb);
  } // do_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id_

  function do_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_detalle_validate_tipo_calificacion_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipo_calificaciones_detalle_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipo_calificaciones_detalle_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipo_calificaciones_detalle_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_add_new_line_cb);
  } // do_ajax_form_tipo_calificaciones_detalle_add_new_line

  function do_ajax_form_tipo_calificaciones_detalle_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_tipo_calificaciones_detalle_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipo_calificaciones_detalle_backup_line(iNumLinha)
  {
    var var_colegio_id_ = scAjaxGetFieldSelect("colegio_id_" + iNumLinha);
    var var_tipo_calificacion_id_ = scAjaxGetFieldSelect("tipo_calificacion_id_" + iNumLinha);
    var var_linea_ = scAjaxGetFieldText("linea_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_detalle_backup_line(var_colegio_id_, var_tipo_calificacion_id_, var_linea_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_backup_line_cb);
  } // do_ajax_form_tipo_calificaciones_detalle_backup_line

  function do_ajax_form_tipo_calificaciones_detalle_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipo_calificaciones_detalle_backup_line_cb

  function do_ajax_form_tipo_calificaciones_detalle_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipo_calificaciones_detalle_cancel_insert

  function do_ajax_form_tipo_calificaciones_detalle_cancel_update(iSeqVert)
  {
    do_ajax_form_tipo_calificaciones_detalle_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipo_calificaciones_detalle_cancel_update

  function do_ajax_form_tipo_calificaciones_detalle_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipo_calificaciones_detalle_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipo_calificaciones_detalle_table_refresh()
  {
    var var_colegio_id_ = document.F2.colegio_id_.value;
    var var_tipo_calificacion_id_ = document.F2.tipo_calificacion_id_.value;
    var var_linea_ = document.F2.linea_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_detalle_table_refresh(var_colegio_id_, var_tipo_calificacion_id_, var_linea_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_table_refresh_cb);
  } //  do_ajax_form_tipo_calificaciones_detalle_table_refresh

  function do_ajax_form_tipo_calificaciones_detalle_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipo_calificacion_id_.value = scAjaxGetKeyValue("tipo_calificacion_id_");
    document.F2.linea_.value = scAjaxGetKeyValue("linea_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipo_calificaciones_detalle_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipo_calificaciones_detalle_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipo_calificaciones_detalle_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_calificacion_maxima_ = scAjaxGetFieldText("calificacion_maxima_" + iNumLinha);
    var var_colegio_id_ = scAjaxGetFieldSelect("colegio_id_" + iNumLinha);
    var var_tipo_calificacion_id_ = scAjaxGetFieldSelect("tipo_calificacion_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipo_calificaciones_detalle_submit_form(var_linea_, var_descripcion_, var_calificacion_maxima_, var_colegio_id_, var_tipo_calificacion_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_calificaciones_detalle_submit_form_cb);
  } // do_ajax_form_tipo_calificaciones_detalle_submit_form

  function do_ajax_form_tipo_calificaciones_detalle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("linea_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_maxima_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_tipo_calificaciones_detalle_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_calificaciones_detalle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipo_calificaciones_detalle_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("linea_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_maxima_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_detalle_navigate_form(var_colegio_id_, var_tipo_calificacion_id_, var_linea_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_calificaciones_detalle_navigate_form_cb);
  } // do_ajax_form_tipo_calificaciones_detalle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_detalle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_calificaciones_detalle_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipo_calificacion_id_.value = scAjaxGetKeyValue("tipo_calificacion_id_" + var_last_index);
    document.F2.linea_.value = scAjaxGetKeyValue("linea_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_tipo_calificaciones_detalle_navigate_form_cb
  function sc_hide_form_tipo_calificaciones_detalle_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tipo_calificaciones_detalle_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "linea_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_maxima_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "colegio_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_calificacion_id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["linea_" + iNumLinha] = {"label": "Línea<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["calificacion_maxima_" + iNumLinha] = {"label": "Calificación Máxima<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["linea_"][iNumLinha] = "linea_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["calificacion_maxima_"][iNumLinha] = "calificacion_maxima_" + iNumLinha;
    ...
    ajax_field_id["linea_" + iNumLinha] = new Array("hidden_field_label_linea_", "hidden_field_data_linea_" + iNumLinha);
    ajax_field_id["descripcion_" + iNumLinha] = new Array("hidden_field_label_descripcion_", "hidden_field_data_descripcion_" + iNumLinha);
    ajax_field_id["calificacion_maxima_" + iNumLinha] = new Array("hidden_field_label_calificacion_maxima_", "hidden_field_data_calificacion_maxima_" + iNumLinha);
    ajax_error_count["linea_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["calificacion_maxima_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["linea_" + iNumLinha] = "on";
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["calificacion_maxima_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["calificacion_maxima_" + iNumLinha] = "on";
    ajax_read_only["colegio_id_" + iNumLinha] = "on";
    ajax_read_only["tipo_calificacion_id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["linea_" + iNumLinha] = null;
    ajax_error_list["descripcion_" + iNumLinha] = null;
    ajax_error_list["calificacion_maxima_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "calificacion_maxima_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["linea_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["linea_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["linea_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["linea_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["linea_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["calificacion_maxima_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_maxima_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_maxima_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_maxima_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_maxima_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['linea_'])) ? $this->nmgp_cmp_readonly['linea_'] : 'on';
?>
    scAjaxFieldRead("linea_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_maxima_'])) ? $this->nmgp_cmp_readonly['calificacion_maxima_'] : 'off';
?>
    scAjaxFieldRead("calificacion_maxima_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_calificacion_id_'])) ? $this->nmgp_cmp_readonly['tipo_calificacion_id_'] : 'on';
?>
  ...
  {
    scAjaxFieldRead("linea_" + iSeq, "on");
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("calificacion_maxima_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["linea_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["calificacion_maxima_" + iRow] || "on" == ajax_error_count["colegio_id_" + iRow] || "on" == ajax_error_count["tipo_calificacion_id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_linea_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_maxima_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["linea_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["calificacion_maxima_" + iRow] && "off" == ajax_error_count["colegio_id_" + iRow] && "off" == ajax_error_count["tipo_calificacion_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["linea_" + iRow] = "off";
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["calificacion_maxima_" + iRow] = "off";
      ...
      $("#hidden_field_data_linea_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_maxima_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("calificacion_maxima_" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
