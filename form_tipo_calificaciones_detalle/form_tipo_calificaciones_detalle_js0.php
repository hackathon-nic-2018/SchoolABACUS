...
<input type="hidden" name="tipo_calificacion_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['tipo_calificacion_id_']); ?>">
<input type="hidden" name="linea_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['linea_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_tipo_calificaciones_detalle"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_tipo_calificaciones_detalle_submit_form(y, z); 
} 
<?php
}
?>
