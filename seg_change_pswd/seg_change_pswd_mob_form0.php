...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_old_pswd_line" id="hidden_field_data_old_pswd" style="<?php echo $sStyleHidden_old_pswd; ?>"> <span class="scFormLabelOddFormat css_old_pswd_label"><span id="id_label_old_pswd"><?php echo $this->nm_new_label['old_pswd']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_old_pswd" class="sc-ui-readonly-old_pswd css_old_pswd_line" style="<?php echo $sStyleReadLab_old_pswd; ?>"><?php echo $this->form_encode_input($this->old_pswd); ?></span><span id="id_read_off_old_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_old_pswd; ?>"><input class="sc-js-input scFormObjectOdd css_old_pswd_obj" style="" id="id_sc_field_old_pswd" type=password name="old_pswd" value="" 
 size=10 maxlength=32 alt="{datatype: 'text', maxLength: 32, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: false, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
 </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_pswd_line" id="hidden_field_data_pswd" style="<?php echo $sStyleHidden_pswd; ?>"> <span class="scFormLabelOddFormat css_pswd_label"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirm_pswd_line" id="hidden_field_data_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"> <span class="scFormLabelOddFormat css_confirm_pswd_label"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['seg_change_pswd_mob']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
