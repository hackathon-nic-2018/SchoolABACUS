...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_estudiantes"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_estudiantes"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_estudiantes'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_estudiantes']['embutida_filho'] as $ind => $sc_init)
          {
