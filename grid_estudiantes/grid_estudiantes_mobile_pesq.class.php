...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_nacimiento";$Nm_datas[] = "fecha_ingreso";$Nm_numeric[] = "colegio_id";$Nm_numeric[] = "estudiante_id";$Nm_numeric[] = "grado_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numero_carnet_cond" name="numero_carnet_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_carnet'), this, 'numero_carnet')">
      ...
      <br><span id="id_hide_numero_carnet"  <?php echo $str_hide_numero_carnet?>><?php
      if ($numero_carnet != "")
      {
      $numero_carnet_look = substr($this->Db->qstr($numero_carnet), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_estudiante_id_cond" name="estudiante_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_estudiante_id'), this, 'estudiante_id')">
      ...
      <br><span id="id_hide_estudiante_id"  <?php echo $str_hide_estudiante_id?>><?php
      if ($estudiante_id != "")
      {
      $estudiante_id_look = substr($this->Db->qstr($estudiante_id), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_codigo_estudiante_cond" name="codigo_estudiante_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_estudiante'), this, 'codigo_estudiante')">
      ...
      <br><span id="id_hide_codigo_estudiante"  <?php echo $str_hide_codigo_estudiante?>><?php
