      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'][$field] = $cada_dado['value']; 
              }
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numero_carnet')
      {
          $numero_carnet = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numero_carnet($numero_carnet);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_estudiante_id')
      {
          $estudiante_id = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_estudiante_id($estudiante_id);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigo_estudiante')
      {
          $codigo_estudiante = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigo_estudiante($codigo_estudiante);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $estudiante_id = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $estudiante_id);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fecha_nacimiento";$Nm_datas[] = "fecha_ingreso";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> estudiantes</TITLE>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_numero_carnet_cond#NMF#' + search_get_sel_txt('SC_numero_carnet_cond') + '@NMF@';
  str_out += 'SC_numero_carnet#NMF#' + search_get_text('SC_numero_carnet') + '@NMF@';
  str_out += 'id_ac_numero_carnet#NMF#' + search_get_text('id_ac_numero_carnet') + '@NMF@';
  ...
  str_out += 'SC_estudiante_id_cond#NMF#' + search_get_sel_txt('SC_estudiante_id_cond') + '@NMF@';
  str_out += 'SC_estudiante_id#NMF#' + search_get_text('SC_estudiante_id') + '@NMF@';
  str_out += 'id_ac_estudiante_id#NMF#' + search_get_text('id_ac_estudiante_id') + '@NMF@';
  str_out += 'SC_codigo_estudiante_cond#NMF#' + search_get_sel_txt('SC_codigo_estudiante_cond') + '@NMF@';
  str_out += 'SC_codigo_estudiante#NMF#' + search_get_text('SC_codigo_estudiante') + '@NMF@';
  str_out += 'id_ac_codigo_estudiante#NMF#' + search_get_text('id_ac_codigo_estudiante') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   $("#id_ac_codigo_estudiante").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_codigo_estudiante",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_codigo_estudiante").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_codigo_estudiante").val( $(this).val() );
       }
     }
   });
   $("#id_ac_numero_carnet").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_numero_carnet",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_numero_carnet").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_numero_carnet").val( $(this).val() );
       }
     }
   });
   $("#id_ac_estudiante_id").autocomplete({
     minLength: 1,
     source: function (request, response) {
     $.ajax({
       url: "index.php",
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_estudiante_id",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_estudiante_id").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> estudiantes</div>
...
<?php
   ...
   {
      global 
             $numero_carnet_cond, $numero_carnet, $numero_carnet_autocomp,
             $colegio_id_cond, $colegio_id, $colegio_id_autocomp,
             $estudiante_id_cond, $estudiante_id, $estudiante_id_autocomp,
             $codigo_estudiante_cond, $codigo_estudiante, $codigo_estudiante_autocomp,
      ...
      { 
          ...
          $numero_carnet = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['numero_carnet']; 
          $numero_carnet_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['numero_carnet_cond']; 
          $colegio_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['colegio_id']; 
          $colegio_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['colegio_id_cond']; 
          $estudiante_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['estudiante_id']; 
          $estudiante_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['estudiante_id_cond']; 
          $codigo_estudiante = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['codigo_estudiante']; 
          $codigo_estudiante_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['codigo_estudiante_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['NM_operador']; 
      } 
      if (!isset($numero_carnet_cond) || empty($numero_carnet_cond))
      {
         $numero_carnet_cond = "qp";
      }
      if (!isset($colegio_id_cond) || empty($colegio_id_cond))
      {
         $colegio_id_cond = "gt";
      }
      if (!isset($estudiante_id_cond) || empty($estudiante_id_cond))
      {
         $estudiante_id_cond = "gt";
      }
      if (!isset($codigo_estudiante_cond) || empty($codigo_estudiante_cond))
      {
         $codigo_estudiante_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_numero_carnet = (in_array($numero_carnet_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_colegio_id = (in_array($colegio_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_estudiante_id = (in_array($estudiante_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_codigo_estudiante = (in_array($codigo_estudiante_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($numero_carnet) || $numero_carnet == "")
      {
          $numero_carnet = "";
      }
      if (isset($numero_carnet) && !empty($numero_carnet))
      {
         $tmp_pos = strpos($numero_carnet, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numero_carnet = substr($numero_carnet, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($estudiante_id) || $estudiante_id == "")
      {
          $estudiante_id = "";
      }
      if (isset($estudiante_id) && !empty($estudiante_id))
      {
      ...
      if (!isset($codigo_estudiante) || $codigo_estudiante == "")
      {
          $codigo_estudiante = "";
      }
      if (isset($codigo_estudiante) && !empty($codigo_estudiante))
      {
         $tmp_pos = strpos($codigo_estudiante, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigo_estudiante = substr($codigo_estudiante, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['numero_carnet'])) ? $this->New_label['numero_carnet'] : "Numero Carnet"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_numero_carnet_cond" name="numero_carnet_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_carnet'), this, 'numero_carnet')">
       <OPTION value="qp" <?php if ("qp" == $numero_carnet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $numero_carnet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numero_carnet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $numero_carnet_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numero_carnet" <?php echo $str_hide_numero_carnet?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['numero_carnet'])) ? $this->New_label['numero_carnet'] : "Numero Carnet";
 $nmgp_tab_label .= "numero_carnet?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($numero_carnet != "")
      ...
      {
          $sAutocompValue = $numero_carnet;
      }
?>
<INPUT  type="text" id="SC_numero_carnet" name="numero_carnet" value="<?php echo NM_encode_input($numero_carnet) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_numero_carnet" name="numero_carnet_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_colegio_id" name="colegio_id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['estudiante_id'])) ? $this->New_label['estudiante_id'] : "Estudiante"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_estudiante_id_cond" name="estudiante_id_cond" onChange="nm_campos_between(document.getElementById('id_vis_estudiante_id'), this, 'estudiante_id')">
       <OPTION value="gt" <?php if ("gt" == $estudiante_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $estudiante_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $estudiante_id_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_estudiante_id" <?php echo $str_hide_estudiante_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['estudiante_id'])) ? $this->New_label['estudiante_id'] : "Estudiante";
 $nmgp_tab_label .= "estudiante_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      if ($estudiante_id != "")
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($estudiante_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $estudiante_id;
      }
?>
<INPUT  type="text" id="SC_estudiante_id" name="estudiante_id" value="<?php echo NM_encode_input($estudiante_id) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_estudiante_id" name="estudiante_id_autocomp" size="11" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['codigo_estudiante'])) ? $this->New_label['codigo_estudiante'] : "Código Estudiante"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_codigo_estudiante_cond" name="codigo_estudiante_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_estudiante'), this, 'codigo_estudiante')">
       <OPTION value="qp" <?php if ("qp" == $codigo_estudiante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigo_estudiante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $codigo_estudiante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $codigo_estudiante_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo_estudiante" <?php echo $str_hide_codigo_estudiante?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['codigo_estudiante'])) ? $this->New_label['codigo_estudiante'] : "Código Estudiante";
 $nmgp_tab_label .= "codigo_estudiante?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php
      ...
      {
          $sAutocompValue = $codigo_estudiante;
      }
?>
<INPUT  type="text" id="SC_codigo_estudiante" name="codigo_estudiante" value="<?php echo NM_encode_input($codigo_estudiante) ?>" size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_codigo_estudiante" name="codigo_estudiante_autocomp" size="15" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_numero_carnet'), document.F1.numero_carnet_cond, 'numero_carnet');
   document.F1.numero_carnet.value = "";
   document.F1.numero_carnet_autocomp.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_estudiante_id'), document.F1.estudiante_id_cond, 'estudiante_id');
   document.F1.estudiante_id.value = "";
   document.F1.estudiante_id_autocomp.value = "";
   nm_campos_between(document.getElementById('id_vis_codigo_estudiante'), document.F1.codigo_estudiante_cond, 'codigo_estudiante');
   document.F1.codigo_estudiante.value = "";
   document.F1.codigo_estudiante_autocomp.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_numero_carnet_cond'] = 'cond';
      $tp_fields['SC_numero_carnet'] = 'text_aut';
      $tp_fields['id_ac_numero_carnet'] = 'text_aut';
      $tp_fields['SC_colegio_id_cond'] = 'cond';
      $tp_fields['SC_colegio_id'] = 'text_aut';
      $tp_fields['id_ac_colegio_id'] = 'text_aut';
      $tp_fields['SC_estudiante_id_cond'] = 'cond';
      $tp_fields['SC_estudiante_id'] = 'text_aut';
      $tp_fields['id_ac_estudiante_id'] = 'text_aut';
      $tp_fields['SC_codigo_estudiante_cond'] = 'cond';
      $tp_fields['SC_codigo_estudiante'] = 'text_aut';
      $tp_fields['id_ac_codigo_estudiante'] = 'text_aut';
   ...
   {
      global $numero_carnet_cond, $numero_carnet, $numero_carnet_autocomp,
             $colegio_id_cond, $colegio_id, $colegio_id_autocomp,
             $estudiante_id_cond, $estudiante_id, $estudiante_id_autocomp,
             $codigo_estudiante_cond, $codigo_estudiante, $codigo_estudiante_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $C_formatado = false;
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq'] = array();
      if (!empty($numero_carnet_autocomp) && empty($numero_carnet))
      {
          $numero_carnet = $numero_carnet_autocomp;
      }
      if (!empty($colegio_id_autocomp) && empty($colegio_id))
      {
          $colegio_id = $colegio_id_autocomp;
      }
      if (!empty($estudiante_id_autocomp) && empty($estudiante_id))
      {
          $estudiante_id = $estudiante_id_autocomp;
      }
      if (!empty($codigo_estudiante_autocomp) && empty($codigo_estudiante))
      {
          $codigo_estudiante = $codigo_estudiante_autocomp;
      }
      $numero_carnet_cond_salva = $numero_carnet_cond; 
      if (!isset($numero_carnet_input_2) || $numero_carnet_input_2 == "")
      {
          $numero_carnet_input_2 = $numero_carnet;
      }
      ...
      $estudiante_id_cond_salva = $estudiante_id_cond; 
      if (!isset($estudiante_id_input_2) || $estudiante_id_input_2 == "")
      {
          $estudiante_id_input_2 = $estudiante_id;
      }
      $codigo_estudiante_cond_salva = $codigo_estudiante_cond; 
      if (!isset($codigo_estudiante_input_2) || $codigo_estudiante_input_2 == "")
      {
          $codigo_estudiante_input_2 = $codigo_estudiante;
      }
      ...
      if ($estudiante_id_cond != "in")
      {
          nm_limpa_numero($estudiante_id, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      else
      {
          $Nm_sc_valores = explode(",", $estudiante_id);
          foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
          {
              $Nm_sc_valor = trim($Nm_sc_valor);
              nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $estudiante_id = implode(",", $Nm_sc_valores);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['numero_carnet'] = $numero_carnet; 
      if (is_array($numero_carnet) && !empty($numero_carnet))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0] = $numero_carnet;
      }
      elseif ($numero_carnet_cond_salva == "nu" || $numero_carnet_cond_salva == "nn" || $numero_carnet_cond_salva == "ep" || $numero_carnet_cond_salva == "ne" ||  !empty($numero_carnet))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0][0] = $numero_carnet;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['numero_carnet_cond'] = $numero_carnet_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['cmp'] = "numero_carnet"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['opc'] = $numero_carnet_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq']['numero_carnet'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['colegio_id'] = $colegio_id; 
      if (is_array($colegio_id) && !empty($colegio_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0] = $colegio_id;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0][0] = $colegio_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['colegio_id_cond'] = $colegio_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['cmp'] = "colegio_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['opc'] = $colegio_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq']['colegio_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['estudiante_id'] = $estudiante_id; 
      if (is_array($estudiante_id) && !empty($estudiante_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0] = $estudiante_id;
      }
      elseif ($estudiante_id_cond_salva == "nu" || $estudiante_id_cond_salva == "nn" || $estudiante_id_cond_salva == "ep" || $estudiante_id_cond_salva == "ne" ||  !empty($estudiante_id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0][0] = $estudiante_id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['estudiante_id_cond'] = $estudiante_id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['cmp'] = "estudiante_id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['opc'] = $estudiante_id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq']['estudiante_id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['codigo_estudiante'] = $codigo_estudiante; 
      if (is_array($codigo_estudiante) && !empty($codigo_estudiante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0] = $codigo_estudiante;
      }
      elseif ($codigo_estudiante_cond_salva == "nu" || $codigo_estudiante_cond_salva == "nn" || $codigo_estudiante_cond_salva == "ep" || $codigo_estudiante_cond_salva == "ne" ||  !empty($codigo_estudiante))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['val'][0][0] = $codigo_estudiante;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['codigo_estudiante_cond'] = $codigo_estudiante_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['cmp'] = "codigo_estudiante"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid]['opc'] = $codigo_estudiante_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['grid_pesq']['codigo_estudiante'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['campos_busca'] = $Temp_Busca;
      }
      ...
      if ($estudiante_id_cond != "in" && $estudiante_id_cond != "bw" && !empty($estudiante_id) && !is_numeric($estudiante_id))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Estudiante";
      }
      if ($estudiante_id_cond == "bw" && ((!empty($estudiante_id) && !is_numeric($estudiante_id)) || (!empty($estudiante_id_input_2) && !is_numeric($estudiante_id_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Estudiante";
      }
      if (!empty($this->Campos_Mens_erro)) 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numero_carnet'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['numero_carnet'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['numero_carnet'] = $numero_carnet;
      }
      $colegio_id_look = substr($this->Db->qstr($colegio_id), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($colegio_id))
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['estudiante_id'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['estudiante_id'] = $cmp1;
      }
      else
      {
          $cmp1 = $estudiante_id;
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigo_estudiante'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['codigo_estudiante'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigo_estudiante'] = $codigo_estudiante;
      }

      //----- $numero_carnet
      $this->Date_part = false;
      if (isset($numero_carnet) || $numero_carnet_cond == "nu" || $numero_carnet_cond == "nn" || $numero_carnet_cond == "ep" || $numero_carnet_cond == "ne")
      {
         $this->monta_condicao("numero_carnet", $numero_carnet_cond, $numero_carnet, "", "numero_carnet");
      }
      ...
      //----- $estudiante_id
      $this->Date_part = false;
      if (isset($estudiante_id) || $estudiante_id_cond == "nu" || $estudiante_id_cond == "nn" || $estudiante_id_cond == "ep" || $estudiante_id_cond == "ne")
      {
         $this->monta_condicao("estudiante_id", $estudiante_id_cond, $estudiante_id, "", "estudiante_id");
      }

      //----- $codigo_estudiante
      $this->Date_part = false;
      if (isset($codigo_estudiante) || $codigo_estudiante_cond == "nu" || $codigo_estudiante_cond == "nn" || $codigo_estudiante_cond == "ep" || $codigo_estudiante_cond == "ne")
      {
         $this->monta_condicao("codigo_estudiante", $codigo_estudiante_cond, $codigo_estudiante, "", "codigo_estudiante");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_fast'])) 
       {
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_fast'] . ")";
           }
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_interativ'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_interativ'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq'] = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_interativ'];
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['cond_dyn_search'] = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_estudiantes']['where_pesq_grid']    = $this->comando_filtro;
