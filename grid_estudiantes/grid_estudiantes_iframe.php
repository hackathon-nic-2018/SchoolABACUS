...
$oExportPdf = new grid_estudiantes_export_pdf;
$oExportPdf->exportPdf();

class grid_estudiantes_export_pdf {
...
$STR_btn    = '';
$STR_lang   = '';
if (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']))
{
    $STR_schema = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']['str_schema'];
    $STR_tmp    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']['str_tmp'];
    $STR_prod   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']['str_prod'];
    $STR_btn    = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']['str_btn'];
    $STR_lang   = $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['grid_estudiantes_iframe_params']['str_lang'];
}
if (isset($aParams['sc_create_charts'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['skip_charts'] = 'N' == $aParams['sc_create_charts'];
}
if (isset($aParams['chart_level'])) {
    $_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['chart_level'] = $aParams['chart_level'];
}
elseif (isset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['chart_level'])) {
    unset($_SESSION['sc_session'][ $aParams['script_case_init'] ]['grid_estudiantes']['chart_level']);
}
if (isset($aParams['page_break_pdf']) && $aParams['page_break_pdf'] != "_NO_")
{
    $Arr_page_pdf = explode("_BRK_", $aParams['page_break_pdf']);
    foreach ($_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['Page_break_PDF'] as $cmp => $opt)
    {
        if (in_array($cmp, $Arr_page_pdf))
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['Page_break_PDF'][$cmp] = "S";
        }
        else
        {
            $_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['Page_break_PDF'][$cmp] = "N";
        }
    }
}
$Nm_lang     = array();
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?> estudiantes :: PDF</title>
...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_estudiantes_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_estudiantes.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes']['pdf_name'] : "grid_estudiantes.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$path_doc_md5 = md5($NM_pdfurl . "/" . $NM_pdfbase);
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_estudiantes'][$path_doc_md5][1] = $NM_tit_doc;
$NM_volta   = "volta_grid";
?>
