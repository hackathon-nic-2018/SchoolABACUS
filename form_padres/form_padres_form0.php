...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_padres_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_padres_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['recarga'];
}
?>
...
<?php
 include_once("form_padres_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_padres'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_padres'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_apellidos_label" id="hidden_field_label_apellidos" style="<?php echo $sStyleHidden_apellidos; ?>"><span id="id_label_apellidos"><?php echo $this->nm_new_label['apellidos']; ?></span></TD>
    <TD class="scFormDataOdd css_apellidos_line" id="hidden_field_data_apellidos" style="<?php echo $sStyleHidden_apellidos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_apellidos_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_identificacion_label" id="hidden_field_label_identificacion" style="<?php echo $sStyleHidden_identificacion; ?>"><span id="id_label_identificacion"><?php echo $this->nm_new_label['identificacion']; ?></span></TD>
    <TD class="scFormDataOdd css_identificacion_line" id="hidden_field_data_identificacion" style="<?php echo $sStyleHidden_identificacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_identificacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_direccion_linea1_line" id="hidden_field_data_direccion_linea1" style="<?php echo $sStyleHidden_direccion_linea1; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_linea1_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_direccion_linea2_line" id="hidden_field_data_direccion_linea2" style="<?php echo $sStyleHidden_direccion_linea2; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_linea2_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_padres");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_padres");
 parent.scAjaxDetailHeight("form_padres", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
