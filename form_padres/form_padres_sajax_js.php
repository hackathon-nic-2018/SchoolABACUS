  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_padres" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate fotografia
  function do_ajax_form_padres_validate_fotografia()
  {
    var nomeCampo_fotografia = "fotografia";
    var var_fotografia = scAjaxGetFieldText(nomeCampo_fotografia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_fotografia(var_fotografia, var_script_case_init, do_ajax_form_padres_validate_fotografia_cb);
  } // do_ajax_form_padres_validate_fotografia

  function do_ajax_form_padres_validate_fotografia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_fotografia_cb

  // ---------- Validate apellidos
  function do_ajax_form_padres_validate_apellidos()
  {
    var nomeCampo_apellidos = "apellidos";
    var var_apellidos = scAjaxGetFieldText(nomeCampo_apellidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_apellidos(var_apellidos, var_script_case_init, do_ajax_form_padres_validate_apellidos_cb);
  } // do_ajax_form_padres_validate_apellidos

  function do_ajax_form_padres_validate_apellidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_apellidos_cb

  // ---------- Validate nombres
  function do_ajax_form_padres_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_nombres(var_nombres, var_script_case_init, do_ajax_form_padres_validate_nombres_cb);
  } // do_ajax_form_padres_validate_nombres

  function do_ajax_form_padres_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_nombres_cb

  // ---------- Validate identificacion
  function do_ajax_form_padres_validate_identificacion()
  {
    var nomeCampo_identificacion = "identificacion";
    var var_identificacion = scAjaxGetFieldText(nomeCampo_identificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_identificacion(var_identificacion, var_script_case_init, do_ajax_form_padres_validate_identificacion_cb);
  } // do_ajax_form_padres_validate_identificacion

  function do_ajax_form_padres_validate_identificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_identificacion_cb

  // ---------- Validate telefono
  function do_ajax_form_padres_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_padres_validate_telefono_cb);
  } // do_ajax_form_padres_validate_telefono

  function do_ajax_form_padres_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_telefono_cb

  // ---------- Validate correo
  function do_ajax_form_padres_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_correo(var_correo, var_script_case_init, do_ajax_form_padres_validate_correo_cb);
  } // do_ajax_form_padres_validate_correo

  function do_ajax_form_padres_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_correo_cb

  // ---------- Validate direccion_linea1
  function do_ajax_form_padres_validate_direccion_linea1()
  {
    var nomeCampo_direccion_linea1 = "direccion_linea1";
    var var_direccion_linea1 = scAjaxGetFieldText(nomeCampo_direccion_linea1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_direccion_linea1(var_direccion_linea1, var_script_case_init, do_ajax_form_padres_validate_direccion_linea1_cb);
  } // do_ajax_form_padres_validate_direccion_linea1

  function do_ajax_form_padres_validate_direccion_linea1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_direccion_linea1_cb

  // ---------- Validate direccion_linea2
  function do_ajax_form_padres_validate_direccion_linea2()
  {
    var nomeCampo_direccion_linea2 = "direccion_linea2";
    var var_direccion_linea2 = scAjaxGetFieldText(nomeCampo_direccion_linea2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_validate_direccion_linea2(var_direccion_linea2, var_script_case_init, do_ajax_form_padres_validate_direccion_linea2_cb);
  } // do_ajax_form_padres_validate_direccion_linea2

  function do_ajax_form_padres_validate_direccion_linea2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_validate_direccion_linea2_cb
  // ---------- Form
  function do_ajax_form_padres_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_padres_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_padres_submit_form(var_fotografia, var_apellidos, var_nombres, var_identificacion, var_telefono, var_correo, var_direccion_linea1, var_direccion_linea2, var_fotografia_ul_name, var_fotografia_ul_type, var_fotografia_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_padres_submit_form_cb);
  } // do_ajax_form_padres_submit_form

  function do_ajax_form_padres_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_padres_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_padres_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_padres_navigate_form(var_colegio_id, var_padre_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_padres_navigate_form_cb);
  } // do_ajax_form_padres_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_padres_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_padres_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_padres_navigate_form_cb
  function sc_hide_form_padres_form()
  {
