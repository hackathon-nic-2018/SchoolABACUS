...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_asignatura_id' + iSeqRow).bind('blur', function() { sc_form_asignaturas_grados_asignatura_id_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_asignaturas_grados_asignatura_id_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_asignaturas_grados_asignatura_id_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_asignaturas_grados_asignatura_id_onblur(oThis, iSeqRow) {
  do_ajax_form_asignaturas_grados_mob_validate_asignatura_id();
  scCssBlur(oThis);
}

function sc_form_asignaturas_grados_asignatura_id_onchange(oThis, iSeqRow) {
  lookup_asignatura_id();
}

function sc_form_asignaturas_grados_asignatura_id_onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_form_asignaturas_grados_mob_form" + pageNo).hide();
}
