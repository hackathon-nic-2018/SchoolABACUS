...
class grid_cursos_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_name']);
      }
   ...
   function NM_export_grado_id()
   {
         ...
         $this->look_grado_id = str_replace('<', '&lt;', $this->look_grado_id);
         $this->look_grado_id = str_replace('>', '&gt;', $this->look_grado_id);
         $this->Texto_tag .= "<td>" . $this->look_grado_id . "</td>\r\n";
   }
   //----- descripcion
   ...
   function NM_export_docente_guia_id()
   {
         ...
         $this->look_docente_guia_id = str_replace('<', '&lt;', $this->look_docente_guia_id);
         $this->look_docente_guia_id = str_replace('>', '&gt;', $this->look_docente_guia_id);
         $this->Texto_tag .= "<td>" . $this->look_docente_guia_id . "</td>\r\n";
   }
   //----- colegio_id
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Cursos del Periodo :: RTF</TITLE>
