...
class grid_cursos_res_rtf
{
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['pivot_tabular'];
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['arr_export']['data'];
