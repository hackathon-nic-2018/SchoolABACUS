...
<?php
   ...
   $Ord_Cmp = new grid_cursos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cursos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["grado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["grado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["grado_id"] : "Grado Id";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_converte["descripcion"]   = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['ubicacion'] = "on";
   $tab_def_campos['ubicacion'] = "ubicacion";
   $tab_converte["ubicacion"]   = "ubicacion";
   $tab_labels["ubicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["ubicacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["ubicacion"] : "Ubicacion";
   $tab_ger_campos['docente_guia_id'] = "on";
   $tab_def_campos['docente_guia_id'] = "docente_guia_id";
   $tab_converte["docente_guia_id"]   = "docente_guia_id";
   $tab_labels["docente_guia_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["docente_guia_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_cursos']['labels']["docente_guia_id"] : "Docente Guia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cursos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cursos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cursos_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_cursos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
