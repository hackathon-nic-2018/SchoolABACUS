...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_cursos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_cursos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cursos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cursos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cursos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cursos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cursos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cursos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cursos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cursos']['embutida_filho'] as $ind => $sc_init)
          {
