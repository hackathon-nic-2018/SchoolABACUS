...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_asistencias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____grid_asistencias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_asistencias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_asistencias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_asistencias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_asistencias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_asistencias']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_asistencias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_asistencias']['embutida_filho'] as $ind => $sc_init)
          {
