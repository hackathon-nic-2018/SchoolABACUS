...
class grid_asistencias_resumo
{
   ...
   var $array_total_curso_id;
   var $array_total_estudiante_id;
   var $array_total_asignatura_id;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_curso_id      = array();
      $this->array_total_estudiante_id = array();
      $this->array_total_asignatura_id = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['phantomjs_export_process'] = false;
	...
	function zipChartImages() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList) {
		...
		$tempDir = $this->Ini->root . $_SESSION['scriptcase']['grid_asistencias']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_asistencias']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['contr_total_geral'] == "OK")
      {
          $this->array_total_periodo_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['periodo_id'];
          $this->array_total_curso_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['curso_id'];
          $this->array_total_estudiante_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['estudiante_id'];
          $this->array_total_asignatura_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['asignatura_id'];
      }
      else
      {
          $this->array_total_periodo_id = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['tot_geral'][1] == 0)
      {
      ...
      $this->drawMatrix();
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['periodo_id'] = $this->array_total_periodo_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['curso_id'] = $this->array_total_curso_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['estudiante_id'] = $this->array_total_estudiante_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total']['asignatura_id'] = $this->array_total_asignatura_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       $Lab_curso_id = "Curso";
       $Lab_estudiante_id = "Estudiante";
       $Lab_asignatura_id = "Asignatura";
       $this->comp_field = array(
           $Lab_periodo_id,
           $Lab_curso_id,
           $Lab_estudiante_id,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_order']['asistencia']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_order']['asistencia'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_order']['asistencia'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['summarizing_fields_display']['asistencia'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "asistencia", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_asistencia_avg",
       );
       ...
       foreach ($this->array_total_periodo_id as $i_periodo_id => $d_periodo_id) {
           if (!in_array($i_periodo_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_periodo_id[3] ] = $d_periodo_id[2];
               $this->comp_label[0][ $d_periodo_id[3] ] = $d_periodo_id[2];
           }
           foreach ($this->array_total_curso_id[$i_periodo_id] as $i_curso_id => $d_curso_id) {
               if (!in_array($i_curso_id, $this->comp_label[1][ $d_periodo_id[3] ], true)) {
                   $this->comp_index[1][ $d_curso_id[3] ] = $d_curso_id[2];
                   $this->comp_label[1][ $d_periodo_id[3] ][ $d_curso_id[3] ] = $d_curso_id[2];
               }
               foreach ($this->array_total_estudiante_id[$i_periodo_id][$i_curso_id] as $i_estudiante_id => $d_estudiante_id) {
                   if (!in_array($i_estudiante_id, $this->comp_label[2][ $d_periodo_id[3] ][ $d_curso_id[3] ], true)) {
                       $this->comp_index[2][ $d_estudiante_id[3] ] = $d_estudiante_id[2];
                       $this->comp_label[2][ $d_periodo_id[3] ][ $d_curso_id[3] ][ $d_estudiante_id[3] ] = $d_estudiante_id[2];
                   }
                   foreach ($this->array_total_asignatura_id[$i_periodo_id][$i_curso_id][$i_estudiante_id] as $i_asignatura_id => $d_asignatura_id) {
                       if (!in_array($i_asignatura_id, $this->comp_label[3][ $d_periodo_id[3] ][ $d_curso_id[3] ][ $d_estudiante_id[3] ], true)) {
                           $this->comp_index[3][ $d_asignatura_id[3] ] = $d_asignatura_id[2];
                           $this->comp_label[3][ $d_periodo_id[3] ][ $d_curso_id[3] ][ $d_estudiante_id[3] ][ $d_asignatura_id[3] ] = $d_asignatura_id[2];
                       }
                   }
               }
           }
       ...
       //-----
       $this->comp_x_axys = array();
       $this->comp_y_axys = array(0, 1, 2, 3);
       ...
       $this->comp_links_fl = array(
           ...
           array('name' => 'curso_id', 'prot' => ''),
           array('name' => 'estudiante_id', 'prot' => ''),
           array('name' => 'asignatura_id', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_tabular_label'];
       ...
       foreach ($this->comp_label[0] as $i_periodo_id => $l_periodo_id) {
           ...
           foreach ($this->comp_label[1][$i_periodo_id] as $i_curso_id => $l_curso_id) {
               if (isset($this->array_total_curso_id[$i_periodo_id][$i_curso_id])) {
                   $this->comp_group[$i_periodo_id][$i_curso_id] = array();
               }
               foreach ($this->comp_label[2][$i_periodo_id][$i_curso_id] as $i_estudiante_id => $l_estudiante_id) {
                   if (isset($this->array_total_estudiante_id[$i_periodo_id][$i_curso_id][$i_estudiante_id])) {
                       $this->comp_group[$i_periodo_id][$i_curso_id][$i_estudiante_id] = array();
                   }
                   foreach ($this->comp_label[3][$i_periodo_id][$i_curso_id][$i_estudiante_id] as $i_asignatura_id => $l_asignatura_id) {
                       if (isset($this->array_total_asignatura_id[$i_periodo_id][$i_curso_id][$i_estudiante_id][$i_asignatura_id])) {
                           $this->comp_group[$i_periodo_id][$i_curso_id][$i_estudiante_id][$i_asignatura_id] = array();
                       }
                   }
               }
           }
   ...
   function getCompData($level, $params = array()) {
       ...
       elseif (1 == $level) {
           $return = $this->array_total_curso_id;
       }
       elseif (2 == $level) {
           $return = $this->array_total_estudiante_id;
       }
       elseif (3 == $level) {
           $return = $this->array_total_asignatura_id;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_asistencias@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'periodo_id',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_periodo_id)),
               'label_y'  => $this->getChartText(strip_tags("Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'curso_id',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_curso_id)),
               'label_y'  => $this->getChartText(strip_tags("Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '2|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'estudiante_id',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_estudiante_id)),
               'label_y'  => $this->getChartText(strip_tags("Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '3|1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'asignatura_id',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_asignatura_id)),
               'label_y'  => $this->getChartText(strip_tags("Asistencia (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_avg'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           'T|1' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_asistencias_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_asistencias_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['pivot_order_start'][$iYAxysIndex])
                       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_asistencias_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] = "print";
      ...
      $this->Total   = new grid_asistencias_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_asistencia("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_periodo_id);
      ksort($this->array_total_curso_id);
      ksort($this->array_total_estudiante_id);
      ksort($this->array_total_asignatura_id);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['responsive_chart']['active']) {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['doc_word'])
{
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_asistencias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_asistencias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_asistencias_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css'] . '.css');
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_config_graf_flash.php?nome_apl=grid_asistencias&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_asistencias_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_asistencias_config_pivot.php?nome_apl=grid_asistencias&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("</form> \r\n");
      ...
      $nm_saida->saida("           $('#TB_window').remove();\r\n");
      $nm_saida->saida("           $('body').append(\"<div id='TB_window'></div>\");\r\n");
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__cor_print=\" + cor + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida("      else\r\n");
      $nm_saida->saida("      {\r\n");
      $nm_saida->saida("          window.location = \"" . $this->Ini->path_link . "grid_asistencias/grid_asistencias_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&sc_graf_pdf=\" + g + '&chart_level=' + chart_level;\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_asistencias_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_asistencias/grid_asistencias_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $colegio_id = $Busca_temp['colegio_id']; 
          $tmp_pos = strpos($colegio_id, "##@@");
          if ($tmp_pos !== false && !is_array($colegio_id))
          {
              $colegio_id = substr($colegio_id, 0, $tmp_pos);
          }
          $periodo_id = $Busca_temp['periodo_id']; 
          $tmp_pos = strpos($periodo_id, "##@@");
          if ($tmp_pos !== false && !is_array($periodo_id))
          {
              $periodo_id = substr($periodo_id, 0, $tmp_pos);
          }
          $curso_id = $Busca_temp['curso_id']; 
          $tmp_pos = strpos($curso_id, "##@@");
          if ($tmp_pos !== false && !is_array($curso_id))
          {
              $curso_id = substr($curso_id, 0, $tmp_pos);
          }
          $estudiante_id = $Busca_temp['estudiante_id']; 
          $tmp_pos = strpos($estudiante_id, "##@@");
          if ($tmp_pos !== false && !is_array($estudiante_id))
          {
              $estudiante_id = substr($estudiante_id, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_asistencias']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($avg_asistencia, $quebra_periodo_id, $quebra_curso_id, $quebra_estudiante_id, $quebra_asignatura_id, $quebra_periodo_id_orig, $quebra_curso_id_orig, $quebra_estudiante_id_orig, $quebra_asignatura_id_orig)
   {
      //----- Periodo
      if (!isset($this->array_total_periodo_id[$quebra_periodo_id_orig]))
      {
         $this->array_total_periodo_id[$quebra_periodo_id_orig][0] = 1;
         $this->array_total_periodo_id[$quebra_periodo_id_orig][1] = $avg_asistencia;
         $this->array_total_periodo_id[$quebra_periodo_id_orig][2] = $quebra_periodo_id;
         $this->array_total_periodo_id[$quebra_periodo_id_orig][3] = $quebra_periodo_id_orig;
      }
      else
      {
      ...
      //----- Curso
      if (!isset($this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig]))
      {
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][0] = 1;
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][1] = $avg_asistencia;
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][2] = $quebra_curso_id;
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][3] = $quebra_curso_id_orig;
      }
      else
      {
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][0]++;
         $this->array_total_curso_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][1] += $avg_asistencia;
      }
      //----- Estudiante
      if (!isset($this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig]))
      {
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][0] = 1;
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][1] = $avg_asistencia;
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][2] = $quebra_estudiante_id;
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][3] = $quebra_estudiante_id_orig;
      }
      else
      {
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][0]++;
         $this->array_total_estudiante_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][1] += $avg_asistencia;
      }
      //----- Asignatura
      if (!isset($this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig]))
      {
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][0] = 1;
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][1] = $avg_asistencia;
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][2] = $quebra_asignatura_id;
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][3] = $quebra_asignatura_id_orig;
      }
      else
      {
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][0]++;
         $this->array_total_asignatura_id[$quebra_periodo_id_orig][$quebra_curso_id_orig][$quebra_estudiante_id_orig][$quebra_asignatura_id_orig][1] += $avg_asistencia;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $format       = $this->Ini->Get_Gb_date_format('', 'curso_id');
     $campos_order = $this->Ini->Get_date_order_groupby("curso_id", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'estudiante_id');
     $campos_order = $this->Ini->Get_date_order_groupby("estudiante_id", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'asignatura_id');
     $campos_order = $this->Ini->Get_date_order_groupby("asignatura_id", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->curso_id = $rs_res->fields[1] ;  
            $this->fecha = $rs_res->fields[2] ;  
            $this->estudiante_id = $rs_res->fields[3] ;  
            $this->asignatura_id = $rs_res->fields[4] ;  
            $this->asistencia = $rs_res->fields[5] ;  
            $this->asistencia =  str_replace(",", ".", $this->asistencia);
            $this->colegio_id = $rs_res->fields[6] ;  
            ...
            $this->look_curso_id = $this->curso_id; 
            $this->Lookup->lookup_curso_id($this->look_curso_id, $this->curso_id, $_SESSION['vglo_colegio'], $_SESSION['vglo_periodo']) ; 
            $this->look_estudiante_id = $this->estudiante_id; 
            $this->Lookup->lookup_estudiante_id($this->look_estudiante_id, $this->estudiante_id, $_SESSION['vglo_colegio']) ; 
            $this->look_asignatura_id = $this->asignatura_id; 
            $this->Lookup->lookup_asignatura_id($this->look_asignatura_id, $this->asignatura_id, $_SESSION['vglo_colegio']) ; 
            ...
            $this->curso_id_orig = $this->curso_id;
            $this->estudiante_id_orig = $this->estudiante_id;
            $this->asignatura_id_orig = $this->asignatura_id;
            $this->periodo_id = $this->look_periodo_id ;
            $this->curso_id = $this->look_curso_id ;
            $this->estudiante_id = $this->look_estudiante_id ;
            $this->asignatura_id = $this->look_asignatura_id ;
            $this->asistencia = $this->look_asistencia ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->asistencia, $this->periodo_id, $this->curso_id, $this->estudiante_id, $this->asignatura_id, $this->periodo_id_orig,  $this->curso_id_orig,  $this->estudiante_id_orig,  $this->asignatura_id_orig);
            }
   }
//
