...
<?php
   ...
   $Ord_Cmp = new grid_asistencias_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_asistencias_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["periodo_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["periodo_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["periodo_id"] : "Periodo";
   $tab_ger_campos['curso_id'] = "on";
   $tab_def_campos['curso_id'] = "curso_id";
   $tab_converte["curso_id"]   = "curso_id";
   $tab_labels["curso_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["curso_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["curso_id"] : "Curso";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['estudiante_id'] = "on";
   $tab_def_campos['estudiante_id'] = "estudiante_id";
   $tab_converte["estudiante_id"]   = "estudiante_id";
   $tab_labels["estudiante_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["estudiante_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["estudiante_id"] : "Estudiante";
   $tab_ger_campos['asignatura_id'] = "on";
   $tab_def_campos['asignatura_id'] = "asignatura_id";
   $tab_converte["asignatura_id"]   = "asignatura_id";
   $tab_labels["asignatura_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["asignatura_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["asignatura_id"] : "Asignatura";
   $tab_ger_campos['asistencia'] = "on";
   $tab_def_campos['asistencia'] = "asistencia";
   $tab_converte["asistencia"]   = "asistencia";
   $tab_labels["asistencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["asistencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_asistencias']['labels']["asistencia"] : "Asistencia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_asistencias']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_asistencias']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> asistencias</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_asistencias_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_asistencias']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
