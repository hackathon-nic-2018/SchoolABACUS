  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_curso_asignaturas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_curso_asignaturas_validate_asignatura_id_(iNumLinha)
  {
    ...
    x_ajax_form_curso_asignaturas_validate_asignatura_id_(var_asignatura_id_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_asignatura_id__cb);
  } // do_ajax_form_curso_asignaturas_validate_asignatura_id_

  function do_ajax_form_curso_asignaturas_validate_asignatura_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_asignatura_id__cb

  // ---------- Validate docente_id_
  function do_ajax_form_curso_asignaturas_validate_docente_id_(iNumLinha)
  {
    var nomeCampo_docente_id_ = "docente_id_" + iNumLinha;
    var var_docente_id_ = scAjaxGetFieldSelect(nomeCampo_docente_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_validate_docente_id_(var_docente_id_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_docente_id__cb);
  } // do_ajax_form_curso_asignaturas_validate_docente_id_

  function do_ajax_form_curso_asignaturas_validate_docente_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "docente_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "docente_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "docente_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "docente_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_docente_id__cb

  // ---------- Validate comentarios_
  function do_ajax_form_curso_asignaturas_validate_comentarios_(iNumLinha)
  {
    var nomeCampo_comentarios_ = "comentarios_" + iNumLinha;
    var var_comentarios_ = scAjaxGetFieldText(nomeCampo_comentarios_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_validate_comentarios_(var_comentarios_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_comentarios__cb);
  } // do_ajax_form_curso_asignaturas_validate_comentarios_

  function do_ajax_form_curso_asignaturas_validate_comentarios__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "comentarios_" + iLineNumber;
    }
    else
    {
      sFieldValid = "comentarios_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "comentarios_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "comentarios_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_comentarios__cb

  // ---------- Validate colegio_id_
  function do_ajax_form_curso_asignaturas_validate_colegio_id_(iNumLinha)
  {
    var nomeCampo_colegio_id_ = "colegio_id_" + iNumLinha;
    var var_colegio_id_ = scAjaxGetFieldSelect(nomeCampo_colegio_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_validate_colegio_id_(var_colegio_id_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_colegio_id__cb);
  } // do_ajax_form_curso_asignaturas_validate_colegio_id_

  function do_ajax_form_curso_asignaturas_validate_colegio_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_colegio_id__cb

  // ---------- Validate periodo_id_
  function do_ajax_form_curso_asignaturas_validate_periodo_id_(iNumLinha)
  {
    var nomeCampo_periodo_id_ = "periodo_id_" + iNumLinha;
    var var_periodo_id_ = scAjaxGetFieldText(nomeCampo_periodo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_validate_periodo_id_(var_periodo_id_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_periodo_id__cb);
  } // do_ajax_form_curso_asignaturas_validate_periodo_id_

  function do_ajax_form_curso_asignaturas_validate_periodo_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_periodo_id__cb

  // ---------- Validate curso_id_
  function do_ajax_form_curso_asignaturas_validate_curso_id_(iNumLinha)
  {
    var nomeCampo_curso_id_ = "curso_id_" + iNumLinha;
    var var_curso_id_ = scAjaxGetFieldText(nomeCampo_curso_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_validate_curso_id_(var_curso_id_, iNumLinha, var_script_case_init, do_ajax_form_curso_asignaturas_validate_curso_id__cb);
  } // do_ajax_form_curso_asignaturas_validate_curso_id_

  function do_ajax_form_curso_asignaturas_validate_curso_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_asignaturas_validate_curso_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_curso_asignaturas_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_curso_asignaturas_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_curso_asignaturas_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_curso_asignaturas_add_new_line_cb);
  } // do_ajax_form_curso_asignaturas_add_new_line

  function do_ajax_form_curso_asignaturas_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_curso_asignaturas_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_curso_asignaturas_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_asignaturas_backup_line(var_colegio_id_, var_periodo_id_, var_curso_id_, var_asignatura_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_curso_asignaturas_backup_line_cb);
  } // do_ajax_form_curso_asignaturas_backup_line

  function do_ajax_form_curso_asignaturas_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_curso_asignaturas_backup_line_cb

  function do_ajax_form_curso_asignaturas_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_curso_asignaturas_cancel_insert

  function do_ajax_form_curso_asignaturas_cancel_update(iSeqVert)
  {
    do_ajax_form_curso_asignaturas_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_curso_asignaturas_cancel_update

  function do_ajax_form_curso_asignaturas_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_curso_asignaturas_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_curso_asignaturas_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_curso_asignaturas_table_refresh(var_colegio_id_, var_periodo_id_, var_curso_id_, var_asignatura_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_curso_asignaturas_table_refresh_cb);
  } //  do_ajax_form_curso_asignaturas_table_refresh

  function do_ajax_form_curso_asignaturas_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    sc_insert_open = false;
  } // do_ajax_form_curso_asignaturas_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_curso_asignaturas_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_curso_asignaturas_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_asignatura_id_ = scAjaxGetFieldSelect("asignatura_id_" + iNumLinha);
    var var_docente_id_ = scAjaxGetFieldSelect("docente_id_" + iNumLinha);
    var var_comentarios_ = scAjaxGetFieldText("comentarios_" + iNumLinha);
    var var_colegio_id_ = scAjaxGetFieldSelect("colegio_id_" + iNumLinha);
    var var_periodo_id_ = scAjaxGetFieldText("periodo_id_" + iNumLinha);
    var var_curso_id_ = scAjaxGetFieldText("curso_id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_curso_asignaturas_submit_form(var_asignatura_id_, var_docente_id_, var_comentarios_, var_colegio_id_, var_periodo_id_, var_curso_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_curso_asignaturas_submit_form_cb);
  } // do_ajax_form_curso_asignaturas_submit_form

  function do_ajax_form_curso_asignaturas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("docente_id_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("comentarios_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_curso_asignaturas_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_curso_asignaturas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_curso_asignaturas_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("docente_id_" + iNavForm);
      scAjaxHideErrorDisplay("comentarios_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_curso_asignaturas_navigate_form(var_colegio_id_, var_periodo_id_, var_curso_id_, var_asignatura_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_curso_asignaturas_navigate_form_cb);
  } // do_ajax_form_curso_asignaturas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_curso_asignaturas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_curso_asignaturas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
?>
  ...
  } // do_ajax_form_curso_asignaturas_navigate_form_cb
  function sc_hide_form_curso_asignaturas_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_curso_asignaturas_form
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "docente_id_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "comentarios_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["docente_id_" + iNumLinha] = {"label": "Docente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["comentarios_" + iNumLinha] = {"label": "Comentarios<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["docente_id_"][iNumLinha] = "docente_id_" + iNumLinha;
    ajax_field_mult["comentarios_"][iNumLinha] = "comentarios_" + iNumLinha;
    ...
    ajax_field_id["docente_id_" + iNumLinha] = new Array("hidden_field_label_docente_id_", "hidden_field_data_docente_id_" + iNumLinha);
    ajax_field_id["comentarios_" + iNumLinha] = new Array("hidden_field_label_comentarios_", "hidden_field_data_comentarios_" + iNumLinha);
    ajax_error_count["asignatura_id_" + iNumLinha] = "off";
    ajax_error_count["docente_id_" + iNumLinha] = "off";
    ajax_error_count["comentarios_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["docente_id_" + iNumLinha] = "off";
    ajax_read_only["comentarios_" + iNumLinha] = "off";
...
?>
    ajax_read_only["asignatura_id_" + iNumLinha] = "on";
    ajax_read_only["docente_id_" + iNumLinha] = "on";
    ajax_read_only["comentarios_" + iNumLinha] = "on";
    ajax_read_only["colegio_id_" + iNumLinha] = "on";
    ajax_read_only["periodo_id_" + iNumLinha] = "on";
    ajax_read_only["curso_id_" + iNumLinha] = "on";
<?php
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["docente_id_" + iNumLinha] = null;
    ajax_error_list["comentarios_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "docente_id_": new Array(),
    "comentarios_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["docente_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["docente_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["docente_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["docente_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["docente_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["comentarios_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["comentarios_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["comentarios_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["comentarios_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["comentarios_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['docente_id_'])) ? $this->nmgp_cmp_readonly['docente_id_'] : 'off';
?>
    scAjaxFieldRead("docente_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['comentarios_'])) ? $this->nmgp_cmp_readonly['comentarios_'] : 'off';
?>
    scAjaxFieldRead("comentarios_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("docente_id_" + iSeq, "on");
    scAjaxFieldRead("comentarios_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["asignatura_id_" + iRow] || "on" == ajax_error_count["docente_id_" + iRow] || "on" == ajax_error_count["comentarios_" + iRow] || "on" == ajax_error_count["colegio_id_" + iRow] || "on" == ajax_error_count["periodo_id_" + iRow] || "on" == ajax_error_count["curso_id_" + iRow]))
    {
      ...
      $("#hidden_field_data_docente_id_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_comentarios_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["asignatura_id_" + iRow] && "off" == ajax_error_count["docente_id_" + iRow] && "off" == ajax_error_count["comentarios_" + iRow] && "off" == ajax_error_count["colegio_id_" + iRow] && "off" == ajax_error_count["periodo_id_" + iRow] && "off" == ajax_error_count["curso_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["asignatura_id_" + iRow] = "off";
        ajax_error_count["docente_id_" + iRow] = "off";
        ajax_error_count["comentarios_" + iRow] = "off";
      ...
      $("#hidden_field_data_docente_id_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_comentarios_" + iRow).removeClass("scFormErrorLine");
