  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_usuarios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario
  function do_ajax_form_usuarios_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_usuarios_validate_usuario_cb);
  } // do_ajax_form_usuarios_validate_usuario

  function do_ajax_form_usuarios_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_usuario_cb

  // ---------- Validate usuario_nombre
  function do_ajax_form_usuarios_validate_usuario_nombre()
  {
    var nomeCampo_usuario_nombre = "usuario_nombre";
    var var_usuario_nombre = scAjaxGetFieldText(nomeCampo_usuario_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_usuario_nombre(var_usuario_nombre, var_script_case_init, do_ajax_form_usuarios_validate_usuario_nombre_cb);
  } // do_ajax_form_usuarios_validate_usuario_nombre

  function do_ajax_form_usuarios_validate_usuario_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_usuario_nombre_cb

  // ---------- Validate clave
  function do_ajax_form_usuarios_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldText(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_clave(var_clave, var_script_case_init, do_ajax_form_usuarios_validate_clave_cb);
  } // do_ajax_form_usuarios_validate_clave

  function do_ajax_form_usuarios_validate_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_clave_cb

  // ---------- Validate confirmar_clave
  function do_ajax_form_usuarios_validate_confirmar_clave()
  {
    var nomeCampo_confirmar_clave = "confirmar_clave";
    var var_confirmar_clave = scAjaxGetFieldText(nomeCampo_confirmar_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_confirmar_clave(var_confirmar_clave, var_script_case_init, do_ajax_form_usuarios_validate_confirmar_clave_cb);
  } // do_ajax_form_usuarios_validate_confirmar_clave

  function do_ajax_form_usuarios_validate_confirmar_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_confirmar_clave_cb

  // ---------- Validate tipo_usuario
  function do_ajax_form_usuarios_validate_tipo_usuario()
  {
    var nomeCampo_tipo_usuario = "tipo_usuario";
    var var_tipo_usuario = scAjaxGetFieldSelect(nomeCampo_tipo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_tipo_usuario(var_tipo_usuario, var_script_case_init, do_ajax_form_usuarios_validate_tipo_usuario_cb);
  } // do_ajax_form_usuarios_validate_tipo_usuario

  function do_ajax_form_usuarios_validate_tipo_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_tipo_usuario_cb

  // ---------- Validate usuario_correo
  function do_ajax_form_usuarios_validate_usuario_correo()
  {
    var nomeCampo_usuario_correo = "usuario_correo";
    var var_usuario_correo = scAjaxGetFieldText(nomeCampo_usuario_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_usuario_correo(var_usuario_correo, var_script_case_init, do_ajax_form_usuarios_validate_usuario_correo_cb);
  } // do_ajax_form_usuarios_validate_usuario_correo

  function do_ajax_form_usuarios_validate_usuario_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_usuario_correo_cb

  // ---------- Validate activo
  function do_ajax_form_usuarios_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_validate_activo(var_activo, var_script_case_init, do_ajax_form_usuarios_validate_activo_cb);
  } // do_ajax_form_usuarios_validate_activo

  function do_ajax_form_usuarios_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_validate_activo_cb
  // ---------- Form
  function do_ajax_form_usuarios_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_usuarios_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_submit_form(var_usuario, var_usuario_nombre, var_clave, var_confirmar_clave, var_tipo_usuario, var_usuario_correo, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_submit_form_cb);
  } // do_ajax_form_usuarios_submit_form

  function do_ajax_form_usuarios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_usuarios_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_usuarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_navigate_form(var_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_navigate_form_cb);
  } // do_ajax_form_usuarios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_usuarios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_usuarios_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_usuarios_navigate_form_cb
  function sc_hide_form_usuarios_form()
  {
