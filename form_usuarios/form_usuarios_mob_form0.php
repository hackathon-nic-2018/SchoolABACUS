...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['embutida_pdf']))
 {
 ?>
...
if (isset($_SESSION['scriptcase']['form_usuarios']['error_buffer']) && '' != $_SESSION['scriptcase']['form_usuarios']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_usuarios']['error_buffer'];
}
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_usuario_nombre_line" id="hidden_field_data_usuario_nombre" style="<?php echo $sStyleHidden_usuario_nombre; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_usuario_nombre_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_usuario_nombre_label"><span id="id_label_usuario_nombre"><?php echo $this->nm_new_label['usuario_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['usuario_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['usuario_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_clave_line" id="hidden_field_data_clave" style="<?php echo $sStyleHidden_clave; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_clave_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_clave_label"><span id="id_label_clave"><?php echo $this->nm_new_label['clave']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['clave']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['php_cmp_required']['clave'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_confirmar_clave_line" id="hidden_field_data_confirmar_clave" style="<?php echo $sStyleHidden_confirmar_clave; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_confirmar_clave_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_confirmar_clave_label"><span id="id_label_confirmar_clave"><?php echo $this->nm_new_label['confirmar_clave']; ?></span></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['tipo_usuario']) && $this->nmgp_cmp_readonly['tipo_usuario'] == 'on')
   {
       $bTestReadOnly = false;
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_usuario_line" id="hidden_field_data_tipo_usuario" style="<?php echo $sStyleHidden_tipo_usuario; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_usuario_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_usuario_label"><span id="id_label_tipo_usuario"><?php echo $this->nm_new_label['tipo_usuario']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tipo_usuario"]) &&  $this->nmgp_cmp_readonly["tipo_usuario"] == "on") { 
...
?>
<input type="hidden" name="tipo_usuario" value="<?php echo $this->form_encode_input($tipo_usuario) . "\">" . $tipo_usuario_look . ""; ?>
<?php } else { ?>
<?php
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tipo_usuario'][] = 'a'; ?>
 <option  value="d" <?php  if ($this->tipo_usuario == "d") { echo " selected" ;} ?>>Docente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tipo_usuario'][] = 'd'; ?>
 <option  value="e" <?php  if ($this->tipo_usuario == "e") { echo " selected" ;} ?>>Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tipo_usuario'][] = 'e'; ?>
 <option  value="p" <?php  if ($this->tipo_usuario == "p") { echo " selected" ;} ?>>Padre</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_tipo_usuario'][] = 'p'; ?>
 </select></span>
</span><?php  }?>
...
$activo_look = "";
 ...
 if (empty($activo_look)) { $activo_look = $this->activo; }
?>
<span id="id_read_on_activo" class="css_activo_line" style="<?php echo $sStyleReadLab_activo; ?>"><?php echo $this->form_encode_input($activo_look); ?></span><span id="id_read_off_activo" class="css_activo_line" style="<?php echo $sStyleReadInp_activo; ?>"><?php echo "<div id=\"idAjaxCheckbox_activo\" style=\"display: inline-block\" class=\"css_activo_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['Lookup_activo'][] = '1'; ?>
<?php  if (in_array("1", $this->activo_1))  { echo " checked" ;} ?> onClick="" ><span></span>
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_usuarios_mob");
</script>
<?php
    }
    else {
