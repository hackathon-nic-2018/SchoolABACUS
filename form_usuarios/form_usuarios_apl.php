   ...
   function ini_controle()
   {
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " usuarios";
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_usuarios' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_usuarios']['contr_erro'] = 'off'; 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['usuario_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['usuario_nombre'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if (($this->nmgp_opcao == "incluir" || 'validate_clave' == $this->NM_ajax_opcao) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['clave']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['clave'] == "on"))
      { 
          if ($this->clave == "")  
          { 
              $Campos_Falta[] =  "Clave" ; 
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['usuario']['keyVal'] = form_usuarios_pack_protect_string($this->nmgp_dados_form['usuario']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_usuarios_pack_protect_string('a') => form_usuarios_pack_protect_string("Administrador"));
$aLookup[] = array(form_usuarios_pack_protect_string('d') => form_usuarios_pack_protect_string("Docente"));
$aLookup[] = array(form_usuarios_pack_protect_string('e') => form_usuarios_pack_protect_string("Estudiante"));
$aLookup[] = array(form_usuarios_pack_protect_string('p') => form_usuarios_pack_protect_string("Padre"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'a';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'd';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'e';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'p';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_usuario']['valList'][$i] = form_usuarios_pack_protect_string($v);
          }
...
$aLookup[] = array(form_usuarios_pack_protect_string('1') => form_usuarios_pack_protect_string(""));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_activo'][] = '1';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
...
//----------- 
   ...
   { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['parms'] = "usuario?#?$this->usuario?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
