...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_usuario_nombre_label" id="hidden_field_label_usuario_nombre" style="<?php echo $sStyleHidden_usuario_nombre; ?>"><span id="id_label_usuario_nombre"><?php echo $this->nm_new_label['usuario_nombre']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['usuario_nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['usuario_nombre'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_clave_label" id="hidden_field_label_clave" style="<?php echo $sStyleHidden_clave; ?>"><span id="id_label_clave"><?php echo $this->nm_new_label['clave']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['clave']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['php_cmp_required']['clave'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'a'; ?>
 <option  value="d" <?php  if ($this->tipo_usuario == "d") { echo " selected" ;} ?>>Docente</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'd'; ?>
 <option  value="e" <?php  if ($this->tipo_usuario == "e") { echo " selected" ;} ?>>Estudiante</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'e'; ?>
 <option  value="p" <?php  if ($this->tipo_usuario == "p") { echo " selected" ;} ?>>Padre</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_tipo_usuario'][] = 'p'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['Lookup_activo'][] = '1'; ?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_usuarios");
</script>
<?php
    }
    else {
