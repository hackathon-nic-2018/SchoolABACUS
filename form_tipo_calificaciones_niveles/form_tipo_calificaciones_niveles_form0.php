...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_tipo_calificaciones_niveles_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_tipo_calificaciones_niveles_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['recarga'];
}
?>
...
<?php
 include_once("form_tipo_calificaciones_niveles_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_tipo_calificaciones_niveles'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_tipo_calificaciones_niveles'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['run_iframe'] != "R")
{
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nivel_label" id="hidden_field_label_nivel" style="<?php echo $sStyleHidden_nivel; ?>"><span id="id_label_nivel"><?php echo $this->nm_new_label['nivel']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['php_cmp_required']['nivel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['php_cmp_required']['nivel'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_nivel_line" id="hidden_field_data_nivel" style="<?php echo $sStyleHidden_nivel; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nivel_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_abreviacion_label" id="hidden_field_label_abreviacion" style="<?php echo $sStyleHidden_abreviacion; ?>"><span id="id_label_abreviacion"><?php echo $this->nm_new_label['abreviacion']; ?></span></TD>
    <TD class="scFormDataOdd css_abreviacion_line" id="hidden_field_data_abreviacion" style="<?php echo $sStyleHidden_abreviacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_abreviacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_minimo_label" id="hidden_field_label_minimo" style="<?php echo $sStyleHidden_minimo; ?>"><span id="id_label_minimo"><?php echo $this->nm_new_label['minimo']; ?></span></TD>
    <TD class="scFormDataOdd css_minimo_line" id="hidden_field_data_minimo" style="<?php echo $sStyleHidden_minimo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_minimo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_maximo_label" id="hidden_field_label_maximo" style="<?php echo $sStyleHidden_maximo; ?>"><span id="id_label_maximo"><?php echo $this->nm_new_label['maximo']; ?></span></TD>
    <TD class="scFormDataOdd css_maximo_line" id="hidden_field_data_maximo" style="<?php echo $sStyleHidden_maximo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_maximo_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_tipo_calificaciones_niveles");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_tipo_calificaciones_niveles");
 parent.scAjaxDetailHeight("form_tipo_calificaciones_niveles", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
