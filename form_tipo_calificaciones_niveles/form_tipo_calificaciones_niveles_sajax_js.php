  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_calificaciones_niveles" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nivel
  function do_ajax_form_tipo_calificaciones_niveles_validate_nivel()
  {
    var nomeCampo_nivel = "nivel";
    var var_nivel = scAjaxGetFieldText(nomeCampo_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_nivel(var_nivel, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_nivel_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_nivel

  function do_ajax_form_tipo_calificaciones_niveles_validate_nivel_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_nivel_cb

  // ---------- Validate abreviacion
  function do_ajax_form_tipo_calificaciones_niveles_validate_abreviacion()
  {
    var nomeCampo_abreviacion = "abreviacion";
    var var_abreviacion = scAjaxGetFieldText(nomeCampo_abreviacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_abreviacion(var_abreviacion, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_abreviacion_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_abreviacion

  function do_ajax_form_tipo_calificaciones_niveles_validate_abreviacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "abreviacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_abreviacion_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipo_calificaciones_niveles_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_descripcion_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_descripcion

  function do_ajax_form_tipo_calificaciones_niveles_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_descripcion_cb

  // ---------- Validate minimo
  function do_ajax_form_tipo_calificaciones_niveles_validate_minimo()
  {
    var nomeCampo_minimo = "minimo";
    var var_minimo = scAjaxGetFieldText(nomeCampo_minimo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_minimo(var_minimo, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_minimo_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_minimo

  function do_ajax_form_tipo_calificaciones_niveles_validate_minimo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "minimo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_minimo_cb

  // ---------- Validate maximo
  function do_ajax_form_tipo_calificaciones_niveles_validate_maximo()
  {
    var nomeCampo_maximo = "maximo";
    var var_maximo = scAjaxGetFieldText(nomeCampo_maximo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_maximo(var_maximo, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_maximo_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_maximo

  function do_ajax_form_tipo_calificaciones_niveles_validate_maximo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "maximo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_maximo_cb

  // ---------- Validate color
  function do_ajax_form_tipo_calificaciones_niveles_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_validate_color(var_color, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_validate_color_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_validate_color

  function do_ajax_form_tipo_calificaciones_niveles_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_validate_color_cb
  // ---------- Form
  function do_ajax_form_tipo_calificaciones_niveles_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_calificaciones_niveles_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nivel = scAjaxGetFieldText("nivel");
    var var_abreviacion = scAjaxGetFieldText("abreviacion");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_minimo = scAjaxGetFieldText("minimo");
    var var_maximo = scAjaxGetFieldText("maximo");
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_niveles_submit_form(var_nivel, var_abreviacion, var_descripcion, var_minimo, var_maximo, var_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_calificaciones_niveles_submit_form_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_submit_form

  function do_ajax_form_tipo_calificaciones_niveles_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nivel");
      scAjaxHideErrorDisplay("abreviacion");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("minimo");
      scAjaxHideErrorDisplay("maximo");
...
?>
  ...
  } // do_ajax_form_tipo_calificaciones_niveles_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_calificaciones_niveles_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_tipo_calificacion_id = document.F2.tipo_calificacion_id.value;
    var var_nivel = document.F2.nivel.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_niveles_navigate_form(var_colegio_id, var_tipo_calificacion_id, var_nivel, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_navigate_form_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_calificaciones_niveles_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.tipo_calificacion_id.value = scAjaxGetKeyValue("tipo_calificacion_id");
    document.F2.nivel.value = scAjaxGetKeyValue("nivel");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_tipo_calificaciones_niveles_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipo_calificaciones_niveles_navigate_form_cb
  function sc_hide_form_tipo_calificaciones_niveles_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tipo_calificaciones_niveles_form
  ...
  ajax_field_list[0] = "nivel";
  ajax_field_list[1] = "abreviacion";
  ajax_field_list[2] = "descripcion";
  ajax_field_list[3] = "minimo";
  ajax_field_list[4] = "maximo";
  ajax_field_list[5] = "color";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nivel": {"label": "Nivel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "abreviacion": {"label": "Abreviación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "minimo": {"label": "Mínimo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "maximo": {"label": "Máximo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "nivel": new Array(),
    "abreviacion": new Array(),
    "descripcion": new Array(),
    "minimo": new Array(),
    "maximo": new Array(),
    "color": new Array()
  };
  ajax_field_mult["nivel"][1] = "nivel";
  ajax_field_mult["abreviacion"][1] = "abreviacion";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["minimo"][1] = "minimo";
  ajax_field_mult["maximo"][1] = "maximo";
  ajax_field_mult["color"][1] = "color";

  var ajax_field_id = {
    "nivel": new Array("hidden_field_label_nivel", "hidden_field_data_nivel"),
    "abreviacion": new Array("hidden_field_label_abreviacion", "hidden_field_data_abreviacion"),
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "minimo": new Array("hidden_field_label_minimo", "hidden_field_data_minimo"),
    "maximo": new Array("hidden_field_label_maximo", "hidden_field_data_maximo"),
