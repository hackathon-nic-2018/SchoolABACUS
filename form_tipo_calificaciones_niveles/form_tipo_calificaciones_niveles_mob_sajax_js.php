  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_calificaciones_niveles_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate nivel
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel()
  {
    var nomeCampo_nivel = "nivel";
    var var_nivel = scAjaxGetFieldText(nomeCampo_nivel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel(var_nivel, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_nivel_cb

  // ---------- Validate abreviacion
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion()
  {
    var nomeCampo_abreviacion = "abreviacion";
    var var_abreviacion = scAjaxGetFieldText(nomeCampo_abreviacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion(var_abreviacion, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_abreviacion_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_descripcion_cb

  // ---------- Validate minimo
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo()
  {
    var nomeCampo_minimo = "minimo";
    var var_minimo = scAjaxGetFieldText(nomeCampo_minimo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo(var_minimo, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "minimo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_minimo_cb

  // ---------- Validate maximo
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo()
  {
    var nomeCampo_maximo = "maximo";
    var var_maximo = scAjaxGetFieldText(nomeCampo_maximo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo(var_maximo, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "maximo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_maximo_cb

  // ---------- Validate color
  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_niveles_mob_validate_color(var_color, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_validate_color_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_color

  function do_ajax_form_tipo_calificaciones_niveles_mob_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_niveles_mob_validate_color_cb
  // ---------- Form
  function do_ajax_form_tipo_calificaciones_niveles_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_calificaciones_niveles_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_niveles_mob_submit_form(var_nivel, var_abreviacion, var_descripcion, var_minimo, var_maximo, var_color, var_colegio_id, var_tipo_calificacion_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_calificaciones_niveles_mob_submit_form_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_submit_form

  function do_ajax_form_tipo_calificaciones_niveles_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_tipo_calificaciones_niveles_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_tipo_calificaciones_niveles_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_niveles_mob_navigate_form(var_colegio_id, var_tipo_calificacion_id, var_nivel, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_calificaciones_niveles_mob_navigate_form_cb);
  } // do_ajax_form_tipo_calificaciones_niveles_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_niveles_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_calificaciones_niveles_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_tipo_calificaciones_niveles_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipo_calificaciones_niveles_mob_navigate_form_cb
  function sc_hide_form_tipo_calificaciones_niveles_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_tipo_calificaciones_niveles_mob_form
