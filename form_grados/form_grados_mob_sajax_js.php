  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grados_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grado_id
  function do_ajax_form_grados_mob_validate_grado_id()
  {
    var nomeCampo_grado_id = "grado_id";
    var var_grado_id = scAjaxGetFieldText(nomeCampo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_mob_validate_grado_id(var_grado_id, var_script_case_init, do_ajax_form_grados_mob_validate_grado_id_cb);
  } // do_ajax_form_grados_mob_validate_grado_id

  function do_ajax_form_grados_mob_validate_grado_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_mob_validate_grado_id_cb

  // ---------- Validate grado_nombre
  function do_ajax_form_grados_mob_validate_grado_nombre()
  {
    var nomeCampo_grado_nombre = "grado_nombre";
    var var_grado_nombre = scAjaxGetFieldText(nomeCampo_grado_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_mob_validate_grado_nombre(var_grado_nombre, var_script_case_init, do_ajax_form_grados_mob_validate_grado_nombre_cb);
  } // do_ajax_form_grados_mob_validate_grado_nombre

  function do_ajax_form_grados_mob_validate_grado_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grado_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_mob_validate_grado_nombre_cb

  // ---------- Validate tipo_grado_id
  function do_ajax_form_grados_mob_validate_tipo_grado_id()
  {
    var nomeCampo_tipo_grado_id = "tipo_grado_id";
    var var_tipo_grado_id = scAjaxGetFieldSelect(nomeCampo_tipo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_mob_validate_tipo_grado_id(var_tipo_grado_id, var_script_case_init, do_ajax_form_grados_mob_validate_tipo_grado_id_cb);
  } // do_ajax_form_grados_mob_validate_tipo_grado_id

  function do_ajax_form_grados_mob_validate_tipo_grado_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_grado_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_mob_validate_tipo_grado_id_cb

  // ---------- Validate actualiza_estudiante
  function do_ajax_form_grados_mob_validate_actualiza_estudiante()
  {
    var nomeCampo_actualiza_estudiante = "actualiza_estudiante";
    var var_actualiza_estudiante = scAjaxGetFieldCheckbox(nomeCampo_actualiza_estudiante, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_mob_validate_actualiza_estudiante(var_actualiza_estudiante, var_script_case_init, do_ajax_form_grados_mob_validate_actualiza_estudiante_cb);
  } // do_ajax_form_grados_mob_validate_actualiza_estudiante

  function do_ajax_form_grados_mob_validate_actualiza_estudiante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "actualiza_estudiante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_mob_validate_actualiza_estudiante_cb

  // ---------- Validate asignaturas
  function do_ajax_form_grados_mob_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_mob_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_grados_mob_validate_asignaturas_cb);
  } // do_ajax_form_grados_mob_validate_asignaturas

  function do_ajax_form_grados_mob_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_mob_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_grados_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grados_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_grado_id = scAjaxGetFieldText("grado_id");
    var var_grado_nombre = scAjaxGetFieldText("grado_nombre");
    var var_tipo_grado_id = scAjaxGetFieldSelect("tipo_grado_id");
    var var_actualiza_estudiante = scAjaxGetFieldCheckbox("actualiza_estudiante", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_grados_mob_submit_form(var_grado_id, var_grado_nombre, var_tipo_grado_id, var_actualiza_estudiante, var_colegio_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grados_mob_submit_form_cb);
  } // do_ajax_form_grados_mob_submit_form

  function do_ajax_form_grados_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("grado_nombre");
      scAjaxHideErrorDisplay("tipo_grado_id");
      scAjaxHideErrorDisplay("actualiza_estudiante");
...
?>
  ...
  } // do_ajax_form_grados_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_asignaturas_grados"] = "off";

  function do_ajax_form_grados_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_grado_id = document.F2.grado_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_asignaturas_grados"] = "on";
    x_ajax_form_grados_mob_navigate_form(var_colegio_id, var_grado_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grados_mob_navigate_form_cb);
  } // do_ajax_form_grados_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grados_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grados_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_grados_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.colegio_id.value = scAjaxGetKeyValue("colegio_id");
    document.F2.grado_id.value = scAjaxGetKeyValue("grado_id");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_asignaturas_grados"] && "nmsc_iframe_liga_grid_asignaturas_grados" != scMasterDetailIframe["nmsc_iframe_liga_grid_asignaturas_grados"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_asignaturas_grados"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_asignaturas_grados').contentWindow.nm_move('apl_detalhe', true);
        }
        document.getElementById('nmsc_iframe_liga_grid_asignaturas_grados').style.height = "1";
        document.getElementById('nmsc_iframe_liga_grid_asignaturas_grados').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_grados_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_grados_mob_navigate_form_cb
  function sc_hide_form_grados_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_asignaturas_grados"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "grado_nombre";
  ajax_field_list[2] = "tipo_grado_id";
  ajax_field_list[3] = "actualiza_estudiante";
  ajax_field_list[4] = "asignaturas";
  ...
  var ajax_error_list = {
    "grado_id": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grado_nombre": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_grado_id": {"label": "Tipo de Grado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "actualiza_estudiante": {"label": "Actualiza Estudiante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "grado_id": new Array(),
    "grado_nombre": new Array(),
    "tipo_grado_id": new Array(),
    "actualiza_estudiante": new Array(),
    "asignaturas": new Array()
  };
  ajax_field_mult["grado_id"][1] = "grado_id";
  ajax_field_mult["grado_nombre"][1] = "grado_nombre";
  ajax_field_mult["tipo_grado_id"][1] = "tipo_grado_id";
  ajax_field_mult["actualiza_estudiante"][1] = "actualiza_estudiante";
  ajax_field_mult["asignaturas"][1] = "asignaturas";

  var ajax_field_id = {
    "grado_id": new Array("hidden_field_label_grado_id", "hidden_field_data_grado_id"),
    "grado_nombre": new Array("hidden_field_label_grado_nombre", "hidden_field_data_grado_nombre"),
    "tipo_grado_id": new Array("hidden_field_label_tipo_grado_id", "hidden_field_data_tipo_grado_id"),
    "actualiza_estudiante": new Array("hidden_field_label_actualiza_estudiante", "hidden_field_data_actualiza_estudiante"),
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("actualiza_estudiante" == sIndex)
    {
