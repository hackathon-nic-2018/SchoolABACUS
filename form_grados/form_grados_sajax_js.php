  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grados" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grado_id
  function do_ajax_form_grados_validate_grado_id()
  {
    var nomeCampo_grado_id = "grado_id";
    var var_grado_id = scAjaxGetFieldText(nomeCampo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_validate_grado_id(var_grado_id, var_script_case_init, do_ajax_form_grados_validate_grado_id_cb);
  } // do_ajax_form_grados_validate_grado_id

  function do_ajax_form_grados_validate_grado_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_validate_grado_id_cb

  // ---------- Validate grado_nombre
  function do_ajax_form_grados_validate_grado_nombre()
  {
    var nomeCampo_grado_nombre = "grado_nombre";
    var var_grado_nombre = scAjaxGetFieldText(nomeCampo_grado_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_validate_grado_nombre(var_grado_nombre, var_script_case_init, do_ajax_form_grados_validate_grado_nombre_cb);
  } // do_ajax_form_grados_validate_grado_nombre

  function do_ajax_form_grados_validate_grado_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_validate_grado_nombre_cb

  // ---------- Validate tipo_grado_id
  function do_ajax_form_grados_validate_tipo_grado_id()
  {
    var nomeCampo_tipo_grado_id = "tipo_grado_id";
    var var_tipo_grado_id = scAjaxGetFieldSelect(nomeCampo_tipo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_validate_tipo_grado_id(var_tipo_grado_id, var_script_case_init, do_ajax_form_grados_validate_tipo_grado_id_cb);
  } // do_ajax_form_grados_validate_tipo_grado_id

  function do_ajax_form_grados_validate_tipo_grado_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_validate_tipo_grado_id_cb

  // ---------- Validate actualiza_estudiante
  function do_ajax_form_grados_validate_actualiza_estudiante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_validate_actualiza_estudiante(var_actualiza_estudiante, var_script_case_init, do_ajax_form_grados_validate_actualiza_estudiante_cb);
  } // do_ajax_form_grados_validate_actualiza_estudiante

  function do_ajax_form_grados_validate_actualiza_estudiante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_validate_actualiza_estudiante_cb

  // ---------- Validate asignaturas
  function do_ajax_form_grados_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grados_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_grados_validate_asignaturas_cb);
  } // do_ajax_form_grados_validate_asignaturas

  function do_ajax_form_grados_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grados_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_grados_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grados_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_grados_submit_form(var_grado_id, var_grado_nombre, var_tipo_grado_id, var_actualiza_estudiante, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grados_submit_form_cb);
  } // do_ajax_form_grados_submit_form

  function do_ajax_form_grados_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_grados_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_asignaturas_grados"] = "off";

  function do_ajax_form_grados_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_grados_navigate_form(var_colegio_id, var_grado_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grados_navigate_form_cb);
  } // do_ajax_form_grados_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grados']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grados_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_grados_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_grados_navigate_form_cb
  function sc_hide_form_grados_form()
  {
