  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_asignaturas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_asignaturas_validate_asignatura_id()
  {
    var nomeCampo_asignatura_id = "asignatura_id";
    var var_asignatura_id = scAjaxGetFieldText(nomeCampo_asignatura_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_asignatura_id(var_asignatura_id, var_script_case_init, do_ajax_form_asignaturas_validate_asignatura_id_cb);
  } // do_ajax_form_asignaturas_validate_asignatura_id

  function do_ajax_form_asignaturas_validate_asignatura_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asignatura_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_asignatura_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_asignaturas_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_asignaturas_validate_descripcion_cb);
  } // do_ajax_form_asignaturas_validate_descripcion

  function do_ajax_form_asignaturas_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_descripcion_cb

  // ---------- Validate descripcion_detallada
  function do_ajax_form_asignaturas_validate_descripcion_detallada()
  {
    var nomeCampo_descripcion_detallada = "descripcion_detallada";
    var var_descripcion_detallada = scAjaxGetFieldEditorHtml(nomeCampo_descripcion_detallada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_descripcion_detallada(var_descripcion_detallada, var_script_case_init, do_ajax_form_asignaturas_validate_descripcion_detallada_cb);
  } // do_ajax_form_asignaturas_validate_descripcion_detallada

  function do_ajax_form_asignaturas_validate_descripcion_detallada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descripcion_detallada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_descripcion_detallada_cb

  // ---------- Validate especialidad_id
  function do_ajax_form_asignaturas_validate_especialidad_id()
  {
    var nomeCampo_especialidad_id = "especialidad_id";
    var var_especialidad_id = scAjaxGetFieldSelect(nomeCampo_especialidad_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_especialidad_id(var_especialidad_id, var_script_case_init, do_ajax_form_asignaturas_validate_especialidad_id_cb);
  } // do_ajax_form_asignaturas_validate_especialidad_id

  function do_ajax_form_asignaturas_validate_especialidad_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_especialidad_id_cb

  // ---------- Validate reportar_gobierno
  function do_ajax_form_asignaturas_validate_reportar_gobierno()
  {
    var nomeCampo_reportar_gobierno = "reportar_gobierno";
    var var_reportar_gobierno = scAjaxGetFieldCheckbox(nomeCampo_reportar_gobierno, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_reportar_gobierno(var_reportar_gobierno, var_script_case_init, do_ajax_form_asignaturas_validate_reportar_gobierno_cb);
  } // do_ajax_form_asignaturas_validate_reportar_gobierno

  function do_ajax_form_asignaturas_validate_reportar_gobierno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reportar_gobierno";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_reportar_gobierno_cb

  // ---------- Validate tipo_calificacion_id
  function do_ajax_form_asignaturas_validate_tipo_calificacion_id()
  {
    var nomeCampo_tipo_calificacion_id = "tipo_calificacion_id";
    var var_tipo_calificacion_id = scAjaxGetFieldSelect(nomeCampo_tipo_calificacion_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_asignaturas_validate_tipo_calificacion_id(var_tipo_calificacion_id, var_script_case_init, do_ajax_form_asignaturas_validate_tipo_calificacion_id_cb);
  } // do_ajax_form_asignaturas_validate_tipo_calificacion_id

  function do_ajax_form_asignaturas_validate_tipo_calificacion_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_calificacion_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_asignaturas_validate_tipo_calificacion_id_cb
  // ---------- Form
  function do_ajax_form_asignaturas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_asignaturas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_asignatura_id = scAjaxGetFieldText("asignatura_id");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_descripcion_detallada = scAjaxGetFieldEditorHtml("descripcion_detallada");
    var var_especialidad_id = scAjaxGetFieldSelect("especialidad_id");
    var var_reportar_gobierno = scAjaxGetFieldCheckbox("reportar_gobierno", ";");
    var var_tipo_calificacion_id = scAjaxGetFieldSelect("tipo_calificacion_id");
    ...
    scAjaxProcOn();
    x_ajax_form_asignaturas_submit_form(var_asignatura_id, var_descripcion, var_descripcion_detallada, var_especialidad_id, var_reportar_gobierno, var_tipo_calificacion_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_asignaturas_submit_form_cb);
  } // do_ajax_form_asignaturas_submit_form

  function do_ajax_form_asignaturas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("asignatura_id");
      scAjaxHideErrorDisplay("descripcion");
      scAjaxHideErrorDisplay("descripcion_detallada");
      scAjaxHideErrorDisplay("especialidad_id");
      scAjaxHideErrorDisplay("reportar_gobierno");
      scAjaxHideErrorDisplay("tipo_calificacion_id");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_asignaturas_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_asignaturas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_asignatura_id = document.F2.asignatura_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_asignaturas_navigate_form(var_colegio_id, var_asignatura_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_asignaturas_navigate_form_cb);
  } // do_ajax_form_asignaturas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_asignaturas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_asignaturas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_asignaturas_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.colegio_id.value = scAjaxGetKeyValue("colegio_id");
    document.F2.asignatura_id.value = scAjaxGetKeyValue("asignatura_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_asignaturas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_asignaturas_navigate_form_cb
  function sc_hide_form_asignaturas_form()
  {
  ...
  ajax_field_list[0] = "asignatura_id";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "descripcion_detallada";
  ajax_field_list[3] = "especialidad_id";
  ajax_field_list[4] = "reportar_gobierno";
  ajax_field_list[5] = "tipo_calificacion_id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "asignatura_id": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_detallada": {"label": "Descripción Detallada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "especialidad_id": {"label": "Especialidad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "reportar_gobierno": {"label": "Reportar Gobierno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_calificacion_id": {"label": "Tipo Calificación ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "asignatura_id": new Array(),
    "descripcion": new Array(),
    "descripcion_detallada": new Array(),
    "especialidad_id": new Array(),
    "reportar_gobierno": new Array(),
    "tipo_calificacion_id": new Array()
  };
  ajax_field_mult["asignatura_id"][1] = "asignatura_id";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["descripcion_detallada"][1] = "descripcion_detallada";
  ajax_field_mult["especialidad_id"][1] = "especialidad_id";
  ajax_field_mult["reportar_gobierno"][1] = "reportar_gobierno";
  ajax_field_mult["tipo_calificacion_id"][1] = "tipo_calificacion_id";

  var ajax_field_id = {
    "asignatura_id": new Array("hidden_field_label_asignatura_id", "hidden_field_data_asignatura_id"),
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "descripcion_detallada": new Array("hidden_field_label_descripcion_detallada", "hidden_field_data_descripcion_detallada"),
    "especialidad_id": new Array("hidden_field_label_especialidad_id", "hidden_field_data_especialidad_id"),
    "reportar_gobierno": new Array("hidden_field_label_reportar_gobierno", "hidden_field_data_reportar_gobierno"),
    "tipo_calificacion_id": new Array("hidden_field_label_tipo_calificacion_id", "hidden_field_data_tipo_calificacion_id")
  };

  var ajax_read_only = {
    "asignatura_id": "on",
    "descripcion": "off",
    "descripcion_detallada": "off",
    "especialidad_id": "off",
    "reportar_gobierno": "off",
    "tipo_calificacion_id": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("descripcion_detallada" == sIndex)
    {
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("tipo_calificacion_id" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
