...
<?php
   ...
   $Ord_Cmp = new grid_grados_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_grados_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['grado_id'] = "on";
   $tab_def_campos['grado_id'] = "grado_id";
   $tab_converte["grado_id"]   = "grado_id";
   $tab_labels["grado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["grado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["grado_id"] : "Código";
   $tab_ger_campos['grado_nombre'] = "on";
   $tab_def_campos['grado_nombre'] = "grado_nombre";
   $tab_converte["grado_nombre"]   = "grado_nombre";
   $tab_labels["grado_nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["grado_nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["grado_nombre"] : "Descripción";
   $tab_ger_campos['tipo_grado_id'] = "on";
   $tab_def_campos['tipo_grado_id'] = "tipo_grado_id";
   $tab_converte["tipo_grado_id"]   = "tipo_grado_id";
   $tab_labels["tipo_grado_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["tipo_grado_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["tipo_grado_id"] : "Tipo Grado";
   $tab_ger_campos['actualiza_estudiante'] = "on";
   $tab_def_campos['actualiza_estudiante'] = "actualiza_estudiante";
   $tab_converte["actualiza_estudiante"]   = "actualiza_estudiante";
   $tab_labels["actualiza_estudiante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["actualiza_estudiante"])) ? $_SESSION['sc_session'][$sc_init]['grid_grados']['labels']["actualiza_estudiante"] : "Actualiza Estudiante";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grados']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grados']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grados']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> grados</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_grados_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_grados']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
