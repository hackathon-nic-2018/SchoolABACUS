...
class grid_grados_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          $this->Tit_doc    = "grid_grados" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['embutida_label'])
      { 
      ...
      while (!$rs->EOF)
      {
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['embutida'])
         { 
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['embutida'])
      { 
   ...
   function NM_export_grado_id()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->grado_id);
         $this->Xls_col++;
   }
   //----- grado_nombre
   function NM_export_grado_nombre()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->grado_nombre, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- tipo_grado_id
   function NM_export_tipo_grado_id()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
         if (is_numeric($this->look_tipo_grado_id))
         {
             $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getNumberFormat()->setFormatCode('###0');
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_tipo_grado_id);
         $this->Xls_col++;
   }
   ...
   function NM_export_actualiza_estudiante()
   {
         ...
         $this->Nm_ActiveSheet->getStyle($current_cell_ref . $this->Xls_row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
         $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_actualiza_estudiante, PHPExcel_Cell_DataType::TYPE_STRING);
         $this->Xls_col++;
   }
   //----- colegio_id
   ...
   function NM_sub_cons_grado_id()
   {
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->grado_id;
   ...
   //----- grado_nombre
   function NM_sub_cons_grado_nombre()
   {
         $this->grado_nombre = html_entity_decode($this->grado_nombre, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->grado_nombre = strip_tags($this->grado_nombre);
         if (!NM_is_utf8($this->grado_nombre))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->grado_nombre;
   ...
   //----- tipo_grado_id
   function NM_sub_cons_tipo_grado_id()
   {
         if (!NM_is_utf8($this->look_tipo_grado_id))
         {
             $this->look_tipo_grado_id = sc_convert_encoding($this->look_tipo_grado_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_tipo_grado_id;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "###0";
         $this->Xls_col++;
   ...
   //----- actualiza_estudiante
   function NM_sub_cons_actualiza_estudiante()
   {
         $this->look_actualiza_estudiante = html_entity_decode($this->look_actualiza_estudiante, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_actualiza_estudiante = strip_tags($this->look_actualiza_estudiante);
         if (!NM_is_utf8($this->look_actualiza_estudiante))
         ...
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_actualiza_estudiante;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_grados']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> grados :: Excel</TITLE>
