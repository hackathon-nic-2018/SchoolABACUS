  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_padres_estudiantes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate padre_id
  function do_ajax_form_padres_estudiantes_validate_padre_id()
  {
  } // do_ajax_form_padres_estudiantes_validate_padre_id

  function do_ajax_form_padres_estudiantes_validate_padre_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "padre_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_validate_padre_id_cb

  // ---------- Validate parentezco
  function do_ajax_form_padres_estudiantes_validate_parentezco()
  {
    var nomeCampo_parentezco = "parentezco";
    var var_parentezco = scAjaxGetFieldText(nomeCampo_parentezco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_validate_parentezco(var_parentezco, var_script_case_init, do_ajax_form_padres_estudiantes_validate_parentezco_cb);
  } // do_ajax_form_padres_estudiantes_validate_parentezco

  function do_ajax_form_padres_estudiantes_validate_parentezco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "parentezco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_validate_parentezco_cb

  // ---------- Validate tutor
  function do_ajax_form_padres_estudiantes_validate_tutor()
  {
    var nomeCampo_tutor = "tutor";
    var var_tutor = scAjaxGetFieldCheckbox(nomeCampo_tutor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_validate_tutor(var_tutor, var_script_case_init, do_ajax_form_padres_estudiantes_validate_tutor_cb);
  } // do_ajax_form_padres_estudiantes_validate_tutor

  function do_ajax_form_padres_estudiantes_validate_tutor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tutor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_validate_tutor_cb

  // ---------- Validate patrocinador
  function do_ajax_form_padres_estudiantes_validate_patrocinador()
  {
    var nomeCampo_patrocinador = "patrocinador";
    var var_patrocinador = scAjaxGetFieldCheckbox(nomeCampo_patrocinador, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_validate_patrocinador(var_patrocinador, var_script_case_init, do_ajax_form_padres_estudiantes_validate_patrocinador_cb);
  } // do_ajax_form_padres_estudiantes_validate_patrocinador

  function do_ajax_form_padres_estudiantes_validate_patrocinador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patrocinador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_validate_patrocinador_cb

  // ---------- Validate llamar_emergencia
  function do_ajax_form_padres_estudiantes_validate_llamar_emergencia()
  {
    var nomeCampo_llamar_emergencia = "llamar_emergencia";
    var var_llamar_emergencia = scAjaxGetFieldCheckbox(nomeCampo_llamar_emergencia, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_validate_llamar_emergencia(var_llamar_emergencia, var_script_case_init, do_ajax_form_padres_estudiantes_validate_llamar_emergencia_cb);
  } // do_ajax_form_padres_estudiantes_validate_llamar_emergencia

  function do_ajax_form_padres_estudiantes_validate_llamar_emergencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "llamar_emergencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_validate_llamar_emergencia_cb
  // ---------- Form
  function do_ajax_form_padres_estudiantes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_padres_estudiantes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_padre_id = scAjaxGetFieldText("padre_id");
    var var_parentezco = scAjaxGetFieldText("parentezco");
    var var_tutor = scAjaxGetFieldCheckbox("tutor", ";");
    var var_patrocinador = scAjaxGetFieldCheckbox("patrocinador", ";");
    var var_llamar_emergencia = scAjaxGetFieldCheckbox("llamar_emergencia", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_padres_estudiantes_submit_form(var_padre_id, var_parentezco, var_tutor, var_patrocinador, var_llamar_emergencia, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_padres_estudiantes_submit_form_cb);
  } // do_ajax_form_padres_estudiantes_submit_form

  function do_ajax_form_padres_estudiantes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("padre_id");
      scAjaxHideErrorDisplay("parentezco");
      scAjaxHideErrorDisplay("tutor");
      scAjaxHideErrorDisplay("patrocinador");
      scAjaxHideErrorDisplay("llamar_emergencia");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_padres_estudiantes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_padres_estudiantes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_padre_id = document.F2.padre_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_padres_estudiantes_navigate_form(var_colegio_id, var_padre_id, var_estudiante_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_padres_estudiantes_navigate_form_cb);
  } // do_ajax_form_padres_estudiantes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres_estudiantes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_padres_estudiantes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.padre_id.value = scAjaxGetKeyValue("padre_id");
...
{
?>
    do_ajax_form_padres_estudiantes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_padres_estudiantes_navigate_form_cb
  function sc_hide_form_padres_estudiantes_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_padres_estudiantes_form
  ...
  ajax_field_list[0] = "padre_id";
  ajax_field_list[1] = "parentezco";
  ajax_field_list[2] = "tutor";
  ajax_field_list[3] = "patrocinador";
  ajax_field_list[4] = "llamar_emergencia";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "padre_id": {"label": "Padre ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "parentezco": {"label": "Parentezco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tutor": {"label": "Tutor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "patrocinador": {"label": "Patrocinador", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "llamar_emergencia": {"label": "Llamar Emergencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "tutor": new Array(),
    "patrocinador": new Array(),
    "llamar_emergencia": new Array()
  };
  ajax_field_mult["padre_id"][1] = "padre_id";
  ajax_field_mult["parentezco"][1] = "parentezco";
  ajax_field_mult["tutor"][1] = "tutor";
  ajax_field_mult["patrocinador"][1] = "patrocinador";
  ajax_field_mult["llamar_emergencia"][1] = "llamar_emergencia";

  var ajax_field_id = {
    "padre_id": new Array("hidden_field_label_padre_id", "hidden_field_data_padre_id"),
    "parentezco": new Array("hidden_field_label_parentezco", "hidden_field_data_parentezco"),
    "tutor": new Array("hidden_field_label_tutor", "hidden_field_data_tutor"),
    "patrocinador": new Array("hidden_field_label_patrocinador", "hidden_field_data_patrocinador"),
    "llamar_emergencia": new Array("hidden_field_label_llamar_emergencia", "hidden_field_data_llamar_emergencia")
  };
