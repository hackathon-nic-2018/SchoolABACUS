  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_padres_estudiantes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate padre_id
  function do_ajax_form_padres_estudiantes_mob_validate_padre_id()
  {
  } // do_ajax_form_padres_estudiantes_mob_validate_padre_id

  function do_ajax_form_padres_estudiantes_mob_validate_padre_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_mob_validate_padre_id_cb

  // ---------- Validate parentezco
  function do_ajax_form_padres_estudiantes_mob_validate_parentezco()
  {
    var nomeCampo_parentezco = "parentezco";
    var var_parentezco = scAjaxGetFieldText(nomeCampo_parentezco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_mob_validate_parentezco(var_parentezco, var_script_case_init, do_ajax_form_padres_estudiantes_mob_validate_parentezco_cb);
  } // do_ajax_form_padres_estudiantes_mob_validate_parentezco

  function do_ajax_form_padres_estudiantes_mob_validate_parentezco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_mob_validate_parentezco_cb

  // ---------- Validate tutor
  function do_ajax_form_padres_estudiantes_mob_validate_tutor()
  {
    var nomeCampo_tutor = "tutor";
    var var_tutor = scAjaxGetFieldCheckbox(nomeCampo_tutor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_mob_validate_tutor(var_tutor, var_script_case_init, do_ajax_form_padres_estudiantes_mob_validate_tutor_cb);
  } // do_ajax_form_padres_estudiantes_mob_validate_tutor

  function do_ajax_form_padres_estudiantes_mob_validate_tutor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tutor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_mob_validate_tutor_cb

  // ---------- Validate patrocinador
  function do_ajax_form_padres_estudiantes_mob_validate_patrocinador()
  {
    var nomeCampo_patrocinador = "patrocinador";
    var var_patrocinador = scAjaxGetFieldCheckbox(nomeCampo_patrocinador, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_mob_validate_patrocinador(var_patrocinador, var_script_case_init, do_ajax_form_padres_estudiantes_mob_validate_patrocinador_cb);
  } // do_ajax_form_padres_estudiantes_mob_validate_patrocinador

  function do_ajax_form_padres_estudiantes_mob_validate_patrocinador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_mob_validate_patrocinador_cb

  // ---------- Validate llamar_emergencia
  function do_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia(var_llamar_emergencia, var_script_case_init, do_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia_cb);
  } // do_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia

  function do_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_padres_estudiantes_mob_validate_llamar_emergencia_cb
  // ---------- Form
  function do_ajax_form_padres_estudiantes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_padres_estudiantes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_padres_estudiantes_mob_submit_form(var_padre_id, var_parentezco, var_tutor, var_patrocinador, var_llamar_emergencia, var_colegio_id, var_estudiante_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_padres_estudiantes_mob_submit_form_cb);
  } // do_ajax_form_padres_estudiantes_mob_submit_form

  function do_ajax_form_padres_estudiantes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_padres_estudiantes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_padres_estudiantes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_padres_estudiantes_mob_navigate_form(var_colegio_id, var_padre_id, var_estudiante_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_padres_estudiantes_mob_navigate_form_cb);
  } // do_ajax_form_padres_estudiantes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_padres_estudiantes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_padres_estudiantes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_padres_estudiantes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_padres_estudiantes_mob_navigate_form_cb
  function sc_hide_form_padres_estudiantes_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_padres_estudiantes_mob_form
