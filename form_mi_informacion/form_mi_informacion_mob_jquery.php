...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_usuario_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_mi_informacion_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario_nombre' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_usuario_nombre_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_mi_informacion_usuario_nombre_onfocus(this, iSeqRow) });
  $('#id_sc_field_clave' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_clave_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_mi_informacion_clave_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_usuario' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_tipo_usuario_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_mi_informacion_tipo_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario_correo' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_usuario_correo_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_mi_informacion_usuario_correo_onfocus(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_activo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mi_informacion_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_confirmar_clave' + iSeqRow).bind('blur', function() { sc_form_mi_informacion_confirmar_clave_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_mi_informacion_confirmar_clave_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_mi_informacion_usuario_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_usuario();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_usuario_nombre_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_usuario_nombre();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_usuario_nombre_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_clave_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_clave();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_clave_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_tipo_usuario_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_tipo_usuario();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_tipo_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_usuario_correo_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_usuario_correo();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_usuario_correo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_activo_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_activo();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mi_informacion_confirmar_clave_onblur(oThis, iSeqRow) {
  do_ajax_form_mi_informacion_mob_validate_confirmar_clave();
  scCssBlur(oThis);
}

function sc_form_mi_informacion_confirmar_clave_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_mi_informacion_mob_form" + pageNo).hide();
}
