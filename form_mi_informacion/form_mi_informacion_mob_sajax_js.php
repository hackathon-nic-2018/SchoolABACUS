  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mi_informacion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate usuario
  function do_ajax_form_mi_informacion_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_usuario_cb);
  } // do_ajax_form_mi_informacion_mob_validate_usuario

  function do_ajax_form_mi_informacion_mob_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_usuario_cb

  // ---------- Validate usuario_nombre
  function do_ajax_form_mi_informacion_mob_validate_usuario_nombre()
  {
    var nomeCampo_usuario_nombre = "usuario_nombre";
    var var_usuario_nombre = scAjaxGetFieldText(nomeCampo_usuario_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_usuario_nombre(var_usuario_nombre, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_usuario_nombre_cb);
  } // do_ajax_form_mi_informacion_mob_validate_usuario_nombre

  function do_ajax_form_mi_informacion_mob_validate_usuario_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_nombre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_usuario_nombre_cb

  // ---------- Validate confirmar_clave
  function do_ajax_form_mi_informacion_mob_validate_confirmar_clave()
  {
    var nomeCampo_confirmar_clave = "confirmar_clave";
    var var_confirmar_clave = scAjaxGetFieldText(nomeCampo_confirmar_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_confirmar_clave(var_confirmar_clave, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_confirmar_clave_cb);
  } // do_ajax_form_mi_informacion_mob_validate_confirmar_clave

  function do_ajax_form_mi_informacion_mob_validate_confirmar_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "confirmar_clave";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_confirmar_clave_cb

  // ---------- Validate clave
  function do_ajax_form_mi_informacion_mob_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldText(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_clave(var_clave, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_clave_cb);
  } // do_ajax_form_mi_informacion_mob_validate_clave

  function do_ajax_form_mi_informacion_mob_validate_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_clave_cb

  // ---------- Validate tipo_usuario
  function do_ajax_form_mi_informacion_mob_validate_tipo_usuario()
  {
    var nomeCampo_tipo_usuario = "tipo_usuario";
    var var_tipo_usuario = scAjaxGetFieldSelect(nomeCampo_tipo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_tipo_usuario(var_tipo_usuario, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_tipo_usuario_cb);
  } // do_ajax_form_mi_informacion_mob_validate_tipo_usuario

  function do_ajax_form_mi_informacion_mob_validate_tipo_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_tipo_usuario_cb

  // ---------- Validate usuario_correo
  function do_ajax_form_mi_informacion_mob_validate_usuario_correo()
  {
    var nomeCampo_usuario_correo = "usuario_correo";
    var var_usuario_correo = scAjaxGetFieldText(nomeCampo_usuario_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_usuario_correo(var_usuario_correo, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_usuario_correo_cb);
  } // do_ajax_form_mi_informacion_mob_validate_usuario_correo

  function do_ajax_form_mi_informacion_mob_validate_usuario_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_correo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_usuario_correo_cb

  // ---------- Validate activo
  function do_ajax_form_mi_informacion_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldSelect(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mi_informacion_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_mi_informacion_mob_validate_activo_cb);
  } // do_ajax_form_mi_informacion_mob_validate_activo

  function do_ajax_form_mi_informacion_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mi_informacion_mob_validate_activo_cb
  // ---------- Form
  function do_ajax_form_mi_informacion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mi_informacion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usuario = scAjaxGetFieldText("usuario");
    var var_usuario_nombre = scAjaxGetFieldText("usuario_nombre");
    var var_confirmar_clave = scAjaxGetFieldText("confirmar_clave");
    var var_clave = scAjaxGetFieldText("clave");
    var var_tipo_usuario = scAjaxGetFieldSelect("tipo_usuario");
    var var_usuario_correo = scAjaxGetFieldText("usuario_correo");
    ...
    scAjaxProcOn();
    x_ajax_form_mi_informacion_mob_submit_form(var_usuario, var_usuario_nombre, var_confirmar_clave, var_clave, var_tipo_usuario, var_usuario_correo, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mi_informacion_mob_submit_form_cb);
  } // do_ajax_form_mi_informacion_mob_submit_form

  function do_ajax_form_mi_informacion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("usuario_nombre");
      scAjaxHideErrorDisplay("confirmar_clave");
      scAjaxHideErrorDisplay("clave");
      scAjaxHideErrorDisplay("tipo_usuario");
      scAjaxHideErrorDisplay("usuario_correo");
...
?>
  ...
  } // do_ajax_form_mi_informacion_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_mi_informacion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("usuario_correo");
    scAjaxHideErrorDisplay("activo");
    var var_usuario = document.F2.usuario.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mi_informacion_mob_navigate_form(var_usuario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mi_informacion_mob_navigate_form_cb);
  } // do_ajax_form_mi_informacion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mi_informacion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mi_informacion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_mi_informacion_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.usuario.value = scAjaxGetKeyValue("usuario");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_mi_informacion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mi_informacion_mob_navigate_form_cb
  function sc_hide_form_mi_informacion_mob_form()
  {
  ...
  ajax_field_list[1] = "usuario_nombre";
  ajax_field_list[2] = "confirmar_clave";
  ajax_field_list[3] = "clave";
  ajax_field_list[4] = "tipo_usuario";
  ajax_field_list[5] = "usuario_correo";
  ajax_field_list[6] = "activo";
  ...
  var ajax_error_list = {
    ...
    "usuario_nombre": {"label": "Usuario Nombre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "confirmar_clave": {"label": "Confirmar Clave", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "clave": {"label": "Clave", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_usuario": {"label": "Tipo Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_correo": {"label": "Usuario Correo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "usuario": new Array(),
    "usuario_nombre": new Array(),
    "confirmar_clave": new Array(),
    "clave": new Array(),
    "tipo_usuario": new Array(),
    "usuario_correo": new Array(),
    "activo": new Array()
  };
  ajax_field_mult["usuario"][1] = "usuario";
  ajax_field_mult["usuario_nombre"][1] = "usuario_nombre";
  ajax_field_mult["confirmar_clave"][1] = "confirmar_clave";
  ajax_field_mult["clave"][1] = "clave";
  ajax_field_mult["tipo_usuario"][1] = "tipo_usuario";
  ajax_field_mult["usuario_correo"][1] = "usuario_correo";
  ajax_field_mult["activo"][1] = "activo";

  var ajax_field_id = {
    "usuario": new Array("hidden_field_label_usuario", "hidden_field_data_usuario"),
    "usuario_nombre": new Array("hidden_field_label_usuario_nombre", "hidden_field_data_usuario_nombre"),
    "confirmar_clave": new Array("hidden_field_label_confirmar_clave", "hidden_field_data_confirmar_clave"),
    "clave": new Array("hidden_field_label_clave", "hidden_field_data_clave"),
    "tipo_usuario": new Array("hidden_field_label_tipo_usuario", "hidden_field_data_tipo_usuario"),
    "usuario_correo": new Array("hidden_field_label_usuario_correo", "hidden_field_data_usuario_correo"),
