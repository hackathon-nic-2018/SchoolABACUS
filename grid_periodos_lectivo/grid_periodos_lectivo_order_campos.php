...
<?php
   ...
   $Ord_Cmp = new grid_periodos_lectivo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_periodos_lectivo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['periodo_descripcion'] = "on";
   $tab_def_campos['periodo_descripcion'] = "periodo_descripcion";
   $tab_converte["periodo_descripcion"]   = "periodo_descripcion";
   $tab_labels["periodo_descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["periodo_descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["periodo_descripcion"] : "Descripcion";
   $tab_ger_campos['desde'] = "on";
   $tab_def_campos['desde'] = "desde";
   $tab_converte["desde"]   = "desde";
   $tab_labels["desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["desde"])) ? $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["desde"] : "Desde";
   $tab_ger_campos['hasta'] = "on";
   $tab_def_campos['hasta'] = "hasta";
   $tab_converte["hasta"]   = "hasta";
   $tab_labels["hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["hasta"])) ? $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["hasta"] : "Hasta";
   $tab_ger_campos['tipo_periodo_id'] = "on";
   $tab_def_campos['tipo_periodo_id'] = "tipo_periodo_id";
   $tab_converte["tipo_periodo_id"]   = "tipo_periodo_id";
   $tab_labels["tipo_periodo_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["tipo_periodo_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['labels']["tipo_periodo_id"] : "Tipo Periodo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_periodos_lectivo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_periodos_lectivo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
