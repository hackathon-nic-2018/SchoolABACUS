...
class grid_periodos_lectivo_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_periodos_lectivo']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_periodos_lectivo']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_total($res_limit=false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_periodos_lectivo']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_periodos_lectivo']['where_pesq']; 
      } 
      ...
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_periodos_lectivo']['contr_total_geral'] = "OK";
   } 
