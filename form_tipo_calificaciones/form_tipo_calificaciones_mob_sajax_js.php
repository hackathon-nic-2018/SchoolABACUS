  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_calificaciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id()
  {
    var nomeCampo_tipo_calificacion_id = "tipo_calificacion_id";
    var var_tipo_calificacion_id = scAjaxGetFieldText(nomeCampo_tipo_calificacion_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id(var_tipo_calificacion_id, var_script_case_init, do_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id_cb);
  } // do_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id

  function do_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_mob_validate_tipo_calificacion_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_tipo_calificaciones_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tipo_calificaciones_mob_validate_descripcion_cb);
  } // do_ajax_form_tipo_calificaciones_mob_validate_descripcion

  function do_ajax_form_tipo_calificaciones_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_mob_validate_descripcion_cb

  // ---------- Validate detalle
  function do_ajax_form_tipo_calificaciones_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_tipo_calificaciones_mob_validate_detalle_cb);
  } // do_ajax_form_tipo_calificaciones_mob_validate_detalle

  function do_ajax_form_tipo_calificaciones_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_mob_validate_detalle_cb

  // ---------- Validate niveles
  function do_ajax_form_tipo_calificaciones_mob_validate_niveles()
  {
    var nomeCampo_niveles = "niveles";
    var var_niveles = scAjaxGetFieldText(nomeCampo_niveles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_calificaciones_mob_validate_niveles(var_niveles, var_script_case_init, do_ajax_form_tipo_calificaciones_mob_validate_niveles_cb);
  } // do_ajax_form_tipo_calificaciones_mob_validate_niveles

  function do_ajax_form_tipo_calificaciones_mob_validate_niveles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "niveles";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_calificaciones_mob_validate_niveles_cb
  // ---------- Form
  function do_ajax_form_tipo_calificaciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipo_calificaciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo_calificacion_id = scAjaxGetFieldText("tipo_calificacion_id");
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_calificaciones_mob_submit_form(var_tipo_calificacion_id, var_descripcion, var_colegio_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_calificaciones_mob_submit_form_cb);
  } // do_ajax_form_tipo_calificaciones_mob_submit_form

  function do_ajax_form_tipo_calificaciones_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("niveles");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_tipo_calificaciones_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["form_tipo_calificaciones_detalle_mob"] = "off";
  scStatusDetail["form_tipo_calificaciones_niveles_mob"] = "off";

  function do_ajax_form_tipo_calificaciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_tipo_calificaciones_detalle_mob"] = "on";
    scStatusDetail["form_tipo_calificaciones_niveles_mob"] = "on";
    x_ajax_form_tipo_calificaciones_mob_navigate_form(var_colegio_id, var_tipo_calificacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_calificaciones_mob_navigate_form_cb);
  } // do_ajax_form_tipo_calificaciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_calificaciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_calificaciones_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_tipo_calificaciones_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob"] && "nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_detalle_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob"] && "nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_tipo_calificaciones_niveles_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_tipo_calificaciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tipo_calificaciones_mob_navigate_form_cb
  function sc_hide_form_tipo_calificaciones_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_tipo_calificaciones_detalle_mob"] && "off" == scStatusDetail["form_tipo_calificaciones_niveles_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "tipo_calificacion_id";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "detalle";
  ajax_field_list[3] = "niveles";
  ...
  var ajax_error_list = {
    "tipo_calificacion_id": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "niveles": {"label": "Niveles", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["niveles"][1] = "niveles";
  ...
  var ajax_field_id = {
    ...
    "niveles": new Array("hidden_field_label_niveles", "hidden_field_data_niveles")
  };

  var ajax_read_only = {
    "tipo_calificacion_id": "on",
    "descripcion": "off",
    "detalle": "off",
    "niveles": "off"
  };
