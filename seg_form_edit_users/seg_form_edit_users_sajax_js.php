  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seg_form_edit_users" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_seg_form_edit_users_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_login(var_login, var_script_case_init, do_ajax_seg_form_edit_users_validate_login_cb);
  } // do_ajax_seg_form_edit_users_validate_login

  function do_ajax_seg_form_edit_users_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_seg_form_edit_users_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_pswd(var_pswd, var_script_case_init, do_ajax_seg_form_edit_users_validate_pswd_cb);
  } // do_ajax_seg_form_edit_users_validate_pswd

  function do_ajax_seg_form_edit_users_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pswd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_pswd_cb

  // ---------- Validate confirm_pswd
  function do_ajax_seg_form_edit_users_validate_confirm_pswd()
  {
    var nomeCampo_confirm_pswd = "confirm_pswd";
    var var_confirm_pswd = scAjaxGetFieldText(nomeCampo_confirm_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_confirm_pswd(var_confirm_pswd, var_script_case_init, do_ajax_seg_form_edit_users_validate_confirm_pswd_cb);
  } // do_ajax_seg_form_edit_users_validate_confirm_pswd

  function do_ajax_seg_form_edit_users_validate_confirm_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_confirm_pswd_cb

  // ---------- Validate name
  function do_ajax_seg_form_edit_users_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_name(var_name, var_script_case_init, do_ajax_seg_form_edit_users_validate_name_cb);
  } // do_ajax_seg_form_edit_users_validate_name

  function do_ajax_seg_form_edit_users_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_name_cb

  // ---------- Validate email
  function do_ajax_seg_form_edit_users_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_email(var_email, var_script_case_init, do_ajax_seg_form_edit_users_validate_email_cb);
  } // do_ajax_seg_form_edit_users_validate_email

  function do_ajax_seg_form_edit_users_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_email_cb

  // ---------- Validate active
  function do_ajax_seg_form_edit_users_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldCheckbox(nomeCampo_active, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_active(var_active, var_script_case_init, do_ajax_seg_form_edit_users_validate_active_cb);
  } // do_ajax_seg_form_edit_users_validate_active

  function do_ajax_seg_form_edit_users_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_active_cb

  // ---------- Validate groups
  function do_ajax_seg_form_edit_users_validate_groups()
  {
    var nomeCampo_groups = "groups";
    var var_groups = scAjaxGetFieldCheckbox(nomeCampo_groups, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_edit_users_validate_groups(var_groups, var_script_case_init, do_ajax_seg_form_edit_users_validate_groups_cb);
  } // do_ajax_seg_form_edit_users_validate_groups

  function do_ajax_seg_form_edit_users_validate_groups_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "groups";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_edit_users_validate_groups_cb
  // ---------- Form
  function do_ajax_seg_form_edit_users_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_seg_form_edit_users_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_seg_form_edit_users_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_active, var_groups, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_form_edit_users_submit_form_cb);
  } // do_ajax_seg_form_edit_users_submit_form

  function do_ajax_seg_form_edit_users_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_seg_form_edit_users_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_seg_form_edit_users_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_seg_form_edit_users_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_form_edit_users_navigate_form_cb);
  } // do_ajax_seg_form_edit_users_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_edit_users']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seg_form_edit_users_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_seg_form_edit_users_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_seg_form_edit_users_navigate_form_cb
  function sc_hide_seg_form_edit_users_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_seg_form_edit_users_form
