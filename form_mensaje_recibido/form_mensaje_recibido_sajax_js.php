  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mensaje_recibido" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_mensaje_recibido_validate_enviado_por()
  {
    var nomeCampo_enviado_por = "enviado_por";
    var var_enviado_por = scAjaxGetFieldText(nomeCampo_enviado_por);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_validate_enviado_por(var_enviado_por, var_script_case_init, do_ajax_form_mensaje_recibido_validate_enviado_por_cb);
  } // do_ajax_form_mensaje_recibido_validate_enviado_por

  function do_ajax_form_mensaje_recibido_validate_enviado_por_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_validate_enviado_por_cb

  // ---------- Validate titulo
  function do_ajax_form_mensaje_recibido_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_mensaje_recibido_validate_titulo_cb);
  } // do_ajax_form_mensaje_recibido_validate_titulo

  function do_ajax_form_mensaje_recibido_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_validate_titulo_cb

  // ---------- Validate fecha_hora_enviado
  function do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_validate_fecha_hora_enviado(var_fecha_hora_enviado, var_script_case_init, do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado_cb);
  } // do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado

  function do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado_cb

  // ---------- Validate mensaje
  function do_ajax_form_mensaje_recibido_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldEditorHtml(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_mensaje_recibido_validate_mensaje_cb);
  } // do_ajax_form_mensaje_recibido_validate_mensaje

  function do_ajax_form_mensaje_recibido_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_validate_mensaje_cb
  // ---------- Form
  function do_ajax_form_mensaje_recibido_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mensaje_recibido_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_recibido_submit_form(var_enviado_por, var_titulo, var_fecha_hora_enviado, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mensaje_recibido_submit_form_cb);
  } // do_ajax_form_mensaje_recibido_submit_form

  function do_ajax_form_mensaje_recibido_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_mensaje_recibido_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_mensaje_recibido_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_recibido_navigate_form(var_colegio_id, var_notificacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mensaje_recibido_navigate_form_cb);
  } // do_ajax_form_mensaje_recibido_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mensaje_recibido']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mensaje_recibido_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_mensaje_recibido_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mensaje_recibido_navigate_form_cb
  function sc_hide_form_mensaje_recibido_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_mensaje_recibido_form
