  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mensaje_recibido_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate enviado_por
  function do_ajax_form_mensaje_recibido_mob_validate_enviado_por()
  {
    var nomeCampo_enviado_por = "enviado_por";
    var var_enviado_por = scAjaxGetFieldText(nomeCampo_enviado_por);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_mob_validate_enviado_por(var_enviado_por, var_script_case_init, do_ajax_form_mensaje_recibido_mob_validate_enviado_por_cb);
  } // do_ajax_form_mensaje_recibido_mob_validate_enviado_por

  function do_ajax_form_mensaje_recibido_mob_validate_enviado_por_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enviado_por";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_mob_validate_enviado_por_cb

  // ---------- Validate titulo
  function do_ajax_form_mensaje_recibido_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_mensaje_recibido_mob_validate_titulo_cb);
  } // do_ajax_form_mensaje_recibido_mob_validate_titulo

  function do_ajax_form_mensaje_recibido_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_mob_validate_titulo_cb

  // ---------- Validate fecha_hora_enviado
  function do_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado(var_fecha_hora_enviado, var_script_case_init, do_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado_cb);
  } // do_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado

  function do_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_mob_validate_fecha_hora_enviado_cb

  // ---------- Validate mensaje
  function do_ajax_form_mensaje_recibido_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldEditorHtml(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_recibido_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_mensaje_recibido_mob_validate_mensaje_cb);
  } // do_ajax_form_mensaje_recibido_mob_validate_mensaje

  function do_ajax_form_mensaje_recibido_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_recibido_mob_validate_mensaje_cb
  // ---------- Form
  function do_ajax_form_mensaje_recibido_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mensaje_recibido_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_enviado_por = scAjaxGetFieldText("enviado_por");
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_recibido_mob_submit_form(var_enviado_por, var_titulo, var_fecha_hora_enviado, var_mensaje, var_colegio_id, var_notificacion_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mensaje_recibido_mob_submit_form_cb);
  } // do_ajax_form_mensaje_recibido_mob_submit_form

  function do_ajax_form_mensaje_recibido_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("enviado_por");
...
?>
  ...
  } // do_ajax_form_mensaje_recibido_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_mensaje_recibido_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_recibido_mob_navigate_form(var_colegio_id, var_notificacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mensaje_recibido_mob_navigate_form_cb);
  } // do_ajax_form_mensaje_recibido_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mensaje_recibido_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mensaje_recibido_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_mensaje_recibido_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_mensaje_recibido_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mensaje_recibido_mob_navigate_form_cb
  function sc_hide_form_mensaje_recibido_mob_form()
  {
  ...
  ajax_field_list[0] = "enviado_por";
  ajax_field_list[1] = "titulo";
  ajax_field_list[2] = "fecha_hora_enviado";
  ajax_field_list[3] = "mensaje";
  ...
  var ajax_error_list = {
    "enviado_por": {"label": "Enviado Por", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
