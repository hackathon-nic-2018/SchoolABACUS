...
<input type="hidden" name="notificacion_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['notificacion_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_mensaje_recibido']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_mensaje_recibido"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mensaje_recibido']['where_detal']))
  {
?>  
...
function lookup_enviado_por(campo)
{
   dados  = document.F1.enviado_por.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_mensaje_recibido')?>/form_mensaje_recibido.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&script_case_session=<?php echo session_id() ?>&nmgp_opcao=lookup", recebe_enviado_por, "enviado_por", dados, false);
}
function recebe_enviado_por(string)
{
   document.getElementById('id_lookup_enviado_por').innerHTML = string;
}
<?php 
