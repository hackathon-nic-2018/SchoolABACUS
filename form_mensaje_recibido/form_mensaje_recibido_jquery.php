...
function scEventControl_init(iSeqRow) {
  scEventControl_data["enviado_por" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["enviado_por" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["enviado_por" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_enviado_por' + iSeqRow).bind('blur', function() { sc_form_mensaje_recibido_enviado_por_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_mensaje_recibido_enviado_por_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_mensaje_recibido_enviado_por_onfocus(this, iSeqRow) });
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_mensaje_recibido_titulo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_mensaje_recibido_titulo_onfocus(this, iSeqRow) });
  $('#id_sc_field_mensaje' + iSeqRow).bind('blur', function() { sc_form_mensaje_recibido_mensaje_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_mensaje_recibido_mensaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hora_enviado' + iSeqRow).bind('blur', function() { sc_form_mensaje_recibido_fecha_hora_enviado_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_mensaje_recibido_fecha_hora_enviado_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hora_enviado_hora' + iSeqRow).bind('blur', function() { sc_form_mensaje_recibido_fecha_hora_enviado_hora_onblur(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_mensaje_recibido_fecha_hora_enviado_hora_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_mensaje_recibido_enviado_por_onblur(oThis, iSeqRow) {
  do_ajax_form_mensaje_recibido_validate_enviado_por();
  scCssBlur(oThis);
}

function sc_form_mensaje_recibido_enviado_por_onchange(oThis, iSeqRow) {
  lookup_enviado_por();
}

function sc_form_mensaje_recibido_enviado_por_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensaje_recibido_titulo_onblur(oThis, iSeqRow) {
  do_ajax_form_mensaje_recibido_validate_titulo();
  scCssBlur(oThis);
}

function sc_form_mensaje_recibido_titulo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensaje_recibido_mensaje_onblur(oThis, iSeqRow) {
  do_ajax_form_mensaje_recibido_validate_mensaje();
  scCssBlur(oThis);
}

function sc_form_mensaje_recibido_mensaje_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensaje_recibido_fecha_hora_enviado_onblur(oThis, iSeqRow) {
  do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado();
  scCssBlur(oThis);
}

function sc_form_mensaje_recibido_fecha_hora_enviado_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado();
  scCssBlur(oThis);
}

function sc_form_mensaje_recibido_fecha_hora_enviado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_mensaje_recibido_fecha_hora_enviado_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	displayChange_field("enviado_por", "", status);
...
function displayChange_row(row, status) {
	displayChange_field_enviado_por(row, status);
...
function displayChange_field_enviado_por(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_mensaje_recibido_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_hora_enviado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mensaje_recibido_validate_fecha_hora_enviado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_fecha_hora_recibido" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mensaje_recibido_validate_fecha_hora_recibido(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
