  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_cambiar_clave_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate clave_actual
  function do_ajax_control_cambiar_clave_mob_validate_clave_actual()
  {
    var nomeCampo_clave_actual = "clave_actual";
    var var_clave_actual = scAjaxGetFieldText(nomeCampo_clave_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cambiar_clave_mob_validate_clave_actual(var_clave_actual, var_script_case_init, do_ajax_control_cambiar_clave_mob_validate_clave_actual_cb);
  } // do_ajax_control_cambiar_clave_mob_validate_clave_actual

  function do_ajax_control_cambiar_clave_mob_validate_clave_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave_actual";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cambiar_clave_mob_validate_clave_actual_cb

  // ---------- Validate nueva_clave
  function do_ajax_control_cambiar_clave_mob_validate_nueva_clave()
  {
    var nomeCampo_nueva_clave = "nueva_clave";
    var var_nueva_clave = scAjaxGetFieldText(nomeCampo_nueva_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cambiar_clave_mob_validate_nueva_clave(var_nueva_clave, var_script_case_init, do_ajax_control_cambiar_clave_mob_validate_nueva_clave_cb);
  } // do_ajax_control_cambiar_clave_mob_validate_nueva_clave

  function do_ajax_control_cambiar_clave_mob_validate_nueva_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nueva_clave";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cambiar_clave_mob_validate_nueva_clave_cb

  // ---------- Validate confirmar_clave
  function do_ajax_control_cambiar_clave_mob_validate_confirmar_clave()
  {
    var nomeCampo_confirmar_clave = "confirmar_clave";
    var var_confirmar_clave = scAjaxGetFieldText(nomeCampo_confirmar_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cambiar_clave_mob_validate_confirmar_clave(var_confirmar_clave, var_script_case_init, do_ajax_control_cambiar_clave_mob_validate_confirmar_clave_cb);
  } // do_ajax_control_cambiar_clave_mob_validate_confirmar_clave

  function do_ajax_control_cambiar_clave_mob_validate_confirmar_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cambiar_clave_mob_validate_confirmar_clave_cb
  // ---------- Form
  function do_ajax_control_cambiar_clave_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_cambiar_clave_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_clave_actual = scAjaxGetFieldText("clave_actual");
    var var_nueva_clave = scAjaxGetFieldText("nueva_clave");
    ...
    scAjaxProcOn();
    x_ajax_control_cambiar_clave_mob_submit_form(var_clave_actual, var_nueva_clave, var_confirmar_clave, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_cambiar_clave_mob_submit_form_cb);
  } // do_ajax_control_cambiar_clave_mob_submit_form

  function do_ajax_control_cambiar_clave_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_control_cambiar_clave_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_cambiar_clave_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_cambiar_clave_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_cambiar_clave_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_cambiar_clave_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_control_cambiar_clave_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_cambiar_clave_mob_navigate_form_cb
  function sc_hide_control_cambiar_clave_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_control_cambiar_clave_mob_form
  ...
  ajax_field_list[0] = "clave_actual";
  ajax_field_list[1] = "nueva_clave";
  ...
  var ajax_error_list = {
    "clave_actual": {"label": "Clave Actual", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nueva_clave": {"label": "Nueva Clave", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "clave_actual": new Array(),
    "nueva_clave": new Array(),
    "confirmar_clave": new Array()
  };
  ajax_field_mult["clave_actual"][1] = "clave_actual";
  ajax_field_mult["nueva_clave"][1] = "nueva_clave";
  ajax_field_mult["confirmar_clave"][1] = "confirmar_clave";

  var ajax_field_id = {
    "clave_actual": new Array("hidden_field_label_clave_actual", "hidden_field_data_clave_actual"),
    "nueva_clave": new Array("hidden_field_label_nueva_clave", "hidden_field_data_nueva_clave"),
