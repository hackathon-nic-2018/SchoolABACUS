...
$old_error_handler = set_error_handler("control_cambiar_clave_scriptcase_error_handler");

function control_cambiar_clave_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_cambiar_clave']['contr_erro']) && $_SESSION['scriptcase']['control_cambiar_clave']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_cambiar_clave->contr_control_cambiar_clave->Apl_com_erro = true;
            if ($inicial_control_cambiar_clave->contr_control_cambiar_clave->NM_ajax_flag)
            {
                $inicial_control_cambiar_clave->contr_control_cambiar_clave->NM_ajax_info['errList']['geral_control_cambiar_clave'][] = $msg;
                return;
            }
            control_cambiar_clave_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_cambiar_clave_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_cambiar_clave'])  && '' != $_SESSION['scriptcase']['error_icon']['control_cambiar_clave'])  ? $_SESSION['scriptcase']['error_icon']['control_cambiar_clave']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_cambiar_clave']) && '' != $_SESSION['scriptcase']['error_close']['control_cambiar_clave']) ? $_SESSION['scriptcase']['error_close']['control_cambiar_clave'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_cambiar_clave']) && '' != $_SESSION['scriptcase']['error_span_title']['control_cambiar_clave']) ? $_SESSION['scriptcase']['error_span_title']['control_cambiar_clave'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_cambiar_clave']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_cambiar_clave']) ? $_SESSION['scriptcase']['error_icon_title']['control_cambiar_clave'] : '';
?>
