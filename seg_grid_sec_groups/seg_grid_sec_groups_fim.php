...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["school_abacus_____seg_grid_sec_groups"]))
   {
      unset($_SESSION['session_sec_aplicacao']["school_abacus_____seg_grid_sec_groups"]);
   }
