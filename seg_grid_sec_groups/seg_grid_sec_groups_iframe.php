...
?>
 ...
 function checkPDF() {
  $.get(nm_url_rand("seg_grid_sec_groups_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['seg_grid_sec_groups']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['seg_grid_sec_groups']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_seg_grid_sec_groups.pdf';
...
$_SESSION['sc_session'][$aParams['script_case_init']]['seg_grid_sec_groups'][$path_doc_md5][0] = $NM_pdfurl . "/" . $NM_pdfbase;
