...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc8_PictonBlue/Sc8_PictonBlue_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_principal"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
