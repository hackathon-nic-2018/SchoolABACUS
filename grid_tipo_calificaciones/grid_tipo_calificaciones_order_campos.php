...
<?php
   ...
   $Ord_Cmp = new grid_tipo_calificaciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tipo_calificaciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['tipo_calificacion_id'] = "tipo_calificacion_id";
   $tab_converte["tipo_calificacion_id"]   = "tipo_calificacion_id";
   $tab_labels["tipo_calificacion_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['labels']["tipo_calificacion_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['labels']["tipo_calificacion_id"] : "Código";
   $tab_ger_campos['descripcion'] = "on";
   $tab_def_campos['descripcion'] = "descripcion";
   $tab_converte["descripcion"]   = "descripcion";
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['labels']["descripcion"] : "Descripción";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tipo_calificaciones_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_tipo_calificaciones']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
