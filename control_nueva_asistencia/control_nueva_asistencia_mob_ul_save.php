...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['control_nueva_asistencia_mob']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['control_nueva_asistencia_mob']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['control_nueva_asistencia_mob']['upload_field_info'][ $_POST['param_field'] ];
