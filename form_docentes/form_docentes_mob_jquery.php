...
function scHidePage(pageNo) {
	$("#id_form_docentes_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_ingreso" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_docentes_mob_validate_fecha_ingreso(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_fotografia" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_docentes_mob_ul_save.php",
