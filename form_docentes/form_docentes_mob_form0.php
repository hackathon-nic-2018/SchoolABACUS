...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " docentes"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " docentes"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['embutida_pdf']))
 {
 ?>
...
if (isset($_SESSION['scriptcase']['form_docentes']['error_buffer']) && '' != $_SESSION['scriptcase']['form_docentes']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_docentes']['error_buffer'];
}
...
<input type="hidden" name="docente_id" value="<?php  echo $this->form_encode_input($this->docente_id) ?>">
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['apellidos'] = "Apellidos";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type="hidden" name="apellidos" value="<?php echo $this->form_encode_input($apellidos) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_apellidos_line" id="hidden_field_data_apellidos" style="<?php echo $sStyleHidden_apellidos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_apellidos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_apellidos_label"><span id="id_label_apellidos"><?php echo $this->nm_new_label['apellidos']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["apellidos"]) &&  $this->nmgp_cmp_readonly["apellidos"] == "on") { 

 ?>
<input type="hidden" name="apellidos" value="<?php echo $this->form_encode_input($apellidos) . "\">" . $apellidos . ""; ?>
<?php } else { ?>
<span id="id_read_on_apellidos" class="sc-ui-readonly-apellidos css_apellidos_line" style="<?php echo $sStyleReadLab_apellidos; ?>"><?php echo $this->form_encode_input($this->apellidos); ?></span><span id="id_read_off_apellidos" style="white-space: nowrap;<?php echo $sStyleReadInp_apellidos; ?>">
 <input class="sc-js-input scFormObjectOdd css_apellidos_obj" style="" id="id_sc_field_apellidos" type=text name="apellidos" value="<?php echo $this->form_encode_input($apellidos) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_apellidos_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_apellidos_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombres_line" id="hidden_field_data_nombres" style="<?php echo $sStyleHidden_nombres; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombres_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nombres_label"><span id="id_label_nombres"><?php echo $this->nm_new_label['nombres']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_identificacion" class="sc-ui-readonly-identificacion css_identificacion_line" style="<?php echo $sStyleReadLab_identificacion; ?>"><?php echo $this->form_encode_input($this->identificacion); ?></span><span id="id_read_off_identificacion" style="white-space: nowrap;<?php echo $sStyleReadInp_identificacion; ?>">
 <input class="sc-js-input scFormObjectOdd css_identificacion_obj" style="" id="id_sc_field_identificacion" type=text name="identificacion" value="<?php echo $this->form_encode_input($identificacion) ?>"
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_fecha_ingreso_line" id="hidden_field_data_fecha_ingreso" style="<?php echo $sStyleHidden_fecha_ingreso; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_ingreso_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_fecha_ingreso_label"><span id="id_label_fecha_ingreso"><?php echo $this->nm_new_label['fecha_ingreso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['php_cmp_required']['fecha_ingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['php_cmp_required']['fecha_ingreso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estatus_line" id="hidden_field_data_estatus" style="<?php echo $sStyleHidden_estatus; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estatus_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estatus_label"><span id="id_label_estatus"><?php echo $this->nm_new_label['estatus']; ?></span></span><br>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   {
       $this->nm_new_label['especialidad_id'] = "Especialidad Id";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
...
<?php 
  ...
  {
      $this->especialidad_id_1 = explode(";", trim($this->especialidad_id));
  } 
  else
  {
      ...
      else
      {
          ...
          foreach ($this->especialidad_id_1 as $cada_especialidad_id)
          {
             if (!empty($this->especialidad_id))
             {
                 $this->especialidad_id.= ";"; 
             } 
             $this->especialidad_id.= $cada_especialidad_id; 
          } 
      } 
  } 
?> 

    <TD class="scFormDataOdd css_especialidad_id_line" id="hidden_field_data_especialidad_id" style="<?php echo $sStyleHidden_especialidad_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_especialidad_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_especialidad_id_label"><span id="id_label_especialidad_id"><?php echo $this->nm_new_label['especialidad_id']; ?></span></span><br>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          foreach ($this->especialidad_id_1 as $Dados)
          {
              if ($Dados === $cadaselect[1])
              {
                  $especialidad_id_look .= $cadaselect[0] . "&nbsp;";
                  break;
              }
          }
          $x++; 
...
<?php
   ...
   while (!empty($todo[$x])) 
   {
          ...
          foreach ($this->especialidad_id_1 as $Dados)
          {
              if ($Dados === $cadaselect[1])
              {
                  $especialidad_id_look .= $cadaselect[0] . "<br>";
                  break;
              }
          }
          $x++; 
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_especialidad_id\" class=\"css_especialidad_id_line\" style=\"" .  $sStyleReadLab_especialidad_id . "\">" . $this->form_encode_input($especialidad_id_look) . "</span><span id=\"id_read_off_especialidad_id\" class=\"css_especialidad_id_line\" style=\"" . $sStyleReadInp_especialidad_id . "\">";
   echo "<div id=\"idAjaxCheckbox_especialidad_id\" class=\"css_especialidad_id_line\" style=\"display: inline-block\">\r\n";
   $y = 0 ; 
   ...
   while (!empty($todo[$x])) 
   {
          ...
          echo "  <td class=\"scFormDataFontOdd  css_especialidad_id_line\">\r\n";
          echo "      <div class=\"sc switch\">";
          $tempOptionId = "id-opt-especialidad_id-" . $x;
          echo "      <input type=checkbox id=\"" . $tempOptionId . "\" class=\"sc-ui-checkbox-especialidad_id sc-ui-checkbox-especialidad_id\" name=\"especialidad_id[]\" value=\"$cadacheck[1]\"" ; 
          foreach ($this->especialidad_id_1 as $Dados)
          {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_direccion_linea1_line" id="hidden_field_data_direccion_linea1" style="<?php echo $sStyleHidden_direccion_linea1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_linea1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_direccion_linea1_label"><span id="id_label_direccion_linea1"><?php echo $this->nm_new_label['direccion_linea1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_direccion_linea2_line" id="hidden_field_data_direccion_linea2" style="<?php echo $sStyleHidden_direccion_linea2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_direccion_linea2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_direccion_linea2_label"><span id="id_label_direccion_linea2"><?php echo $this->nm_new_label['direccion_linea2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentarios_line" id="hidden_field_data_comentarios" style="<?php echo $sStyleHidden_comentarios; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentarios_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_comentarios_label"><span id="id_label_comentarios"><?php echo $this->nm_new_label['comentarios']; ?></span></span><br>
<?php
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_docentes_mob");
</script>
<?php
    }
    else {
