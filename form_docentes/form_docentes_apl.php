...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['form_docentes']['upload_field_info']['fotografia'] = array(
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_docentes']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_docentes']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " docentes";
      ...
      $_SESSION['scriptcase']['error_icon']['form_docentes']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['upload_field_ul_name'][$this->fotografia_ul_name]))
          {
              $this->NM_ajax_info['param']['fotografia_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['upload_field_ul_name'][$this->fotografia_ul_name];
          }
      ...
      elseif (isset($this->fotografia_ul_name) && '' != $this->fotografia_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['upload_field_ul_name'][$this->fotografia_ul_name]))
          {
              $this->fotografia_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['upload_field_ul_name'][$this->fotografia_ul_name];
          }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_orig'] = " where colegio_id = " . $_SESSION['vglo_colegio'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_pesq'] = " where colegio_id = " . $_SESSION['vglo_colegio'] . "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_docentes'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_docentes'];
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_docentes/form_docentes_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_docentes_calendar.php');
          }
          exit;
      }
...
//---
    ...
    function ValidateField_fecha_ingreso(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['php_cmp_required']['fecha_ingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['php_cmp_required']['fecha_ingreso'] == "on") 
           { 
    ...
    {
        global $teste_validade;
               if (!empty($this->estatus) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus']) && !in_array($this->estatus, $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus']))
               {
      ...
      if (is_array($this->especialidad_id))
      {
          ...
          { 
              ...
              { 
                       ...
                       $this->especialidad_id .= $dados_especialidad_id_1;
                       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id']) && !in_array($dados_especialidad_id_1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id']))
                       {
                           $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['colegio_id']['keyVal'] = form_docentes_pack_protect_string($this->nmgp_dados_form['colegio_id']);
              $this->NM_ajax_info['fldList']['docente_id']['keyVal'] = form_docentes_pack_protect_string($this->nmgp_dados_form['docente_id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_docentes_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_docentes_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_estatus'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estatus']['valList'][$i] = form_docentes_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['Lookup_especialidad_id'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['especialidad_id']['valList'][$i] = form_docentes_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['scriptcase']['form_docentes']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $this->fotografia = $this->fotografia_before_qstr;
              ...
              $this->nmgp_refresh_fields = array_diff(array('apellidos', 'nombres', 'identificacion', 'fecha_ingreso', 'estatus', 'especialidad_id', 'direccion_linea1', 'direccion_linea2', 'telefono', 'correo', 'comentarios'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['parms'] = "colegio_id?#?$this->colegio_id?@?docente_id?#?$this->docente_id?@?"; 
      }
...
//------------ 
      ...
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->colegio_id) && !empty($this->docente_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
...
//---------- 
      ...
      { 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['parms'] = "colegio_id?#?$this->colegio_id?@?docente_id?#?$this->docente_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['sub_dir'][0]  = "";
          } 
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['where_filter_form'] . " and (colegio_id = " . $_SESSION['vglo_colegio'] . ") and (" . $comando . ")";
      }
      else
      {
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['SC_sep_date1'];
              }
          }
...
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_docentes']['dashboard_info']['parent_widget']; ?>']");
