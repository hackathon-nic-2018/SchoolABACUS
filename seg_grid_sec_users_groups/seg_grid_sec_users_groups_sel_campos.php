...
<?php
   ...
   $Sel_Cmp = new seg_grid_sec_users_groups_sel_cmp(); 
...
<?php
   if (isset($_SESSION['sc_session'][$this->sc_init]['seg_grid_sec_users_groups']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['seg_grid_sec_users_groups']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               ...
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsEnabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['seg_grid_sec_users_groups']['labels'][$NM_cada_field]; ?></li>
<?php
               }
               else
               {
?>
     <li class="sc_ui_litem scAppDivSelectFieldsDisabled" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['seg_grid_sec_users_groups']['labels'][$NM_cada_field]; ?></li>
<?php
               }
           }
       }
