 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['group'])) ? $this->New_label['group'] : "group"; ?></TD>
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT group_id, description  FROM seg_groups  ORDER BY description"; 
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "school_abacus/seg_grid_sec_users_groups";
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['seg_grid_sec_users_groups']['where_pesq_ant'] = $this->comando . $this->comando_fim;
