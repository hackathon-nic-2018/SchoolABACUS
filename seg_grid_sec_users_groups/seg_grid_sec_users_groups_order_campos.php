...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['seg_grid_sec_users_groups']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['seg_grid_sec_users_groups']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['seg_grid_sec_users_groups']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
