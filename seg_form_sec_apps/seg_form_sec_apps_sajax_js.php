  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seg_form_sec_apps" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate app_name
  function do_ajax_seg_form_sec_apps_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_apps_validate_app_name(var_app_name, var_script_case_init, do_ajax_seg_form_sec_apps_validate_app_name_cb);
  } // do_ajax_seg_form_sec_apps_validate_app_name

  function do_ajax_seg_form_sec_apps_validate_app_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_apps_validate_app_name_cb

  // ---------- Validate description
  function do_ajax_seg_form_sec_apps_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_form_sec_apps_validate_description(var_description, var_script_case_init, do_ajax_seg_form_sec_apps_validate_description_cb);
  } // do_ajax_seg_form_sec_apps_validate_description

  function do_ajax_seg_form_sec_apps_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_form_sec_apps_validate_description_cb
  // ---------- Form
  function do_ajax_seg_form_sec_apps_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_seg_form_sec_apps_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_seg_form_sec_apps_submit_form(var_app_name, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_form_sec_apps_submit_form_cb);
  } // do_ajax_seg_form_sec_apps_submit_form

  function do_ajax_seg_form_sec_apps_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_seg_form_sec_apps_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_seg_form_sec_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_seg_form_sec_apps_navigate_form(var_app_name, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_form_sec_apps_navigate_form_cb);
  } // do_ajax_seg_form_sec_apps_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_form_sec_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seg_form_sec_apps_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_seg_form_sec_apps_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_seg_form_sec_apps_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_seg_form_sec_apps_navigate_form_cb
  function sc_hide_seg_form_sec_apps_form()
  {
