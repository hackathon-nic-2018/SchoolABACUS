...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_grado_id_line" id="hidden_field_data_grado_id" style="<?php echo $sStyleHidden_grado_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_grado_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_grado_id_label"><span id="id_label_grado_id"><?php echo $this->nm_new_label['grado_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['php_cmp_required']['grado_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['php_cmp_required']['grado_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_id_line" id="hidden_field_data_turno_id" style="<?php echo $sStyleHidden_turno_id; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_id_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_turno_id_label"><span id="id_label_turno_id"><?php echo $this->nm_new_label['turno_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['php_cmp_required']['turno_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['php_cmp_required']['turno_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cant_max_alumnos_line" id="hidden_field_data_cant_max_alumnos" style="<?php echo $sStyleHidden_cant_max_alumnos; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cant_max_alumnos_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_cant_max_alumnos_label"><span id="id_label_cant_max_alumnos"><?php echo $this->nm_new_label['cant_max_alumnos']; ?></span></span><br>
