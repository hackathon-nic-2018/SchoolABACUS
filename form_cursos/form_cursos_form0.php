...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe']) ? 'margin: 2px;' : '';
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_grado_id_line" id="hidden_field_data_grado_id" style="<?php echo $sStyleHidden_grado_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_grado_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ubicacion_line" id="hidden_field_data_ubicacion" style="<?php echo $sStyleHidden_ubicacion; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ubicacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_turno_id_line" id="hidden_field_data_turno_id" style="<?php echo $sStyleHidden_turno_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_docente_guia_id_line" id="hidden_field_data_docente_guia_id" style="<?php echo $sStyleHidden_docente_guia_id; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_docente_guia_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_comentarios_line" id="hidden_field_data_comentarios" style="<?php echo $sStyleHidden_comentarios; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentarios_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_cant_max_alumnos_line" id="hidden_field_data_cant_max_alumnos" style="<?php echo $sStyleHidden_cant_max_alumnos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cant_max_alumnos_line" style="vertical-align: top;padding: 0px">
