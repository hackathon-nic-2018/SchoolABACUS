...
<input type="hidden" name="estatus_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['estatus_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_estatus_estudiantes"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_estatus_estudiantes_submit_form(y, z); 
} 
<?php
}
?>
