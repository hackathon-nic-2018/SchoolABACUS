...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_hora_enviado_hora' + iSeqRow).bind('blur', function() { sc_form_mensaje_enviados_fecha_hora_enviado_onblur(this, iSeqRow) })
                                                     .bind('focus', function() { sc_form_mensaje_enviados_fecha_hora_enviado_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_fecha_hora_recibido_hora' + iSeqRow).bind('blur', function() { sc_form_mensaje_enviados_fecha_hora_recibido_onblur(this, iSeqRow) })
                                                      .bind('focus', function() { sc_form_mensaje_enviados_fecha_hora_recibido_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function scHidePage(pageNo) {
	$("#id_form_mensaje_enviados_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_hora_enviado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#id_sc_field_fecha_hora_recibido" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
