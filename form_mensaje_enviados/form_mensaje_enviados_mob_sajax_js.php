  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mensaje_enviados_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate enviado_a
  function do_ajax_form_mensaje_enviados_mob_validate_enviado_a()
  {
    var nomeCampo_enviado_a = "enviado_a";
    var var_enviado_a = scAjaxGetFieldSelect(nomeCampo_enviado_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_enviados_mob_validate_enviado_a(var_enviado_a, var_script_case_init, do_ajax_form_mensaje_enviados_mob_validate_enviado_a_cb);
  } // do_ajax_form_mensaje_enviados_mob_validate_enviado_a

  function do_ajax_form_mensaje_enviados_mob_validate_enviado_a_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enviado_a";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_enviados_mob_validate_enviado_a_cb

  // ---------- Validate titulo
  function do_ajax_form_mensaje_enviados_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_enviados_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_mensaje_enviados_mob_validate_titulo_cb);
  } // do_ajax_form_mensaje_enviados_mob_validate_titulo

  function do_ajax_form_mensaje_enviados_mob_validate_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "titulo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_enviados_mob_validate_titulo_cb

  // ---------- Validate mensaje
  function do_ajax_form_mensaje_enviados_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldEditorHtml(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_enviados_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_form_mensaje_enviados_mob_validate_mensaje_cb);
  } // do_ajax_form_mensaje_enviados_mob_validate_mensaje

  function do_ajax_form_mensaje_enviados_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_enviados_mob_validate_mensaje_cb

  // ---------- Validate fecha_hora_enviado
  function do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado()
  {
    var nomeCampo_fecha_hora_enviado = "fecha_hora_enviado";
    var var_fecha_hora_enviado = scAjaxGetFieldText(nomeCampo_fecha_hora_enviado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado(var_fecha_hora_enviado, var_script_case_init, do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado_cb);
  } // do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado

  function do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_hora_enviado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_enviado_cb

  // ---------- Validate fecha_hora_recibido
  function do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido()
  {
    var nomeCampo_fecha_hora_recibido = "fecha_hora_recibido";
    var var_fecha_hora_recibido = scAjaxGetFieldText(nomeCampo_fecha_hora_recibido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido(var_fecha_hora_recibido, var_script_case_init, do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido_cb);
  } // do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido

  function do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_hora_recibido";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mensaje_enviados_mob_validate_fecha_hora_recibido_cb
  // ---------- Form
  function do_ajax_form_mensaje_enviados_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mensaje_enviados_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_enviado_a = scAjaxGetFieldSelect("enviado_a");
    var var_titulo = scAjaxGetFieldText("titulo");
    var var_mensaje = scAjaxGetFieldEditorHtml("mensaje");
    var var_fecha_hora_enviado = scAjaxGetFieldText("fecha_hora_enviado");
    var var_fecha_hora_recibido = scAjaxGetFieldText("fecha_hora_recibido");
    var var_colegio_id = scAjaxGetFieldText("colegio_id");
    var var_notificacion_id = scAjaxGetFieldText("notificacion_id");
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_enviados_mob_submit_form(var_enviado_a, var_titulo, var_mensaje, var_fecha_hora_enviado, var_fecha_hora_recibido, var_colegio_id, var_notificacion_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mensaje_enviados_mob_submit_form_cb);
  } // do_ajax_form_mensaje_enviados_mob_submit_form

  function do_ajax_form_mensaje_enviados_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("enviado_a");
      scAjaxHideErrorDisplay("titulo");
      scAjaxHideErrorDisplay("mensaje");
      scAjaxHideErrorDisplay("fecha_hora_enviado");
      scAjaxHideErrorDisplay("fecha_hora_recibido");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_mensaje_enviados_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_mensaje_enviados_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_notificacion_id = document.F2.notificacion_id.value;
    ...
    scAjaxProcOn();
    x_ajax_form_mensaje_enviados_mob_navigate_form(var_colegio_id, var_notificacion_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mensaje_enviados_mob_navigate_form_cb);
  } // do_ajax_form_mensaje_enviados_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mensaje_enviados_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mensaje_enviados_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.notificacion_id.value = scAjaxGetKeyValue("notificacion_id");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
...
{
?>
    do_ajax_form_mensaje_enviados_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_mensaje_enviados_mob_navigate_form_cb
  function sc_hide_form_mensaje_enviados_mob_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_mensaje_enviados_mob_form
  ...
  ajax_field_list[0] = "enviado_a";
  ajax_field_list[1] = "titulo";
  ajax_field_list[2] = "mensaje";
  ajax_field_list[3] = "fecha_hora_enviado";
  ajax_field_list[4] = "fecha_hora_recibido";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "enviado_a": {"label": "Enviado A", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "titulo": {"label": "Asunto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mensaje": {"label": "Mensaje", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_hora_enviado": {"label": "Fecha Hora Enviado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_hora_recibido": {"label": "Fecha Hora Recibido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "titulo": new Array(),
    "mensaje": new Array(),
    "fecha_hora_enviado": new Array(),
    "fecha_hora_recibido": new Array()
  };
  ajax_field_mult["enviado_a"][1] = "enviado_a";
  ajax_field_mult["titulo"][1] = "titulo";
  ajax_field_mult["mensaje"][1] = "mensaje";
  ajax_field_mult["fecha_hora_enviado"][1] = "fecha_hora_enviado";
  ajax_field_mult["fecha_hora_recibido"][1] = "fecha_hora_recibido";

  var ajax_field_id = {
    "enviado_a": new Array("hidden_field_label_enviado_a", "hidden_field_data_enviado_a"),
    ...
    "fecha_hora_enviado": new Array("hidden_field_label_fecha_hora_enviado", "hidden_field_data_fecha_hora_enviado"),
    "fecha_hora_recibido": new Array("hidden_field_label_fecha_hora_recibido", "hidden_field_data_fecha_hora_recibido")
  };
  ...
  var ajax_read_only = {
    ...
    "titulo": "on",
    "mensaje": "on",
    "fecha_hora_enviado": "on",
    "fecha_hora_recibido": "on"
  };
