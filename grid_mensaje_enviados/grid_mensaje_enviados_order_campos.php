...
<?php
   ...
   $Ord_Cmp = new grid_mensaje_enviados_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mensaje_enviados_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_def_campos['fecha_hora_enviado'] = "fecha_hora_enviado";
   $tab_converte["fecha_hora_enviado"]   = "fecha_hora_enviado";
   $tab_labels["fecha_hora_enviado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["fecha_hora_enviado"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["fecha_hora_enviado"] : "Fecha Hora Enviado";
   $tab_ger_campos['enviado_a'] = "on";
   $tab_def_campos['enviado_a'] = "enviado_a";
   $tab_converte["enviado_a"]   = "enviado_a";
   $tab_labels["enviado_a"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["enviado_a"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["enviado_a"] : "Enviado A";
   $tab_ger_campos['titulo'] = "on";
   $tab_def_campos['titulo'] = "titulo";
   $tab_converte["titulo"]   = "titulo";
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["titulo"] : "Asunto";
   $tab_ger_campos['fecha_hora_recibido'] = "on";
   $tab_def_campos['fecha_hora_recibido'] = "fecha_hora_recibido";
   $tab_converte["fecha_hora_recibido"]   = "fecha_hora_recibido";
   $tab_labels["fecha_hora_recibido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["fecha_hora_recibido"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['labels']["fecha_hora_recibido"] : "Fecha Hora Recibido";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mensaje_enviados_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_mensaje_enviados']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
