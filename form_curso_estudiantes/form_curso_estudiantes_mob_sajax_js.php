  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_curso_estudiantes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate estudiante_id
  function do_ajax_form_curso_estudiantes_mob_validate_estudiante_id()
  {
  } // do_ajax_form_curso_estudiantes_mob_validate_estudiante_id

  function do_ajax_form_curso_estudiantes_mob_validate_estudiante_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estudiante_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_estudiantes_mob_validate_estudiante_id_cb

  // ---------- Validate numero_lista
  function do_ajax_form_curso_estudiantes_mob_validate_numero_lista()
  {
    var nomeCampo_numero_lista = "numero_lista";
    var var_numero_lista = scAjaxGetFieldText(nomeCampo_numero_lista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_estudiantes_mob_validate_numero_lista(var_numero_lista, var_script_case_init, do_ajax_form_curso_estudiantes_mob_validate_numero_lista_cb);
  } // do_ajax_form_curso_estudiantes_mob_validate_numero_lista

  function do_ajax_form_curso_estudiantes_mob_validate_numero_lista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_lista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_estudiantes_mob_validate_numero_lista_cb

  // ---------- Event onchange estudiante_id
  function do_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange()
  {
    var var_estudiante_id = scAjaxGetFieldText("estudiante_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange(var_estudiante_id, var_script_case_init, do_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange_cb);
  } // do_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange

  function do_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estudiante_id";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_curso_estudiantes_mob_event_estudiante_id_onchange_cb
  // ---------- Form
  function do_ajax_form_curso_estudiantes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_curso_estudiantes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_estudiante_id = scAjaxGetFieldText("estudiante_id");
    var var_numero_lista = scAjaxGetFieldText("numero_lista");
    ...
    scAjaxProcOn();
    x_ajax_form_curso_estudiantes_mob_submit_form(var_estudiante_id, var_numero_lista, var_colegio_id, var_periodo_id, var_curso_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_curso_estudiantes_mob_submit_form_cb);
  } // do_ajax_form_curso_estudiantes_mob_submit_form

  function do_ajax_form_curso_estudiantes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("estudiante_id");
      scAjaxHideErrorDisplay("numero_lista");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_curso_estudiantes_mob_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_curso_estudiantes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_curso_estudiantes_mob_navigate_form(var_colegio_id, var_periodo_id, var_curso_id, var_estudiante_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_curso_estudiantes_mob_navigate_form_cb);
  } // do_ajax_form_curso_estudiantes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_curso_estudiantes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_curso_estudiantes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_curso_estudiantes_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_curso_estudiantes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_curso_estudiantes_mob_navigate_form_cb
  function sc_hide_form_curso_estudiantes_mob_form()
  {
  ...
  ajax_field_list[0] = "estudiante_id";
  ajax_field_list[1] = "numero_lista";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "estudiante_id": {"label": "Estudiante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_lista": {"label": "Numero Lista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "estudiante_id": new Array(),
    "numero_lista": new Array()
  };
  ajax_field_mult["estudiante_id"][1] = "estudiante_id";
  ajax_field_mult["numero_lista"][1] = "numero_lista";

  var ajax_field_id = {
    "estudiante_id": new Array("hidden_field_label_estudiante_id", "hidden_field_data_estudiante_id"),
    "numero_lista": new Array("hidden_field_label_numero_lista", "hidden_field_data_numero_lista")
  };
