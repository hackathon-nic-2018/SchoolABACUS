  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_curso_estudiantes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_curso_estudiantes_validate_estudiante_id()
  {
  } // do_ajax_form_curso_estudiantes_validate_estudiante_id

  function do_ajax_form_curso_estudiantes_validate_estudiante_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_estudiantes_validate_estudiante_id_cb

  // ---------- Validate numero_lista
  function do_ajax_form_curso_estudiantes_validate_numero_lista()
  {
    var nomeCampo_numero_lista = "numero_lista";
    var var_numero_lista = scAjaxGetFieldText(nomeCampo_numero_lista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_curso_estudiantes_validate_numero_lista(var_numero_lista, var_script_case_init, do_ajax_form_curso_estudiantes_validate_numero_lista_cb);
  } // do_ajax_form_curso_estudiantes_validate_numero_lista

  function do_ajax_form_curso_estudiantes_validate_numero_lista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_curso_estudiantes_validate_numero_lista_cb

  // ---------- Event onchange estudiante_id
  function do_ajax_form_curso_estudiantes_event_estudiante_id_onchange()
  {
    var var_estudiante_id = scAjaxGetFieldText("estudiante_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_curso_estudiantes_event_estudiante_id_onchange(var_estudiante_id, var_script_case_init, do_ajax_form_curso_estudiantes_event_estudiante_id_onchange_cb);
  } // do_ajax_form_curso_estudiantes_event_estudiante_id_onchange

  function do_ajax_form_curso_estudiantes_event_estudiante_id_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estudiante_id";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_curso_estudiantes_event_estudiante_id_onchange_cb
  // ---------- Form
  function do_ajax_form_curso_estudiantes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_curso_estudiantes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_estudiante_id = scAjaxGetFieldText("estudiante_id");
    ...
    scAjaxProcOn();
    x_ajax_form_curso_estudiantes_submit_form(var_estudiante_id, var_numero_lista, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_curso_estudiantes_submit_form_cb);
  } // do_ajax_form_curso_estudiantes_submit_form

  function do_ajax_form_curso_estudiantes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_curso_estudiantes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_curso_estudiantes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_curso_estudiantes_navigate_form(var_colegio_id, var_periodo_id, var_curso_id, var_estudiante_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_curso_estudiantes_navigate_form_cb);
  } // do_ajax_form_curso_estudiantes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_curso_estudiantes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_curso_estudiantes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_curso_estudiantes_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_curso_estudiantes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_curso_estudiantes_navigate_form_cb
  function sc_hide_form_curso_estudiantes_form()
  {
