...
$old_error_handler = set_error_handler("form_colegio_mob_scriptcase_error_handler");

function form_colegio_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_colegio_mob']['contr_erro']) && $_SESSION['scriptcase']['form_colegio_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_colegio_mob->contr_form_colegio_mob->Apl_com_erro = true;
            if ($inicial_form_colegio_mob->contr_form_colegio_mob->NM_ajax_flag)
            {
                $inicial_form_colegio_mob->contr_form_colegio_mob->NM_ajax_info['errList']['geral_form_colegio_mob'][] = $msg;
                return;
            }
            form_colegio_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_colegio_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_colegio_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['form_colegio_mob'])  ? $_SESSION['scriptcase']['error_icon']['form_colegio_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_colegio_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['form_colegio_mob']) ? $_SESSION['scriptcase']['error_span_title']['form_colegio_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_colegio_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_colegio_mob']) ? $_SESSION['scriptcase']['error_icon_title']['form_colegio_mob'] : '';
?>
