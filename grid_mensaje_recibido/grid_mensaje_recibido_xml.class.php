...
class grid_mensaje_recibido_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_mensaje_recibido.xml";
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_mensaje_recibido>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_mensaje_recibido";
...
$_SESSION['scriptcase']['grid_mensaje_recibido']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_enviado_por))
         {
             $this->look_enviado_por = sc_convert_encoding($this->look_enviado_por, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->New_Format)
         {
             $this->xml_registro .= " <enviado_por>" . $this->trata_dados($this->look_enviado_por) . "</enviado_por>\r\n";
         }
         else
         {
             $this->xml_registro .= " enviado_por =\"" . $this->trata_dados($this->look_enviado_por) . "\"";
         }
   }
   //----- titulo
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->enviado_a))
         {
             $this->enviado_a = sc_convert_encoding($this->enviado_a, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->New_Format)
         {
             $this->xml_registro .= " <enviado_a>" . $this->trata_dados($this->enviado_a) . "</enviado_a>\r\n";
         }
         else
         {
             $this->xml_registro .= " enviado_a =\"" . $this->trata_dados($this->enviado_a) . "\"";
         }
   }
   //----- mensaje
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensaje_recibido']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
