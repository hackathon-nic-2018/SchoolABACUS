...
<?php
   ...
   $Ord_Cmp = new grid_mensaje_recibido_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mensaje_recibido_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["fecha_hora_enviado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["fecha_hora_enviado"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["fecha_hora_enviado"] : "Fecha Hora Enviado";
   $tab_ger_campos['enviado_por'] = "on";
   $tab_def_campos['enviado_por'] = "enviado_por";
   $tab_converte["enviado_por"]   = "enviado_por";
   $tab_labels["enviado_por"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["enviado_por"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["enviado_por"] : "Enviado Por";
   $tab_ger_campos['titulo'] = "on";
   $tab_def_campos['titulo'] = "titulo";
   $tab_converte["titulo"]   = "titulo";
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['labels']["titulo"] : "Asunto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mensaje_recibido_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_mensaje_recibido']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
