<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="colegio_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['colegio_id_']); ?>">
<input type="hidden" name="periodo_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['periodo_id_']); ?>">
<input type="hidden" name="curso_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['curso_id_']); ?>">
<input type="hidden" name="estudiante_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['estudiante_id_']); ?>">
<input type="hidden" name="asignatura_id_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['asignatura_id_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_calificaciones"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_calificaciones_submit_form(y, z); 
} 
<?php
}
?>
