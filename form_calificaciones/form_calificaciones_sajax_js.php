  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_calificaciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_calificaciones_validate_estudiante_id__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "estudiante_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "estudiante_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "estudiante_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "estudiante_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_estudiante_id__cb

  // ---------- Validate asignatura_id_
  ...
  function do_ajax_form_calificaciones_validate_asignatura_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "asignatura_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "asignatura_id_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "asignatura_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "asignatura_id_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
  ...
  {
    var nomeCampo_calificacion_1_ = "calificacion_1_" + iNumLinha;
    var var_calificacion_1_ = scAjaxGetFieldText(nomeCampo_calificacion_1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_1_(var_calificacion_1_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_1__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_1_

  function do_ajax_form_calificaciones_validate_calificacion_1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_1__cb

  // ---------- Validate calificacion_nivel_1_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_1_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_1_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_1__cb

  // ---------- Validate calificacion_2_
  function do_ajax_form_calificaciones_validate_calificacion_2_(iNumLinha)
  {
    var nomeCampo_calificacion_2_ = "calificacion_2_" + iNumLinha;
    var var_calificacion_2_ = scAjaxGetFieldText(nomeCampo_calificacion_2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_2_(var_calificacion_2_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_2__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_2_

  function do_ajax_form_calificaciones_validate_calificacion_2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_2__cb

  // ---------- Validate calificacion_nivel_2_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_2_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_2_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_2__cb

  // ---------- Validate calificacion_3_
  function do_ajax_form_calificaciones_validate_calificacion_3_(iNumLinha)
  {
    var nomeCampo_calificacion_3_ = "calificacion_3_" + iNumLinha;
    var var_calificacion_3_ = scAjaxGetFieldText(nomeCampo_calificacion_3_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_3_(var_calificacion_3_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_3__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_3_

  function do_ajax_form_calificaciones_validate_calificacion_3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_3_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_3_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_3_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_3_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_3__cb

  // ---------- Validate calificacion_nivel_3_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_3__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_3_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_3_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_3_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_3_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_3__cb

  // ---------- Validate calificacion_4_
  function do_ajax_form_calificaciones_validate_calificacion_4_(iNumLinha)
  {
    var nomeCampo_calificacion_4_ = "calificacion_4_" + iNumLinha;
    var var_calificacion_4_ = scAjaxGetFieldText(nomeCampo_calificacion_4_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_4_(var_calificacion_4_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_4__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_4_

  function do_ajax_form_calificaciones_validate_calificacion_4__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_4_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_4_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_4_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_4_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_4__cb

  // ---------- Validate calificacion_nivel_4_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_4__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_4_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_4_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_4_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_4_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_4__cb

  // ---------- Validate calificacion_5_
  function do_ajax_form_calificaciones_validate_calificacion_5_(iNumLinha)
  {
    var nomeCampo_calificacion_5_ = "calificacion_5_" + iNumLinha;
    var var_calificacion_5_ = scAjaxGetFieldText(nomeCampo_calificacion_5_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_5_(var_calificacion_5_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_5__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_5_

  function do_ajax_form_calificaciones_validate_calificacion_5__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_5_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_5_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_5_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_5_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_5__cb

  // ---------- Validate calificacion_nivel_5_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_5__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_5_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_5_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_5_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_5_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_5__cb

  // ---------- Validate calificacion_6_
  function do_ajax_form_calificaciones_validate_calificacion_6_(iNumLinha)
  {
    var nomeCampo_calificacion_6_ = "calificacion_6_" + iNumLinha;
    var var_calificacion_6_ = scAjaxGetFieldText(nomeCampo_calificacion_6_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_6_(var_calificacion_6_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_6__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_6_

  function do_ajax_form_calificaciones_validate_calificacion_6__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_6_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_6_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_6_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_6_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_6__cb

  // ---------- Validate calificacion_nivel_6_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_6__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_6_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_6_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_6_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_6_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_6__cb

  // ---------- Validate calificacion_7_
  function do_ajax_form_calificaciones_validate_calificacion_7_(iNumLinha)
  {
    var nomeCampo_calificacion_7_ = "calificacion_7_" + iNumLinha;
    var var_calificacion_7_ = scAjaxGetFieldText(nomeCampo_calificacion_7_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_7_(var_calificacion_7_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_7__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_7_

  function do_ajax_form_calificaciones_validate_calificacion_7__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_7_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_7_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_7_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_7_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_7__cb

  // ---------- Validate calificacion_nivel_7_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_7__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_7_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_7_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_7_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_7_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_7__cb

  // ---------- Validate calificacion_8_
  function do_ajax_form_calificaciones_validate_calificacion_8_(iNumLinha)
  {
    var nomeCampo_calificacion_8_ = "calificacion_8_" + iNumLinha;
    var var_calificacion_8_ = scAjaxGetFieldText(nomeCampo_calificacion_8_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_8_(var_calificacion_8_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_8__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_8_

  function do_ajax_form_calificaciones_validate_calificacion_8__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_8_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_8_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_8_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_8_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_8__cb

  // ---------- Validate calificacion_nivel_8_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_8__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_8_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_8_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_8_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_8_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_8__cb

  // ---------- Validate calificacion_9_
  function do_ajax_form_calificaciones_validate_calificacion_9_(iNumLinha)
  {
    var nomeCampo_calificacion_9_ = "calificacion_9_" + iNumLinha;
    var var_calificacion_9_ = scAjaxGetFieldText(nomeCampo_calificacion_9_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_validate_calificacion_9_(var_calificacion_9_, iNumLinha, var_script_case_init, do_ajax_form_calificaciones_validate_calificacion_9__cb);
  } // do_ajax_form_calificaciones_validate_calificacion_9_

  function do_ajax_form_calificaciones_validate_calificacion_9__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_9_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_9_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_9_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_9_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_9__cb

  // ---------- Validate calificacion_nivel_9_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_nivel_9__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_nivel_9_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_nivel_9_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_nivel_9_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_nivel_9_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_calificaciones_validate_calificacion_nivel_9__cb

  // ---------- Validate calificacion_final_
  ...
  function do_ajax_form_calificaciones_validate_calificacion_final__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "calificacion_final_" + iLineNumber;
    }
    else
    {
      sFieldValid = "calificacion_final_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "calificacion_final_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "calificacion_final_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
  ...
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    var var_calificacion_4_ = scAjaxGetFieldText("calificacion_4_" + iSeqForm);
    var var_calificacion_5_ = scAjaxGetFieldText("calificacion_5_" + iSeqForm);
    var var_calificacion_6_ = scAjaxGetFieldText("calificacion_6_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_1__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_1__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_1__onchange

  function do_ajax_form_calificaciones_event_calificacion_1__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_1__onchange_cb

  // ---------- Event onchange calificacion_2_
  function do_ajax_form_calificaciones_event_calificacion_2__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_2__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_2__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_2__onchange

  function do_ajax_form_calificaciones_event_calificacion_2__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_2__onchange_cb

  // ---------- Event onchange calificacion_3_
  function do_ajax_form_calificaciones_event_calificacion_3__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_3__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_3__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_3__onchange

  function do_ajax_form_calificaciones_event_calificacion_3__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_3__onchange_cb

  // ---------- Event onchange calificacion_4_
  function do_ajax_form_calificaciones_event_calificacion_4__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_4__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_4__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_4__onchange

  function do_ajax_form_calificaciones_event_calificacion_4__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_4__onchange_cb

  // ---------- Event onchange calificacion_5_
  function do_ajax_form_calificaciones_event_calificacion_5__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_5__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_5__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_5__onchange

  function do_ajax_form_calificaciones_event_calificacion_5__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_5__onchange_cb

  // ---------- Event onchange calificacion_6_
  function do_ajax_form_calificaciones_event_calificacion_6__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_6__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_6__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_6__onchange

  function do_ajax_form_calificaciones_event_calificacion_6__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_6__onchange_cb

  // ---------- Event onchange calificacion_7_
  function do_ajax_form_calificaciones_event_calificacion_7__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_7__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_7__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_7__onchange

  function do_ajax_form_calificaciones_event_calificacion_7__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_7__onchange_cb

  // ---------- Event onchange calificacion_8_
  function do_ajax_form_calificaciones_event_calificacion_8__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_8__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_8__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_8__onchange

  function do_ajax_form_calificaciones_event_calificacion_8__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_8__onchange_cb

  // ---------- Event onchange calificacion_9_
  function do_ajax_form_calificaciones_event_calificacion_9__onchange(iSeqForm)
  {
    var var_calificacion_1_ = scAjaxGetFieldText("calificacion_1_" + iSeqForm);
    var var_calificacion_2_ = scAjaxGetFieldText("calificacion_2_" + iSeqForm);
    var var_calificacion_3_ = scAjaxGetFieldText("calificacion_3_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_event_calificacion_9__onchange(var_calificacion_1_, var_calificacion_2_, var_calificacion_3_, var_calificacion_4_, var_calificacion_5_, var_calificacion_6_, var_calificacion_7_, var_calificacion_8_, var_calificacion_9_, var_calificacion_final_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_calificaciones_event_calificacion_9__onchange_cb);
  } // do_ajax_form_calificaciones_event_calificacion_9__onchange

  function do_ajax_form_calificaciones_event_calificacion_9__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_calificaciones_event_calificacion_9__onchange_cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_calificaciones_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_calificaciones_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_calificaciones_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_calificaciones_add_new_line_cb);
  } // do_ajax_form_calificaciones_add_new_line

  function do_ajax_form_calificaciones_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_calificaciones_add_new_line_cb
  ...
  function do_ajax_form_calificaciones_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_calificaciones_backup_line(var_colegio_id_, var_periodo_id_, var_curso_id_, var_estudiante_id_, var_asignatura_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_calificaciones_backup_line_cb);
  } // do_ajax_form_calificaciones_backup_line

  function do_ajax_form_calificaciones_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_calificaciones_backup_line_cb

  function do_ajax_form_calificaciones_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_calificaciones_cancel_insert

  function do_ajax_form_calificaciones_cancel_update(iSeqVert)
  {
    do_ajax_form_calificaciones_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_calificaciones_cancel_update

  function do_ajax_form_calificaciones_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_calificaciones_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_calificaciones_table_refresh()
  {
    var var_colegio_id_ = document.F2.colegio_id_.value;
    var var_periodo_id_ = document.F2.periodo_id_.value;
    var var_curso_id_ = document.F2.curso_id_.value;
    var var_estudiante_id_ = document.F2.estudiante_id_.value;
    var var_asignatura_id_ = document.F2.asignatura_id_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_calificaciones_table_refresh(var_colegio_id_, var_periodo_id_, var_curso_id_, var_estudiante_id_, var_asignatura_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_calificaciones_table_refresh_cb);
  } //  do_ajax_form_calificaciones_table_refresh

  function do_ajax_form_calificaciones_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.colegio_id_.value = scAjaxGetKeyValue("colegio_id_");
    document.F2.periodo_id_.value = scAjaxGetKeyValue("periodo_id_");
    document.F2.curso_id_.value = scAjaxGetKeyValue("curso_id_");
    document.F2.estudiante_id_.value = scAjaxGetKeyValue("estudiante_id_");
    document.F2.asignatura_id_.value = scAjaxGetKeyValue("asignatura_id_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_calificaciones_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_calificaciones_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_calificaciones_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
      ...
      scAjaxHideErrorDisplay("calificacion_nivel_2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_3_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_3_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_4_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_4_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_5_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_5_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_6_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_6_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_7_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_7_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_8_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("calificacion_nivel_8_" + sc_num_ult_line);
...
?>
  ...
  } // do_ajax_form_calificaciones_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_calificaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_calificaciones_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("calificacion_nivel_2_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_3_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_3_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_4_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_4_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_5_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_5_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_6_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_6_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_7_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_7_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_8_" + iNavForm);
      scAjaxHideErrorDisplay("calificacion_nivel_8_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_calificaciones_navigate_form(var_colegio_id_, var_periodo_id_, var_curso_id_, var_estudiante_id_, var_asignatura_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_calificaciones_navigate_form_cb);
  } // do_ajax_form_calificaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_calificaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_calificaciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.colegio_id_.value = scAjaxGetKeyValue("colegio_id_" + var_last_index);
    document.F2.periodo_id_.value = scAjaxGetKeyValue("periodo_id_" + var_last_index);
    document.F2.curso_id_.value = scAjaxGetKeyValue("curso_id_" + var_last_index);
    document.F2.estudiante_id_.value = scAjaxGetKeyValue("estudiante_id_" + var_last_index);
    document.F2.asignatura_id_.value = scAjaxGetKeyValue("asignatura_id_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_calificaciones_navigate_form_cb
  function sc_hide_form_calificaciones_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_calificaciones_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "estudiante_id_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_3_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_3_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_4_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_4_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_5_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_5_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_6_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_6_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_7_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_7_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_8_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_8_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_9_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "calificacion_nivel_9_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_field_mult["calificacion_nivel_2_"][iNumLinha] = "calificacion_nivel_2_" + iNumLinha;
    ajax_field_mult["calificacion_3_"][iNumLinha] = "calificacion_3_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_3_"][iNumLinha] = "calificacion_nivel_3_" + iNumLinha;
    ajax_field_mult["calificacion_4_"][iNumLinha] = "calificacion_4_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_4_"][iNumLinha] = "calificacion_nivel_4_" + iNumLinha;
    ajax_field_mult["calificacion_5_"][iNumLinha] = "calificacion_5_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_5_"][iNumLinha] = "calificacion_nivel_5_" + iNumLinha;
    ajax_field_mult["calificacion_6_"][iNumLinha] = "calificacion_6_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_6_"][iNumLinha] = "calificacion_nivel_6_" + iNumLinha;
    ajax_field_mult["calificacion_7_"][iNumLinha] = "calificacion_7_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_7_"][iNumLinha] = "calificacion_nivel_7_" + iNumLinha;
    ajax_field_mult["calificacion_8_"][iNumLinha] = "calificacion_8_" + iNumLinha;
    ajax_field_mult["calificacion_nivel_8_"][iNumLinha] = "calificacion_nivel_8_" + iNumLinha;
    ...
    ajax_field_id["calificacion_nivel_2_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_2_", "hidden_field_data_calificacion_nivel_2_" + iNumLinha);
    ajax_field_id["calificacion_3_" + iNumLinha] = new Array("hidden_field_label_calificacion_3_", "hidden_field_data_calificacion_3_" + iNumLinha);
    ajax_field_id["calificacion_nivel_3_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_3_", "hidden_field_data_calificacion_nivel_3_" + iNumLinha);
    ajax_field_id["calificacion_4_" + iNumLinha] = new Array("hidden_field_label_calificacion_4_", "hidden_field_data_calificacion_4_" + iNumLinha);
    ajax_field_id["calificacion_nivel_4_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_4_", "hidden_field_data_calificacion_nivel_4_" + iNumLinha);
    ajax_field_id["calificacion_5_" + iNumLinha] = new Array("hidden_field_label_calificacion_5_", "hidden_field_data_calificacion_5_" + iNumLinha);
    ajax_field_id["calificacion_nivel_5_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_5_", "hidden_field_data_calificacion_nivel_5_" + iNumLinha);
    ajax_field_id["calificacion_6_" + iNumLinha] = new Array("hidden_field_label_calificacion_6_", "hidden_field_data_calificacion_6_" + iNumLinha);
    ajax_field_id["calificacion_nivel_6_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_6_", "hidden_field_data_calificacion_nivel_6_" + iNumLinha);
    ajax_field_id["calificacion_7_" + iNumLinha] = new Array("hidden_field_label_calificacion_7_", "hidden_field_data_calificacion_7_" + iNumLinha);
    ajax_field_id["calificacion_nivel_7_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_7_", "hidden_field_data_calificacion_nivel_7_" + iNumLinha);
    ajax_field_id["calificacion_8_" + iNumLinha] = new Array("hidden_field_label_calificacion_8_", "hidden_field_data_calificacion_8_" + iNumLinha);
    ajax_field_id["calificacion_nivel_8_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_8_", "hidden_field_data_calificacion_nivel_8_" + iNumLinha);
    ajax_field_id["calificacion_9_" + iNumLinha] = new Array("hidden_field_label_calificacion_9_", "hidden_field_data_calificacion_9_" + iNumLinha);
    ajax_field_id["calificacion_nivel_9_" + iNumLinha] = new Array("hidden_field_label_calificacion_nivel_9_", "hidden_field_data_calificacion_nivel_9_" + iNumLinha);
    ...
    ajax_error_count["calificacion_nivel_2_" + iNumLinha] = "off";
    ajax_error_count["calificacion_3_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_3_" + iNumLinha] = "off";
    ajax_error_count["calificacion_4_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_4_" + iNumLinha] = "off";
    ajax_error_count["calificacion_5_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_5_" + iNumLinha] = "off";
    ajax_error_count["calificacion_6_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_6_" + iNumLinha] = "off";
    ajax_error_count["calificacion_7_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_7_" + iNumLinha] = "off";
    ajax_error_count["calificacion_8_" + iNumLinha] = "off";
    ajax_error_count["calificacion_nivel_8_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["calificacion_nivel_2_" + iNumLinha] = "off";
    ajax_read_only["calificacion_3_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_3_" + iNumLinha] = "off";
    ajax_read_only["calificacion_4_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_4_" + iNumLinha] = "off";
    ajax_read_only["calificacion_5_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_5_" + iNumLinha] = "off";
    ajax_read_only["calificacion_6_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_6_" + iNumLinha] = "off";
    ajax_read_only["calificacion_7_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_7_" + iNumLinha] = "off";
    ajax_read_only["calificacion_8_" + iNumLinha] = "off";
    ajax_read_only["calificacion_nivel_8_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["calificacion_nivel_2_" + iNumLinha] = "on";
    ajax_read_only["calificacion_3_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_3_" + iNumLinha] = "on";
    ajax_read_only["calificacion_4_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_4_" + iNumLinha] = "on";
    ajax_read_only["calificacion_5_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_5_" + iNumLinha] = "on";
    ajax_read_only["calificacion_6_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_6_" + iNumLinha] = "on";
    ajax_read_only["calificacion_7_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_7_" + iNumLinha] = "on";
    ajax_read_only["calificacion_8_" + iNumLinha] = "on";
    ajax_read_only["calificacion_nivel_8_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["calificacion_nivel_2_" + iNumLinha] = null;
    ajax_error_list["calificacion_3_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_3_" + iNumLinha] = null;
    ajax_error_list["calificacion_4_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_4_" + iNumLinha] = null;
    ajax_error_list["calificacion_5_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_5_" + iNumLinha] = null;
    ajax_error_list["calificacion_6_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_6_" + iNumLinha] = null;
    ajax_error_list["calificacion_7_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_7_" + iNumLinha] = null;
    ajax_error_list["calificacion_8_" + iNumLinha] = null;
    ajax_error_list["calificacion_nivel_8_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    ...
    "calificacion_nivel_2_": new Array(),
    "calificacion_3_": new Array(),
    "calificacion_nivel_3_": new Array(),
    "calificacion_4_": new Array(),
    "calificacion_nivel_4_": new Array(),
    "calificacion_5_": new Array(),
    "calificacion_nivel_5_": new Array(),
    "calificacion_6_": new Array(),
    "calificacion_nivel_6_": new Array(),
    "calificacion_7_": new Array(),
    "calificacion_nivel_7_": new Array(),
    "calificacion_8_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["estudiante_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["estudiante_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["estudiante_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["estudiante_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["estudiante_id_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["asignatura_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["asignatura_id_" + iNumLinha]["onblur"] = new Array();
      ...
      ajax_error_list["calificacion_1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_3_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_3_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_3_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_3_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_3_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_3_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_3_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_3_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_3_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_3_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_4_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_4_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_4_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_4_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_4_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_4_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_4_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_4_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_4_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_4_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_5_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_5_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_5_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_5_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_5_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_5_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_5_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_5_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_5_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_5_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_6_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_6_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_6_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_6_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_6_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_6_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_6_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_6_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_6_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_6_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_7_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_7_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_7_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_7_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_7_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_7_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_7_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_7_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_7_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_7_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_8_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_8_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_8_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_8_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_8_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_8_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_8_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_8_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_8_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_8_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_9_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_9_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_9_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_9_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_9_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_nivel_9_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_nivel_9_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["calificacion_nivel_9_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["calificacion_nivel_9_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["calificacion_nivel_9_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["calificacion_final_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["calificacion_final_" + iNumLinha]["onblur"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['estudiante_id_'])) ? $this->nmgp_cmp_readonly['estudiante_id_'] : 'on';
?>
    scAjaxFieldRead("estudiante_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
    scAjaxFieldRead("calificacion_1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_1_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_1_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_2_'])) ? $this->nmgp_cmp_readonly['calificacion_2_'] : 'off';
?>
    scAjaxFieldRead("calificacion_2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_2_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_2_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_3_'])) ? $this->nmgp_cmp_readonly['calificacion_3_'] : 'off';
?>
    scAjaxFieldRead("calificacion_3_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_3_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_3_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_3_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_4_'])) ? $this->nmgp_cmp_readonly['calificacion_4_'] : 'off';
?>
    scAjaxFieldRead("calificacion_4_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_4_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_4_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_4_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_5_'])) ? $this->nmgp_cmp_readonly['calificacion_5_'] : 'off';
?>
    scAjaxFieldRead("calificacion_5_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_5_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_5_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_5_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_6_'])) ? $this->nmgp_cmp_readonly['calificacion_6_'] : 'off';
?>
    scAjaxFieldRead("calificacion_6_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_6_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_6_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_6_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_7_'])) ? $this->nmgp_cmp_readonly['calificacion_7_'] : 'off';
?>
    scAjaxFieldRead("calificacion_7_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_7_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_7_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_7_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_8_'])) ? $this->nmgp_cmp_readonly['calificacion_8_'] : 'off';
?>
    scAjaxFieldRead("calificacion_8_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_8_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_8_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_8_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_9_'])) ? $this->nmgp_cmp_readonly['calificacion_9_'] : 'off';
?>
    scAjaxFieldRead("calificacion_9_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['calificacion_nivel_9_'])) ? $this->nmgp_cmp_readonly['calificacion_nivel_9_'] : 'off';
?>
    scAjaxFieldRead("calificacion_nivel_9_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("calificacion_nivel_2_" + iSeq, "on");
    scAjaxFieldRead("calificacion_3_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_3_" + iSeq, "on");
    scAjaxFieldRead("calificacion_4_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_4_" + iSeq, "on");
    scAjaxFieldRead("calificacion_5_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_5_" + iSeq, "on");
    scAjaxFieldRead("calificacion_6_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_6_" + iSeq, "on");
    scAjaxFieldRead("calificacion_7_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_7_" + iSeq, "on");
    scAjaxFieldRead("calificacion_8_" + iSeq, "on");
    scAjaxFieldRead("calificacion_nivel_8_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["estudiante_id_" + iRow] || "on" == ajax_error_count["asignatura_id_" + iRow] || "on" == ajax_error_count["calificacion_1_" + iRow] || "on" == ajax_error_count["calificacion_nivel_1_" + iRow] || "on" == ajax_error_count["calificacion_2_" + iRow] || "on" == ajax_error_count["calificacion_nivel_2_" + iRow] || "on" == ajax_error_count["calificacion_3_" + iRow] || "on" == ajax_error_count["calificacion_nivel_3_" + iRow] || "on" == ajax_error_count["calificacion_4_" + iRow] || "on" == ajax_error_count["calificacion_nivel_4_" + iRow] || "on" == ajax_error_count["calificacion_5_" + iRow] || "on" == ajax_error_count["calificacion_nivel_5_" + iRow] || "on" == ajax_error_count["calificacion_6_" + iRow] || "on" == ajax_error_count["calificacion_nivel_6_" + iRow] || "on" == ajax_error_count["calificacion_7_" + iRow] || "on" == ajax_error_count["calificacion_nivel_7_" + iRow] || "on" == ajax_error_count["calificacion_8_" + iRow] || "on" == ajax_error_count["calificacion_nivel_8_" + iRow] || "on" == ajax_error_count["calificacion_9_" + iRow] || "on" == ajax_error_count["calificacion_nivel_9_" + iRow] || "on" == ajax_error_count["calificacion_final_" + iRow] || "on" == ajax_error_count["colegio_id_" + iRow] || "on" == ajax_error_count["periodo_id_" + iRow] || "on" == ajax_error_count["curso_id_" + iRow]))
    {
      ...
      $("#hidden_field_data_calificacion_nivel_2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_3_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_3_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_4_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_4_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_5_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_5_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_6_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_6_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_7_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_7_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_8_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_8_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["estudiante_id_" + iRow] && "off" == ajax_error_count["asignatura_id_" + iRow] && "off" == ajax_error_count["calificacion_1_" + iRow] && "off" == ajax_error_count["calificacion_nivel_1_" + iRow] && "off" == ajax_error_count["calificacion_2_" + iRow] && "off" == ajax_error_count["calificacion_nivel_2_" + iRow] && "off" == ajax_error_count["calificacion_3_" + iRow] && "off" == ajax_error_count["calificacion_nivel_3_" + iRow] && "off" == ajax_error_count["calificacion_4_" + iRow] && "off" == ajax_error_count["calificacion_nivel_4_" + iRow] && "off" == ajax_error_count["calificacion_5_" + iRow] && "off" == ajax_error_count["calificacion_nivel_5_" + iRow] && "off" == ajax_error_count["calificacion_6_" + iRow] && "off" == ajax_error_count["calificacion_nivel_6_" + iRow] && "off" == ajax_error_count["calificacion_7_" + iRow] && "off" == ajax_error_count["calificacion_nivel_7_" + iRow] && "off" == ajax_error_count["calificacion_8_" + iRow] && "off" == ajax_error_count["calificacion_nivel_8_" + iRow] && "off" == ajax_error_count["calificacion_9_" + iRow] && "off" == ajax_error_count["calificacion_nivel_9_" + iRow] && "off" == ajax_error_count["calificacion_final_" + iRow] && "off" == ajax_error_count["colegio_id_" + iRow] && "off" == ajax_error_count["periodo_id_" + iRow] && "off" == ajax_error_count["curso_id_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["calificacion_nivel_2_" + iRow] = "off";
        ajax_error_count["calificacion_3_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_3_" + iRow] = "off";
        ajax_error_count["calificacion_4_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_4_" + iRow] = "off";
        ajax_error_count["calificacion_5_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_5_" + iRow] = "off";
        ajax_error_count["calificacion_6_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_6_" + iRow] = "off";
        ajax_error_count["calificacion_7_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_7_" + iRow] = "off";
        ajax_error_count["calificacion_8_" + iRow] = "off";
        ajax_error_count["calificacion_nivel_8_" + iRow] = "off";
      ...
      $("#hidden_field_data_calificacion_nivel_2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_3_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_3_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_4_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_4_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_5_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_5_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_6_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_6_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_7_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_7_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_8_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_calificacion_nivel_8_" + iRow).removeClass("scFormErrorLine");
