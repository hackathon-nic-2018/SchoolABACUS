  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_periodos_lectivo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate periodo_descripcion
  function do_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion()
  {
    var nomeCampo_periodo_descripcion = "periodo_descripcion";
    var var_periodo_descripcion = scAjaxGetFieldText(nomeCampo_periodo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion(var_periodo_descripcion, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion_cb);
  } // do_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion

  function do_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo_descripcion";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_periodo_descripcion_cb

  // ---------- Validate desde
  function do_ajax_form_periodos_lectivo_mob_validate_desde()
  {
    var nomeCampo_desde = "desde";
    var var_desde = scAjaxGetFieldText(nomeCampo_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_periodos_lectivo_mob_validate_desde(var_desde, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_desde_cb); }, 200);
  } // do_ajax_form_periodos_lectivo_mob_validate_desde

  function do_ajax_form_periodos_lectivo_mob_validate_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_desde_cb

  // ---------- Validate hasta
  function do_ajax_form_periodos_lectivo_mob_validate_hasta()
  {
    var nomeCampo_hasta = "hasta";
    var var_hasta = scAjaxGetFieldText(nomeCampo_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_periodos_lectivo_mob_validate_hasta(var_hasta, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_hasta_cb); }, 200);
  } // do_ajax_form_periodos_lectivo_mob_validate_hasta

  function do_ajax_form_periodos_lectivo_mob_validate_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_hasta_cb

  // ---------- Validate tipo_periodo_id
  function do_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id()
  {
    var nomeCampo_tipo_periodo_id = "tipo_periodo_id";
    var var_tipo_periodo_id = scAjaxGetFieldSelect(nomeCampo_tipo_periodo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id(var_tipo_periodo_id, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id_cb);
  } // do_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id

  function do_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_periodo_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_tipo_periodo_id_cb

  // ---------- Validate estatus_id
  function do_ajax_form_periodos_lectivo_mob_validate_estatus_id()
  {
    var nomeCampo_estatus_id = "estatus_id";
    var var_estatus_id = scAjaxGetFieldSelect(nomeCampo_estatus_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_mob_validate_estatus_id(var_estatus_id, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_estatus_id_cb);
  } // do_ajax_form_periodos_lectivo_mob_validate_estatus_id

  function do_ajax_form_periodos_lectivo_mob_validate_estatus_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estatus_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_estatus_id_cb

  // ---------- Validate cursos
  function do_ajax_form_periodos_lectivo_mob_validate_cursos()
  {
    var nomeCampo_cursos = "cursos";
    var var_cursos = scAjaxGetFieldText(nomeCampo_cursos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_mob_validate_cursos(var_cursos, var_script_case_init, do_ajax_form_periodos_lectivo_mob_validate_cursos_cb);
  } // do_ajax_form_periodos_lectivo_mob_validate_cursos

  function do_ajax_form_periodos_lectivo_mob_validate_cursos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cursos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_mob_validate_cursos_cb
  // ---------- Form
  function do_ajax_form_periodos_lectivo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_periodos_lectivo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_periodo_descripcion = scAjaxGetFieldText("periodo_descripcion");
    var var_desde = scAjaxGetFieldText("desde");
    var var_hasta = scAjaxGetFieldText("hasta");
    var var_tipo_periodo_id = scAjaxGetFieldSelect("tipo_periodo_id");
    var var_estatus_id = scAjaxGetFieldSelect("estatus_id");
    ...
    scAjaxProcOn();
    x_ajax_form_periodos_lectivo_mob_submit_form(var_periodo_descripcion, var_desde, var_hasta, var_tipo_periodo_id, var_estatus_id, var_colegio_id, var_periodo_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_periodos_lectivo_mob_submit_form_cb);
  } // do_ajax_form_periodos_lectivo_mob_submit_form

  function do_ajax_form_periodos_lectivo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("periodo_descripcion");
      scAjaxHideErrorDisplay("desde");
      scAjaxHideErrorDisplay("hasta");
      scAjaxHideErrorDisplay("tipo_periodo_id");
      scAjaxHideErrorDisplay("estatus_id");
      scAjaxHideErrorDisplay("cursos");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_periodos_lectivo_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_cursos"] = "off";

  function do_ajax_form_periodos_lectivo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_cursos"] = "on";
    x_ajax_form_periodos_lectivo_mob_navigate_form(var_colegio_id, var_periodo_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_periodos_lectivo_mob_navigate_form_cb);
  } // do_ajax_form_periodos_lectivo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_periodos_lectivo_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_periodos_lectivo_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_cursos"] && "nmsc_iframe_liga_grid_cursos" != scMasterDetailIframe["nmsc_iframe_liga_grid_cursos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_cursos"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_cursos').contentWindow.nm_move('apl_detalhe', true);
        }
        document.getElementById('nmsc_iframe_liga_grid_cursos').style.height = "1";
        document.getElementById('nmsc_iframe_liga_grid_cursos').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_periodos_lectivo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_periodos_lectivo_mob_navigate_form_cb
  function sc_hide_form_periodos_lectivo_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_cursos"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "periodo_descripcion";
  ajax_field_list[1] = "desde";
  ajax_field_list[2] = "hasta";
  ajax_field_list[3] = "tipo_periodo_id";
  ajax_field_list[4] = "estatus_id";
  ajax_field_list[5] = "cursos";
  ...
  var ajax_error_list = {
    "periodo_descripcion": {"label": "Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desde": {"label": "Desde", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hasta": {"label": "Hasta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_periodo_id": {"label": "Tipo Periodo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estatus_id": {"label": "Estatus", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cursos": {"label": "Cursos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "periodo_descripcion": new Array(),
    "desde": new Array(),
    "hasta": new Array(),
    "tipo_periodo_id": new Array(),
    "estatus_id": new Array(),
    "cursos": new Array()
  };
  ajax_field_mult["periodo_descripcion"][1] = "periodo_descripcion";
  ajax_field_mult["desde"][1] = "desde";
  ajax_field_mult["hasta"][1] = "hasta";
  ajax_field_mult["tipo_periodo_id"][1] = "tipo_periodo_id";
  ajax_field_mult["estatus_id"][1] = "estatus_id";
  ajax_field_mult["cursos"][1] = "cursos";

  var ajax_field_id = {
    "periodo_descripcion": new Array("hidden_field_label_periodo_descripcion", "hidden_field_data_periodo_descripcion"),
    "desde": new Array("hidden_field_label_desde", "hidden_field_data_desde"),
    "hasta": new Array("hidden_field_label_hasta", "hidden_field_data_hasta"),
    "tipo_periodo_id": new Array("hidden_field_label_tipo_periodo_id", "hidden_field_data_tipo_periodo_id"),
    "estatus_id": new Array("hidden_field_label_estatus_id", "hidden_field_data_estatus_id"),
    "cursos": new Array("hidden_field_label_cursos", "hidden_field_data_cursos")
  };

  var ajax_read_only = {
    "periodo_descripcion": "off",
    "desde": "off",
    "hasta": "off",
    "tipo_periodo_id": "off",
    "estatus_id": "off",
