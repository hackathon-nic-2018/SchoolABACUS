<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="colegio_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['colegio_id']); ?>">
<input type="hidden" name="periodo_id" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['periodo_id']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_periodos_lectivo_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var var_btn_Cursos_vglo_colegio = "<?php echo $this->form_encode_input($this->nmgp_dados_form['colegio_id']); ?>";
var var_btn_Cursos_vglo_periodo = "<?php echo $this->form_encode_input($this->nmgp_dados_form['periodo_id']); ?>";
function sc_btn_Cursos()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_Cursos(); }, 500);
      return;
    }
  nm_gp_submit('<?php echo $this->Ini->link_grid_cursos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "vglo_colegio*scin' + var_btn_Cursos_vglo_colegio + '*scoutvglo_periodo*scin' + var_btn_Cursos_vglo_periodo + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'grid_cursos');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo_mob']['where_detal']))
  {
?>  
