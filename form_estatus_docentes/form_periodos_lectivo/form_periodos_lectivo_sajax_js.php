  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_periodos_lectivo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_periodos_lectivo_validate_periodo_descripcion()
  {
    ...
    x_ajax_form_periodos_lectivo_validate_periodo_descripcion(var_periodo_descripcion, var_script_case_init, do_ajax_form_periodos_lectivo_validate_periodo_descripcion_cb);
  } // do_ajax_form_periodos_lectivo_validate_periodo_descripcion

  function do_ajax_form_periodos_lectivo_validate_periodo_descripcion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_periodo_descripcion_cb

  // ---------- Validate desde
  function do_ajax_form_periodos_lectivo_validate_desde()
  {
    var nomeCampo_desde = "desde";
    var var_desde = scAjaxGetFieldText(nomeCampo_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_periodos_lectivo_validate_desde(var_desde, var_script_case_init, do_ajax_form_periodos_lectivo_validate_desde_cb); }, 200);
  } // do_ajax_form_periodos_lectivo_validate_desde

  function do_ajax_form_periodos_lectivo_validate_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_desde_cb

  // ---------- Validate hasta
  function do_ajax_form_periodos_lectivo_validate_hasta()
  {
    var nomeCampo_hasta = "hasta";
    var var_hasta = scAjaxGetFieldText(nomeCampo_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_periodos_lectivo_validate_hasta(var_hasta, var_script_case_init, do_ajax_form_periodos_lectivo_validate_hasta_cb); }, 200);
  } // do_ajax_form_periodos_lectivo_validate_hasta

  function do_ajax_form_periodos_lectivo_validate_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_hasta_cb

  // ---------- Validate tipo_periodo_id
  function do_ajax_form_periodos_lectivo_validate_tipo_periodo_id()
  {
    var nomeCampo_tipo_periodo_id = "tipo_periodo_id";
    var var_tipo_periodo_id = scAjaxGetFieldSelect(nomeCampo_tipo_periodo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_validate_tipo_periodo_id(var_tipo_periodo_id, var_script_case_init, do_ajax_form_periodos_lectivo_validate_tipo_periodo_id_cb);
  } // do_ajax_form_periodos_lectivo_validate_tipo_periodo_id

  function do_ajax_form_periodos_lectivo_validate_tipo_periodo_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_tipo_periodo_id_cb

  // ---------- Validate estatus_id
  function do_ajax_form_periodos_lectivo_validate_estatus_id()
  {
    var nomeCampo_estatus_id = "estatus_id";
    var var_estatus_id = scAjaxGetFieldSelect(nomeCampo_estatus_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_validate_estatus_id(var_estatus_id, var_script_case_init, do_ajax_form_periodos_lectivo_validate_estatus_id_cb);
  } // do_ajax_form_periodos_lectivo_validate_estatus_id

  function do_ajax_form_periodos_lectivo_validate_estatus_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_estatus_id_cb

  // ---------- Validate cursos
  function do_ajax_form_periodos_lectivo_validate_cursos()
  {
    var nomeCampo_cursos = "cursos";
    var var_cursos = scAjaxGetFieldText(nomeCampo_cursos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_periodos_lectivo_validate_cursos(var_cursos, var_script_case_init, do_ajax_form_periodos_lectivo_validate_cursos_cb);
  } // do_ajax_form_periodos_lectivo_validate_cursos

  function do_ajax_form_periodos_lectivo_validate_cursos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cursos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_periodos_lectivo_validate_cursos_cb
  // ---------- Form
  function do_ajax_form_periodos_lectivo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_periodos_lectivo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_periodos_lectivo_submit_form(var_periodo_descripcion, var_desde, var_hasta, var_tipo_periodo_id, var_estatus_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_periodos_lectivo_submit_form_cb);
  } // do_ajax_form_periodos_lectivo_submit_form

  function do_ajax_form_periodos_lectivo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_periodos_lectivo_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_cursos"] = "off";

  function do_ajax_form_periodos_lectivo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_periodos_lectivo_navigate_form(var_colegio_id, var_periodo_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_periodos_lectivo_navigate_form_cb);
  } // do_ajax_form_periodos_lectivo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_periodos_lectivo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_periodos_lectivo_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_periodos_lectivo_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
...
{
?>
    do_ajax_form_periodos_lectivo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_periodos_lectivo_navigate_form_cb
  function sc_hide_form_periodos_lectivo_form()
  {
