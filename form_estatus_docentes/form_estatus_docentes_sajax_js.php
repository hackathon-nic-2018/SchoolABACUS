  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estatus_docentes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_estatus_docentes_validate_estatus_id_(iNumLinha)
  {
    var nomeCampo_estatus_id_ = "estatus_id_" + iNumLinha;
    var var_estatus_id_ = scAjaxGetFieldText(nomeCampo_estatus_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_docentes_validate_estatus_id_(var_estatus_id_, iNumLinha, var_script_case_init, do_ajax_form_estatus_docentes_validate_estatus_id__cb);
  } // do_ajax_form_estatus_docentes_validate_estatus_id_

  function do_ajax_form_estatus_docentes_validate_estatus_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estatus_docentes_validate_estatus_id__cb

  // ---------- Validate descripcion_
  function do_ajax_form_estatus_docentes_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_docentes_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_estatus_docentes_validate_descripcion__cb);
  } // do_ajax_form_estatus_docentes_validate_descripcion_

  function do_ajax_form_estatus_docentes_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estatus_docentes_validate_descripcion__cb

  // ---------- Validate colegio_id_
  function do_ajax_form_estatus_docentes_validate_colegio_id_(iNumLinha)
  {
    var nomeCampo_colegio_id_ = "colegio_id_" + iNumLinha;
    var var_colegio_id_ = scAjaxGetFieldSelect(nomeCampo_colegio_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_docentes_validate_colegio_id_(var_colegio_id_, iNumLinha, var_script_case_init, do_ajax_form_estatus_docentes_validate_colegio_id__cb);
  } // do_ajax_form_estatus_docentes_validate_colegio_id_

  function do_ajax_form_estatus_docentes_validate_colegio_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estatus_docentes_validate_colegio_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_estatus_docentes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_estatus_docentes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_estatus_docentes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_estatus_docentes_add_new_line_cb);
  } // do_ajax_form_estatus_docentes_add_new_line

  function do_ajax_form_estatus_docentes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_estatus_docentes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_estatus_docentes_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estatus_docentes_backup_line(var_colegio_id_, var_estatus_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_estatus_docentes_backup_line_cb);
  } // do_ajax_form_estatus_docentes_backup_line

  function do_ajax_form_estatus_docentes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_estatus_docentes_backup_line_cb

  function do_ajax_form_estatus_docentes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_estatus_docentes_cancel_insert

  function do_ajax_form_estatus_docentes_cancel_update(iSeqVert)
  {
    do_ajax_form_estatus_docentes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_estatus_docentes_cancel_update

  function do_ajax_form_estatus_docentes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_estatus_docentes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_estatus_docentes_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_estatus_docentes_table_refresh(var_colegio_id_, var_estatus_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estatus_docentes_table_refresh_cb);
  } //  do_ajax_form_estatus_docentes_table_refresh

  function do_ajax_form_estatus_docentes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    sc_insert_open = false;
  } // do_ajax_form_estatus_docentes_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_estatus_docentes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_estatus_docentes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_estatus_docentes_submit_form(var_estatus_id_, var_descripcion_, var_colegio_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estatus_docentes_submit_form_cb);
  } // do_ajax_form_estatus_docentes_submit_form

  function do_ajax_form_estatus_docentes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_estatus_docentes_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_estatus_docentes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_estatus_docentes_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estatus_docentes_navigate_form(var_colegio_id_, var_estatus_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estatus_docentes_navigate_form_cb);
  } // do_ajax_form_estatus_docentes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estatus_docentes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estatus_docentes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
?>
  ...
  } // do_ajax_form_estatus_docentes_navigate_form_cb
  function sc_hide_form_estatus_docentes_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_estatus_docentes_form
