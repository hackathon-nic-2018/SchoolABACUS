...
<?php
   ...
   $Ord_Cmp = new grid_curso_estudiantes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_curso_estudiantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["estudiante_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["estudiante_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["estudiante_id"] : "Estudiante";
   $tab_ger_campos['estatus'] = "on";
   $tab_def_campos['estatus'] = "estatus";
   $tab_converte["estatus"]   = "estatus";
   $tab_labels["estatus"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["estatus"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["estatus"] : "Estatus";
   $tab_ger_campos['numero_lista'] = "on";
   $tab_def_campos['numero_lista'] = "numero_lista";
   $tab_converte["numero_lista"]   = "numero_lista";
   $tab_labels["numero_lista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["numero_lista"])) ? $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['labels']["numero_lista"] : "Numero Lista";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select'][$campo] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_curso_estudiantes_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_curso_estudiantes']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
