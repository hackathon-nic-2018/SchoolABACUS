  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cursos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grado_id
  function do_ajax_form_cursos_validate_grado_id()
  {
    var nomeCampo_grado_id = "grado_id";
    var var_grado_id = scAjaxGetFieldSelect(nomeCampo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_grado_id(var_grado_id, var_script_case_init, do_ajax_form_cursos_validate_grado_id_cb);
  } // do_ajax_form_cursos_validate_grado_id

  function do_ajax_form_cursos_validate_grado_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_grado_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_cursos_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cursos_validate_descripcion_cb);
  } // do_ajax_form_cursos_validate_descripcion

  function do_ajax_form_cursos_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_descripcion_cb

  // ---------- Validate ubicacion
  function do_ajax_form_cursos_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_form_cursos_validate_ubicacion_cb);
  } // do_ajax_form_cursos_validate_ubicacion

  function do_ajax_form_cursos_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_ubicacion_cb

  // ---------- Validate turno_id
  function do_ajax_form_cursos_validate_turno_id()
  {
    var nomeCampo_turno_id = "turno_id";
    var var_turno_id = scAjaxGetFieldSelect(nomeCampo_turno_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_turno_id(var_turno_id, var_script_case_init, do_ajax_form_cursos_validate_turno_id_cb);
  } // do_ajax_form_cursos_validate_turno_id

  function do_ajax_form_cursos_validate_turno_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_turno_id_cb

  // ---------- Validate docente_guia_id
  function do_ajax_form_cursos_validate_docente_guia_id()
  {
  } // do_ajax_form_cursos_validate_docente_guia_id

  function do_ajax_form_cursos_validate_docente_guia_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_docente_guia_id_cb

  // ---------- Validate comentarios
  function do_ajax_form_cursos_validate_comentarios()
  {
    var nomeCampo_comentarios = "comentarios";
    var var_comentarios = scAjaxGetFieldText(nomeCampo_comentarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_comentarios(var_comentarios, var_script_case_init, do_ajax_form_cursos_validate_comentarios_cb);
  } // do_ajax_form_cursos_validate_comentarios

  function do_ajax_form_cursos_validate_comentarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_comentarios_cb

  // ---------- Validate cant_max_alumnos
  function do_ajax_form_cursos_validate_cant_max_alumnos()
  {
    var nomeCampo_cant_max_alumnos = "cant_max_alumnos";
    var var_cant_max_alumnos = scAjaxGetFieldText(nomeCampo_cant_max_alumnos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_cant_max_alumnos(var_cant_max_alumnos, var_script_case_init, do_ajax_form_cursos_validate_cant_max_alumnos_cb);
  } // do_ajax_form_cursos_validate_cant_max_alumnos

  function do_ajax_form_cursos_validate_cant_max_alumnos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_cant_max_alumnos_cb

  // ---------- Validate estudiantes
  function do_ajax_form_cursos_validate_estudiantes()
  {
    var nomeCampo_estudiantes = "estudiantes";
    var var_estudiantes = scAjaxGetFieldText(nomeCampo_estudiantes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_estudiantes(var_estudiantes, var_script_case_init, do_ajax_form_cursos_validate_estudiantes_cb);
  } // do_ajax_form_cursos_validate_estudiantes

  function do_ajax_form_cursos_validate_estudiantes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_estudiantes_cb

  // ---------- Validate asignaturas
  function do_ajax_form_cursos_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_cursos_validate_asignaturas_cb);
  } // do_ajax_form_cursos_validate_asignaturas

  function do_ajax_form_cursos_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_cursos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cursos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cursos_submit_form(var_grado_id, var_descripcion, var_ubicacion, var_turno_id, var_docente_guia_id, var_comentarios, var_cant_max_alumnos, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cursos_submit_form_cb);
  } // do_ajax_form_cursos_submit_form

  function do_ajax_form_cursos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
  ...
  } // do_ajax_form_cursos_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_curso_estudiantes"] = "off";
  scStatusDetail["form_curso_asignaturas"] = "off";

  function do_ajax_form_cursos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scStatusDetail["form_curso_asignaturas"] = "on";
    x_ajax_form_cursos_navigate_form(var_colegio_id, var_periodo_id, var_curso_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cursos_navigate_form_cb);
  } // do_ajax_form_cursos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cursos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas"] && "nmsc_iframe_liga_form_curso_asignaturas" != scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_cursos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cursos_navigate_form_cb
  function sc_hide_form_cursos_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_curso_estudiantes"] && "off" == scStatusDetail["form_curso_asignaturas"])
    {
      return true;
    }
    return false;
