...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_cursos_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_cursos_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-docente_guia_id", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "docente_guia_id" != sId ? sId.substr(15) : "";
   sc_form_cursos_docente_guia_id_onfocus("id_sc_field_" + sId, sRow);
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['recarga'];
}
?>
...
<?php
 include_once("form_cursos_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cursos'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cursos'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes != "novo") && ($opcao_botoes != "novo")) {
        $sCondStyle = ($this->nmgp_botoes['Estudiantes'] == "on") ? '' : 'display: none;';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "estudiantes", "scBtnFn_Estudiantes()", "scBtnFn_Estudiantes()", "sc_Estudiantes_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_grado_id_label" id="hidden_field_label_grado_id" style="<?php echo $sStyleHidden_grado_id; ?>"><span id="id_label_grado_id"><?php echo $this->nm_new_label['grado_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['grado_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['grado_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_grado_id_line" id="hidden_field_data_grado_id" style="<?php echo $sStyleHidden_grado_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_grado_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_descripcion_label" id="hidden_field_label_descripcion" style="<?php echo $sStyleHidden_descripcion; ?>"><span id="id_label_descripcion"><?php echo $this->nm_new_label['descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ubicacion_label" id="hidden_field_label_ubicacion" style="<?php echo $sStyleHidden_ubicacion; ?>"><span id="id_label_ubicacion"><?php echo $this->nm_new_label['ubicacion']; ?></span></TD>
    <TD class="scFormDataOdd css_ubicacion_line" id="hidden_field_data_ubicacion" style="<?php echo $sStyleHidden_ubicacion; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ubicacion_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_turno_id_label" id="hidden_field_label_turno_id" style="<?php echo $sStyleHidden_turno_id; ?>"><span id="id_label_turno_id"><?php echo $this->nm_new_label['turno_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['turno_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['turno_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_turno_id_line" id="hidden_field_data_turno_id" style="<?php echo $sStyleHidden_turno_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_turno_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_docente_guia_id_label" id="hidden_field_label_docente_guia_id" style="<?php echo $sStyleHidden_docente_guia_id; ?>"><span id="id_label_docente_guia_id"><?php echo $this->nm_new_label['docente_guia_id']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['docente_guia_id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['php_cmp_required']['docente_guia_id'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_docente_guia_id_line" id="hidden_field_data_docente_guia_id" style="<?php echo $sStyleHidden_docente_guia_id; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_docente_guia_id_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_comentarios_label" id="hidden_field_label_comentarios" style="<?php echo $sStyleHidden_comentarios; ?>"><span id="id_label_comentarios"><?php echo $this->nm_new_label['comentarios']; ?></span></TD>
    <TD class="scFormDataOdd css_comentarios_line" id="hidden_field_data_comentarios" style="<?php echo $sStyleHidden_comentarios; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_comentarios_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cant_max_alumnos_label" id="hidden_field_label_cant_max_alumnos" style="<?php echo $sStyleHidden_cant_max_alumnos; ?>"><span id="id_label_cant_max_alumnos"><?php echo $this->nm_new_label['cant_max_alumnos']; ?></span></TD>
    <TD class="scFormDataOdd css_cant_max_alumnos_line" id="hidden_field_data_cant_max_alumnos" style="<?php echo $sStyleHidden_cant_max_alumnos; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cant_max_alumnos_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Estudiantes'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Estudiantes'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['grid_curso_estudiantes_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Estudiantes'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['grid_curso_estudiantes_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_curso_estudiantes"]) && $this->Ini->sc_lig_md5["grid_curso_estudiantes"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cursos@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cursos_empty.htm' : $this->Ini->link_grid_curso_estudiantes_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_Estudiantes']) && 'nmsc_iframe_liga_grid_curso_estudiantes' != $this->Ini->sc_lig_target['C_@scinf_Estudiantes'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Estudiantes'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['grid_curso_estudiantes_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_asignaturas'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_asignaturas'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_asignaturas'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_qtd_reg'] = '';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_curso_asignaturas']['embutida_liga_tp_pag'] = 'total';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init'] ]['form_cursos']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cursos_empty.htm' : $this->Ini->link_form_curso_asignaturas_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_asignaturas']) && 'nmsc_iframe_liga_form_curso_asignaturas' != $this->Ini->sc_lig_target['C_@scinf_asignaturas'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_asignaturas'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['form_curso_asignaturas_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_curso_asignaturas"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_curso_asignaturas"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_cursos");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_cursos");
 parent.scAjaxDetailHeight("form_cursos", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
