...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["estudiantes" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_estudiantes' + iSeqRow).bind('blur', function() { sc_form_cursos_estudiantes_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cursos_estudiantes_onfocus(this, iSeqRow) });
  $('#id_sc_field_asignaturas' + iSeqRow).bind('blur', function() { sc_form_cursos_asignaturas_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cursos_asignaturas_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_form_cursos_estudiantes_onblur(oThis, iSeqRow) {
  do_ajax_form_cursos_mob_validate_estudiantes();
  scCssBlur(oThis);
}

function sc_form_cursos_estudiantes_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_cursos_asignaturas_onblur(oThis, iSeqRow) {
  do_ajax_form_cursos_mob_validate_asignaturas();
  scCssBlur(oThis);
}

function sc_form_cursos_asignaturas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_1(status) {
	displayChange_field("Estudiantes", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_estudiantes(row, status);
...
function displayChange_field_estudiantes(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_cursos_mob_form" + pageNo).hide();
}
