  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cursos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate grado_id
  function do_ajax_form_cursos_mob_validate_grado_id()
  {
    var nomeCampo_grado_id = "grado_id";
    var var_grado_id = scAjaxGetFieldSelect(nomeCampo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_grado_id(var_grado_id, var_script_case_init, do_ajax_form_cursos_mob_validate_grado_id_cb);
  } // do_ajax_form_cursos_mob_validate_grado_id

  function do_ajax_form_cursos_mob_validate_grado_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_grado_id_cb

  // ---------- Validate descripcion
  function do_ajax_form_cursos_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cursos_mob_validate_descripcion_cb);
  } // do_ajax_form_cursos_mob_validate_descripcion

  function do_ajax_form_cursos_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_descripcion_cb

  // ---------- Validate ubicacion
  function do_ajax_form_cursos_mob_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_form_cursos_mob_validate_ubicacion_cb);
  } // do_ajax_form_cursos_mob_validate_ubicacion

  function do_ajax_form_cursos_mob_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_ubicacion_cb

  // ---------- Validate turno_id
  function do_ajax_form_cursos_mob_validate_turno_id()
  {
    var nomeCampo_turno_id = "turno_id";
    var var_turno_id = scAjaxGetFieldSelect(nomeCampo_turno_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_turno_id(var_turno_id, var_script_case_init, do_ajax_form_cursos_mob_validate_turno_id_cb);
  } // do_ajax_form_cursos_mob_validate_turno_id

  function do_ajax_form_cursos_mob_validate_turno_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "turno_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_turno_id_cb

  // ---------- Validate docente_guia_id
  function do_ajax_form_cursos_mob_validate_docente_guia_id()
  {
  } // do_ajax_form_cursos_mob_validate_docente_guia_id

  function do_ajax_form_cursos_mob_validate_docente_guia_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "docente_guia_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_docente_guia_id_cb

  // ---------- Validate comentarios
  function do_ajax_form_cursos_mob_validate_comentarios()
  {
    var nomeCampo_comentarios = "comentarios";
    var var_comentarios = scAjaxGetFieldText(nomeCampo_comentarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_comentarios(var_comentarios, var_script_case_init, do_ajax_form_cursos_mob_validate_comentarios_cb);
  } // do_ajax_form_cursos_mob_validate_comentarios

  function do_ajax_form_cursos_mob_validate_comentarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_comentarios_cb

  // ---------- Validate cant_max_alumnos
  function do_ajax_form_cursos_mob_validate_cant_max_alumnos()
  {
    var nomeCampo_cant_max_alumnos = "cant_max_alumnos";
    var var_cant_max_alumnos = scAjaxGetFieldText(nomeCampo_cant_max_alumnos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_cant_max_alumnos(var_cant_max_alumnos, var_script_case_init, do_ajax_form_cursos_mob_validate_cant_max_alumnos_cb);
  } // do_ajax_form_cursos_mob_validate_cant_max_alumnos

  function do_ajax_form_cursos_mob_validate_cant_max_alumnos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cant_max_alumnos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_cant_max_alumnos_cb

  // ---------- Validate estudiantes
  function do_ajax_form_cursos_mob_validate_estudiantes()
  {
    var nomeCampo_estudiantes = "estudiantes";
    var var_estudiantes = scAjaxGetFieldText(nomeCampo_estudiantes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_estudiantes(var_estudiantes, var_script_case_init, do_ajax_form_cursos_mob_validate_estudiantes_cb);
  } // do_ajax_form_cursos_mob_validate_estudiantes

  function do_ajax_form_cursos_mob_validate_estudiantes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estudiantes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_estudiantes_cb

  // ---------- Validate asignaturas
  function do_ajax_form_cursos_mob_validate_asignaturas()
  {
    var nomeCampo_asignaturas = "asignaturas";
    var var_asignaturas = scAjaxGetFieldText(nomeCampo_asignaturas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cursos_mob_validate_asignaturas(var_asignaturas, var_script_case_init, do_ajax_form_cursos_mob_validate_asignaturas_cb);
  } // do_ajax_form_cursos_mob_validate_asignaturas

  function do_ajax_form_cursos_mob_validate_asignaturas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asignaturas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cursos_mob_validate_asignaturas_cb
  // ---------- Form
  function do_ajax_form_cursos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cursos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_turno_id = scAjaxGetFieldSelect("turno_id");
    var var_docente_guia_id = scAjaxGetFieldText("docente_guia_id");
    var var_comentarios = scAjaxGetFieldText("comentarios");
    var var_cant_max_alumnos = scAjaxGetFieldText("cant_max_alumnos");
    var var_colegio_id = scAjaxGetFieldText("colegio_id");
    var var_periodo_id = scAjaxGetFieldText("periodo_id");
    var var_curso_id = scAjaxGetFieldText("curso_id");
    ...
    scAjaxProcOn();
    x_ajax_form_cursos_mob_submit_form(var_grado_id, var_descripcion, var_ubicacion, var_turno_id, var_docente_guia_id, var_comentarios, var_cant_max_alumnos, var_colegio_id, var_periodo_id, var_curso_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cursos_mob_submit_form_cb);
  } // do_ajax_form_cursos_mob_submit_form

  function do_ajax_form_cursos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("turno_id");
      scAjaxHideErrorDisplay("docente_guia_id");
      scAjaxHideErrorDisplay("comentarios");
      scAjaxHideErrorDisplay("cant_max_alumnos");
      scAjaxHideErrorDisplay("estudiantes");
      scAjaxHideErrorDisplay("asignaturas");
      scLigEditLookupCall();
<?php
...
?>
  ...
  } // do_ajax_form_cursos_mob_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_curso_estudiantes"] = "off";
  scStatusDetail["form_curso_asignaturas_mob"] = "off";

  function do_ajax_form_cursos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_periodo_id = document.F2.periodo_id.value;
    var var_curso_id = document.F2.curso_id.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_curso_estudiantes"] = "on";
    scStatusDetail["form_curso_asignaturas_mob"] = "on";
    x_ajax_form_cursos_mob_navigate_form(var_colegio_id, var_periodo_id, var_curso_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cursos_mob_navigate_form_cb);
  } // do_ajax_form_cursos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cursos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cursos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_cursos_mob_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.colegio_id.value = scAjaxGetKeyValue("colegio_id");
    document.F2.periodo_id.value = scAjaxGetKeyValue("periodo_id");
    document.F2.curso_id.value = scAjaxGetKeyValue("curso_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_curso_estudiantes"] && "nmsc_iframe_liga_grid_curso_estudiantes" != scMasterDetailIframe["nmsc_iframe_liga_grid_curso_estudiantes"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_curso_estudiantes"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_curso_estudiantes').contentWindow.nm_move('apl_detalhe', true);
        }
        document.getElementById('nmsc_iframe_liga_grid_curso_estudiantes').style.height = "1";
        document.getElementById('nmsc_iframe_liga_grid_curso_estudiantes').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas_mob"] && "nmsc_iframe_liga_form_curso_asignaturas_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_curso_asignaturas_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_curso_asignaturas_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert();
...
{
?>
    do_ajax_form_cursos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cursos_mob_navigate_form_cb
  function sc_hide_form_cursos_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_curso_estudiantes"] && "off" == scStatusDetail["form_curso_asignaturas_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "grado_id";
  ajax_field_list[1] = "descripcion";
  ajax_field_list[2] = "ubicacion";
  ajax_field_list[3] = "turno_id";
  ajax_field_list[4] = "docente_guia_id";
  ajax_field_list[5] = "comentarios";
  ajax_field_list[6] = "cant_max_alumnos";
  ajax_field_list[7] = "estudiantes";
  ajax_field_list[8] = "asignaturas";
  ...
  var ajax_error_list = {
    ...
    "turno_id": {"label": "Turno", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "docente_guia_id": {"label": "Docente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "cant_max_alumnos": {"label": "Cant Max Alumnos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estudiantes": {"label": "Estudiantes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "asignaturas": {"label": "asignaturas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "ubicacion": new Array(),
    "turno_id": new Array(),
    "docente_guia_id": new Array(),
    "comentarios": new Array(),
    "cant_max_alumnos": new Array(),
  ...
  ajax_field_mult["turno_id"][1] = "turno_id";
  ajax_field_mult["docente_guia_id"][1] = "docente_guia_id";
  ajax_field_mult["comentarios"][1] = "comentarios";
  ajax_field_mult["cant_max_alumnos"][1] = "cant_max_alumnos";
  ajax_field_mult["estudiantes"][1] = "estudiantes";
  ajax_field_mult["asignaturas"][1] = "asignaturas";
  ...
  var ajax_field_id = {
    ...
    "turno_id": new Array("hidden_field_label_turno_id", "hidden_field_data_turno_id"),
    "docente_guia_id": new Array("hidden_field_label_docente_guia_id", "hidden_field_data_docente_guia_id"),
    "comentarios": new Array("hidden_field_label_comentarios", "hidden_field_data_comentarios"),
    "cant_max_alumnos": new Array("hidden_field_label_cant_max_alumnos", "hidden_field_data_cant_max_alumnos"),
    "estudiantes": new Array("hidden_field_label_estudiantes", "hidden_field_data_estudiantes"),
    "asignaturas": new Array("hidden_field_label_asignaturas", "hidden_field_data_asignaturas")
  };
