...
class grid_cursos_xml
{
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['embutida'])
         { 
             $this->xml_registro .= "<" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['embutida_tit'] . ">\r\n";
         }
         elseif ($this->New_Format)
         {
             $this->xml_registro = "<grid_cursos>\r\n";
         }
         else
         {
             $this->xml_registro = "<grid_cursos";
   ...
   {
         nmgp_Form_Num_Val($this->look_grado_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_grado_id))
         {
             $this->look_grado_id = sc_convert_encoding($this->look_grado_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->New_Format)
         {
             $this->xml_registro .= " <grado_id>" . $this->trata_dados($this->look_grado_id) . "</grado_id>\r\n";
         }
         else
         {
             $this->xml_registro .= " grado_id =\"" . $this->trata_dados($this->look_grado_id) . "\"";
         }
   }
   //----- descripcion
   ...
   function NM_export_ubicacion()
   {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <ubicacion>" . $this->trata_dados($this->ubicacion) . "</ubicacion>\r\n";
         }
         else
         {
   ...
   {
         nmgp_Form_Num_Val($this->look_docente_guia_id, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_docente_guia_id))
         {
             $this->look_docente_guia_id = sc_convert_encoding($this->look_docente_guia_id, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->New_Format)
         {
             $this->xml_registro .= " <docente_guia_id>" . $this->trata_dados($this->look_docente_guia_id) . "</docente_guia_id>\r\n";
         }
         else
         {
             $this->xml_registro .= " docente_guia_id =\"" . $this->trata_dados($this->look_docente_guia_id) . "\"";
         }
   }
   //----- colegio_id
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cursos']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Cursos del Periodo :: XML</TITLE>
