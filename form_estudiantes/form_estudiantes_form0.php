...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_estudiantes_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_estudiantes_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['recarga'];
}
?>
...
<?php
 include_once("form_estudiantes_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_estudiantes'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_estudiantes'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_estudiante_label" id="hidden_field_label_codigo_estudiante" style="<?php echo $sStyleHidden_codigo_estudiante; ?>"><span id="id_label_codigo_estudiante"><?php echo $this->nm_new_label['codigo_estudiante']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['codigo_estudiante']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['codigo_estudiante'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_codigo_estudiante_line" id="hidden_field_data_codigo_estudiante" style="<?php echo $sStyleHidden_codigo_estudiante; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_estudiante_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_numero_carnet_label" id="hidden_field_label_numero_carnet" style="<?php echo $sStyleHidden_numero_carnet; ?>"><span id="id_label_numero_carnet"><?php echo $this->nm_new_label['numero_carnet']; ?></span></TD>
    <TD class="scFormDataOdd css_numero_carnet_line" id="hidden_field_data_numero_carnet" style="<?php echo $sStyleHidden_numero_carnet; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_carnet_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_estatus_label" id="hidden_field_label_estatus" style="<?php echo $sStyleHidden_estatus; ?>"><span id="id_label_estatus"><?php echo $this->nm_new_label['estatus']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['estatus']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['estatus'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_estatus_line" id="hidden_field_data_estatus" style="<?php echo $sStyleHidden_estatus; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estatus_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_primer_apellido_label" id="hidden_field_label_primer_apellido" style="<?php echo $sStyleHidden_primer_apellido; ?>"><span id="id_label_primer_apellido"><?php echo $this->nm_new_label['primer_apellido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['primer_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['primer_apellido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_primer_apellido_line" id="hidden_field_data_primer_apellido" style="<?php echo $sStyleHidden_primer_apellido; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_primer_apellido_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_segundo_apellido_label" id="hidden_field_label_segundo_apellido" style="<?php echo $sStyleHidden_segundo_apellido; ?>"><span id="id_label_segundo_apellido"><?php echo $this->nm_new_label['segundo_apellido']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['segundo_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['segundo_apellido'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_segundo_apellido_line" id="hidden_field_data_segundo_apellido" style="<?php echo $sStyleHidden_segundo_apellido; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_segundo_apellido_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombres_label" id="hidden_field_label_nombres" style="<?php echo $sStyleHidden_nombres; ?>"><span id="id_label_nombres"><?php echo $this->nm_new_label['nombres']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['nombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['nombres'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sexo_label" id="hidden_field_label_sexo" style="<?php echo $sStyleHidden_sexo; ?>"><span id="id_label_sexo"><?php echo $this->nm_new_label['sexo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['sexo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['sexo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_sexo_line" id="hidden_field_data_sexo" style="<?php echo $sStyleHidden_sexo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sexo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['Lookup_sexo'][] = 'M'; ?>
 <option  value="F" <?php  if ($this->sexo == "F") { echo " selected" ;} ?>>Femenino</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['Lookup_sexo'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_grado_id_label" id="hidden_field_label_grado_id" style="<?php echo $sStyleHidden_grado_id; ?>"><span id="id_label_grado_id"><?php echo $this->nm_new_label['grado_id']; ?></span></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_nacimiento_label" id="hidden_field_label_fecha_nacimiento" style="<?php echo $sStyleHidden_fecha_nacimiento; ?>"><span id="id_label_fecha_nacimiento"><?php echo $this->nm_new_label['fecha_nacimiento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['fecha_nacimiento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['fecha_nacimiento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_ingreso_label" id="hidden_field_label_fecha_ingreso" style="<?php echo $sStyleHidden_fecha_ingreso; ?>"><span id="id_label_fecha_ingreso"><?php echo $this->nm_new_label['fecha_ingreso']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['fecha_ingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['php_cmp_required']['fecha_ingreso'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fecha_ingreso_line" id="hidden_field_data_fecha_ingreso" style="<?php echo $sStyleHidden_fecha_ingreso; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_ingreso_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_telefono_line" id="hidden_field_data_telefono" style="<?php echo $sStyleHidden_telefono; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_telefono_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombre_padre_label" id="hidden_field_label_nombre_padre" style="<?php echo $sStyleHidden_nombre_padre; ?>"><span id="id_label_nombre_padre"><?php echo $this->nm_new_label['nombre_padre']; ?></span></TD>
    <TD class="scFormDataOdd css_nombre_padre_line" id="hidden_field_data_nombre_padre" style="<?php echo $sStyleHidden_nombre_padre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_padre_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nombre_madre_label" id="hidden_field_label_nombre_madre" style="<?php echo $sStyleHidden_nombre_madre; ?>"><span id="id_label_nombre_madre"><?php echo $this->nm_new_label['nombre_madre']; ?></span></TD>
    <TD class="scFormDataOdd css_nombre_madre_line" id="hidden_field_data_nombre_madre" style="<?php echo $sStyleHidden_nombre_madre; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_madre_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_padres_estudiante'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_padres_estudiante'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['grid_padres_estudiantes_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_padres_estudiante'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['grid_padres_estudiantes_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_padres_estudiantes"]) && $this->Ini->sc_lig_md5["grid_padres_estudiantes"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_estudiantes@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_estudiantes_empty.htm' : $this->Ini->link_grid_padres_estudiantes_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_session=' . session_id() . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_padres_estudiante']) && 'nmsc_iframe_liga_grid_padres_estudiantes' != $this->Ini->sc_lig_target['C_@scinf_padres_estudiante'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_padres_estudiante'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['grid_padres_estudiantes_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_estudiantes");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_estudiantes");
 parent.scAjaxDetailHeight("form_estudiantes", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
