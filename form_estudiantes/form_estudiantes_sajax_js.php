  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estudiantes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate fotografia
  function do_ajax_form_estudiantes_validate_fotografia()
  {
    var nomeCampo_fotografia = "fotografia";
    var var_fotografia = scAjaxGetFieldText(nomeCampo_fotografia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_fotografia(var_fotografia, var_script_case_init, do_ajax_form_estudiantes_validate_fotografia_cb);
  } // do_ajax_form_estudiantes_validate_fotografia

  function do_ajax_form_estudiantes_validate_fotografia_cb(sResp)
  {
  ...
  function do_ajax_form_estudiantes_validate_codigo_estudiante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_codigo_estudiante(var_codigo_estudiante, var_script_case_init, do_ajax_form_estudiantes_validate_codigo_estudiante_cb);
  } // do_ajax_form_estudiantes_validate_codigo_estudiante

  function do_ajax_form_estudiantes_validate_codigo_estudiante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_codigo_estudiante_cb

  // ---------- Validate numero_carnet
  function do_ajax_form_estudiantes_validate_numero_carnet()
  {
    var nomeCampo_numero_carnet = "numero_carnet";
    var var_numero_carnet = scAjaxGetFieldText(nomeCampo_numero_carnet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_numero_carnet(var_numero_carnet, var_script_case_init, do_ajax_form_estudiantes_validate_numero_carnet_cb);
  } // do_ajax_form_estudiantes_validate_numero_carnet

  function do_ajax_form_estudiantes_validate_numero_carnet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_numero_carnet_cb

  // ---------- Validate estatus
  function do_ajax_form_estudiantes_validate_estatus()
  {
    var nomeCampo_estatus = "estatus";
    var var_estatus = scAjaxGetFieldSelect(nomeCampo_estatus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_estatus(var_estatus, var_script_case_init, do_ajax_form_estudiantes_validate_estatus_cb);
  } // do_ajax_form_estudiantes_validate_estatus

  function do_ajax_form_estudiantes_validate_estatus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estatus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_estatus_cb

  // ---------- Validate primer_apellido
  function do_ajax_form_estudiantes_validate_primer_apellido()
  {
    var nomeCampo_primer_apellido = "primer_apellido";
    var var_primer_apellido = scAjaxGetFieldText(nomeCampo_primer_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_primer_apellido(var_primer_apellido, var_script_case_init, do_ajax_form_estudiantes_validate_primer_apellido_cb);
  } // do_ajax_form_estudiantes_validate_primer_apellido

  function do_ajax_form_estudiantes_validate_primer_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_primer_apellido_cb

  // ---------- Validate segundo_apellido
  function do_ajax_form_estudiantes_validate_segundo_apellido()
  {
    var nomeCampo_segundo_apellido = "segundo_apellido";
    var var_segundo_apellido = scAjaxGetFieldText(nomeCampo_segundo_apellido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_segundo_apellido(var_segundo_apellido, var_script_case_init, do_ajax_form_estudiantes_validate_segundo_apellido_cb);
  } // do_ajax_form_estudiantes_validate_segundo_apellido

  function do_ajax_form_estudiantes_validate_segundo_apellido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_segundo_apellido_cb

  // ---------- Validate nombres
  function do_ajax_form_estudiantes_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_nombres(var_nombres, var_script_case_init, do_ajax_form_estudiantes_validate_nombres_cb);
  } // do_ajax_form_estudiantes_validate_nombres

  function do_ajax_form_estudiantes_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_nombres_cb

  // ---------- Validate sexo
  function do_ajax_form_estudiantes_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_estudiantes_validate_sexo_cb);
  } // do_ajax_form_estudiantes_validate_sexo

  function do_ajax_form_estudiantes_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_sexo_cb

  // ---------- Validate grado_id
  function do_ajax_form_estudiantes_validate_grado_id()
  {
    var nomeCampo_grado_id = "grado_id";
    var var_grado_id = scAjaxGetFieldSelect(nomeCampo_grado_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_grado_id(var_grado_id, var_script_case_init, do_ajax_form_estudiantes_validate_grado_id_cb);
  } // do_ajax_form_estudiantes_validate_grado_id

  function do_ajax_form_estudiantes_validate_grado_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_grado_id_cb

  // ---------- Validate fecha_nacimiento
  function do_ajax_form_estudiantes_validate_fecha_nacimiento()
  {
    var nomeCampo_fecha_nacimiento = "fecha_nacimiento";
    var var_fecha_nacimiento = scAjaxGetFieldText(nomeCampo_fecha_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_estudiantes_validate_fecha_nacimiento(var_fecha_nacimiento, var_script_case_init, do_ajax_form_estudiantes_validate_fecha_nacimiento_cb); }, 200);
  } // do_ajax_form_estudiantes_validate_fecha_nacimiento

  function do_ajax_form_estudiantes_validate_fecha_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_fecha_nacimiento_cb

  // ---------- Validate fecha_ingreso
  function do_ajax_form_estudiantes_validate_fecha_ingreso()
  {
    var nomeCampo_fecha_ingreso = "fecha_ingreso";
    var var_fecha_ingreso = scAjaxGetFieldText(nomeCampo_fecha_ingreso);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() { x_ajax_form_estudiantes_validate_fecha_ingreso(var_fecha_ingreso, var_script_case_init, do_ajax_form_estudiantes_validate_fecha_ingreso_cb); }, 200);
  } // do_ajax_form_estudiantes_validate_fecha_ingreso

  function do_ajax_form_estudiantes_validate_fecha_ingreso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_fecha_ingreso_cb

  // ---------- Validate direccion_linea1
  function do_ajax_form_estudiantes_validate_direccion_linea1()
  {
    var nomeCampo_direccion_linea1 = "direccion_linea1";
    var var_direccion_linea1 = scAjaxGetFieldText(nomeCampo_direccion_linea1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_direccion_linea1(var_direccion_linea1, var_script_case_init, do_ajax_form_estudiantes_validate_direccion_linea1_cb);
  } // do_ajax_form_estudiantes_validate_direccion_linea1

  function do_ajax_form_estudiantes_validate_direccion_linea1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_direccion_linea1_cb

  // ---------- Validate direccion_linea2
  function do_ajax_form_estudiantes_validate_direccion_linea2()
  {
    var nomeCampo_direccion_linea2 = "direccion_linea2";
    var var_direccion_linea2 = scAjaxGetFieldText(nomeCampo_direccion_linea2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_direccion_linea2(var_direccion_linea2, var_script_case_init, do_ajax_form_estudiantes_validate_direccion_linea2_cb);
  } // do_ajax_form_estudiantes_validate_direccion_linea2

  function do_ajax_form_estudiantes_validate_direccion_linea2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_direccion_linea2_cb

  // ---------- Validate telefono
  function do_ajax_form_estudiantes_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_estudiantes_validate_telefono_cb);
  } // do_ajax_form_estudiantes_validate_telefono

  function do_ajax_form_estudiantes_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_telefono_cb

  // ---------- Validate nombre_padre
  function do_ajax_form_estudiantes_validate_nombre_padre()
  {
    var nomeCampo_nombre_padre = "nombre_padre";
    var var_nombre_padre = scAjaxGetFieldText(nomeCampo_nombre_padre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_nombre_padre(var_nombre_padre, var_script_case_init, do_ajax_form_estudiantes_validate_nombre_padre_cb);
  } // do_ajax_form_estudiantes_validate_nombre_padre

  function do_ajax_form_estudiantes_validate_nombre_padre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_nombre_padre_cb

  // ---------- Validate nombre_madre
  function do_ajax_form_estudiantes_validate_nombre_madre()
  {
    var nomeCampo_nombre_madre = "nombre_madre";
    var var_nombre_madre = scAjaxGetFieldText(nomeCampo_nombre_madre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_nombre_madre(var_nombre_madre, var_script_case_init, do_ajax_form_estudiantes_validate_nombre_madre_cb);
  } // do_ajax_form_estudiantes_validate_nombre_madre

  function do_ajax_form_estudiantes_validate_nombre_madre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_nombre_madre_cb

  // ---------- Validate comentarios
  function do_ajax_form_estudiantes_validate_comentarios()
  {
    var nomeCampo_comentarios = "comentarios";
    var var_comentarios = scAjaxGetFieldText(nomeCampo_comentarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_comentarios(var_comentarios, var_script_case_init, do_ajax_form_estudiantes_validate_comentarios_cb);
  } // do_ajax_form_estudiantes_validate_comentarios

  function do_ajax_form_estudiantes_validate_comentarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_comentarios_cb

  // ---------- Validate padres_estudiante
  function do_ajax_form_estudiantes_validate_padres_estudiante()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estudiantes_validate_padres_estudiante(var_padres_estudiante, var_script_case_init, do_ajax_form_estudiantes_validate_padres_estudiante_cb);
  } // do_ajax_form_estudiantes_validate_padres_estudiante

  function do_ajax_form_estudiantes_validate_padres_estudiante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estudiantes_validate_padres_estudiante_cb
  // ---------- Form
  function do_ajax_form_estudiantes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estudiantes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
  ...
  } // do_ajax_form_estudiantes_submit_form_cb

  var scStatusDetail = {};
  scStatusDetail["grid_padres_estudiantes"] = "off";

  function do_ajax_form_estudiantes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_estudiantes_navigate_form(var_colegio_id, var_estudiante_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estudiantes_navigate_form_cb);
  } // do_ajax_form_estudiantes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_estudiantes_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
{
?>
    do_ajax_form_estudiantes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_estudiantes_navigate_form_cb
  function sc_hide_form_estudiantes_form()
  {
