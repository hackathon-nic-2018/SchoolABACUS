<?php
//
class form_estudiantes_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->vglo_colegio)) 
          {
              $_SESSION['vglo_colegio'] = $this->vglo_colegio;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_estudiantes_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_estudiantes_mob']['upload_field_info']['fotografia'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_estudiantes_mob',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_estudiantes_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_estudiantes_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_estudiantes_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_estudiantes_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_estudiantes_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_estudiantes_mob']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " estudiantes";
      ...
      $_SESSION['scriptcase']['error_icon']['form_estudiantes_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_estudiantes_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_field_ul_name'][$this->fotografia_ul_name]))
          {
              $this->NM_ajax_info['param']['fotografia_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_field_ul_name'][$this->fotografia_ul_name];
          }
      ...
      elseif (isset($this->fotografia_ul_name) && '' != $this->fotografia_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_field_ul_name'][$this->fotografia_ul_name]))
          {
              $this->fotografia_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_field_ul_name'][$this->fotografia_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_orig'] = " where colegio_id = " . $_SESSION['vglo_colegio'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_pesq'] = " where colegio_id = " . $_SESSION['vglo_colegio'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_estudiantes_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_estudiantes_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_estudiantes_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['exit'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_estudiantes_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_estudiantes/form_estudiantes_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_estudiantes_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_estudiantes_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_estudiantes_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_estudiantes/form_estudiantes_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_estudiantes_mob_erro.class.php"); 
      }
      $this->Erro      = new form_estudiantes_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao']))
         { 
             if ($this->colegio_id != "" || $this->estudiante_id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_estudiantes_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['recarga'] = $this->nmgp_opcao;
      }
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_estudiantes_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_estudiantes_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_estudiantes_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_estudiantes_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['codigo_estudiante']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['codigo_estudiante'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if ($this->estatus == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['estatus']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['estatus'] == "on"))
      {
          ...
          if (!empty($this->estatus) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_estatus']) && !in_array($this->estatus, $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_estatus']))
          {
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['primer_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['primer_apellido'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['segundo_apellido']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['segundo_apellido'] == "on")) 
      { 
    ...
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['nombres']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['nombres'] == "on")) 
      { 
          if ($this->nombres == "")  
          { 
    ...
    function ValidateField_sexo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['sexo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['sexo'] == "on")
        { 
          $Campos_Falta[] = "Sexo" ;
    ...
    {
        global $teste_validade;
               if (!empty($this->grado_id) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_grado_id']) && !in_array($this->grado_id, $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_grado_id']))
               {
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_fecha_nacimiento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['fecha_nacimiento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['fecha_nacimiento'] == "on") 
           { 
    ...
    function ValidateField_fecha_ingreso(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['fecha_ingreso']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['php_cmp_required']['fecha_ingreso'] == "on") 
           { 
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_estudiantes_mob_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['colegio_id']['keyVal'] = form_estudiantes_mob_pack_protect_string($this->nmgp_dados_form['colegio_id']);
              $this->NM_ajax_info['fldList']['estudiante_id']['keyVal'] = form_estudiantes_mob_pack_protect_string($this->nmgp_dados_form['estudiante_id']);
              ...
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['grid_padres_estudiantes_script_case_init'] ]['grid_padres_estudiantes']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['grid_padres_estudiantes_script_case_init'] ]['grid_padres_estudiantes']['total']);
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['grid_padres_estudiantes_script_case_init'] ]['grid_padres_estudiantes']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['grid_padres_estudiantes_script_case_init'] ]['grid_padres_estudiantes']['total']);
              }
          }
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_estudiantes_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_estudiantes_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['estatus']['valList'][$i] = form_estudiantes_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_estudiantes_mob_pack_protect_string('M') => form_estudiantes_mob_pack_protect_string("Masculino"));
$aLookup[] = array(form_estudiantes_mob_pack_protect_string('F') => form_estudiantes_mob_pack_protect_string("Femenino"));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_sexo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['Lookup_sexo'][] = 'F';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sexo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['sexo']['valList'][$i] = form_estudiantes_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grado_id']['valList'][$i] = form_estudiantes_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_estudiante_id($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_estudiantes_mob']['contr_erro'] = 'on';
...
;
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_form_estudiantes_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
$_SESSION['scriptcase']['form_estudiantes_mob']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_ex_update = true; 
          $SC_ex_upd_or = true; 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $this->padres_estudiante = $this->padres_estudiante_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['db_changed'] = true;
              ...
              $this->nmgp_refresh_fields = array_diff(array('fotografia', 'usuario', 'codigo_estudiante', 'numero_carnet', 'estatus', 'primer_apellido', 'segundo_apellido', 'nombres', 'sexo', 'grado_id', 'fecha_nacimiento', 'fecha_ingreso', 'direccion_linea1', 'direccion_linea2', 'telefono', 'nombre_padre', 'nombre_madre', 'comentarios', 'padres_estudiante'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['parms'] = "colegio_id?#?$this->colegio_id?@?estudiante_id?#?$this->estudiante_id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_estudiantes_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total'] = $qt_geral_reg_form_estudiantes_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->colegio_id) && !empty($this->estudiante_id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_estudiantes_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] > $qt_geral_reg_form_estudiantes_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] = $qt_geral_reg_form_estudiantes_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['parms'] = "colegio_id?#?$this->colegio_id?@?estudiante_id?#?$this->estudiante_id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['reg_start'] < $qt_geral_reg_form_estudiantes_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['dados_select'];
                  $this->codigo_estudiante = $this->nmgp_dados_select['codigo_estudiante'];  
                  $this->numero_carnet = $this->nmgp_dados_select['numero_carnet'];  
                  $this->estatus = $this->nmgp_dados_select['estatus'];  
                  $this->primer_apellido = $this->nmgp_dados_select['primer_apellido'];  
                  $this->segundo_apellido = $this->nmgp_dados_select['segundo_apellido'];  
                  $this->nombres = $this->nmgp_dados_select['nombres'];  
                  $this->sexo = $this->nmgp_dados_select['sexo'];  
                  $this->fecha_nacimiento = $this->nmgp_dados_select['fecha_nacimiento'];  
                  ...
                  $this->nombre_padre = $this->nmgp_dados_select['nombre_padre'];  
                  $this->nombre_madre = $this->nmgp_dados_select['nombre_madre'];  
                  $this->comentarios = $this->nmgp_dados_select['comentarios'];  
                  $this->usuario = $this->nmgp_dados_select['usuario'];  
                  $this->padres_estudiante = $this->nmgp_dados_select['padres_estudiante'];  
              }
          }
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['foreign_key']))
          {
...
//-- 
      ...
      $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['grid_padres_estudiantes_script_case_init'] ]['grid_padres_estudiantes']['embutida_parms'] = "SC_glo_par_vglo_colegio*scinvglo_colegio*scoutvglo_estudiante*scin" . $this->nmgp_dados_form['colegio_id'] . "*scoutNMSC_cab*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_fotografia))
       {
        ...
        $this->initFormPages();
    include_once("form_estudiantes_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['table_refresh'])
        {
   ...
   function jqueryIconFile($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter_form'] . " and (colegio_id = " . $_SESSION['vglo_colegio'] . ") and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_estudiantes_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['total'] = $qt_geral_reg_form_estudiantes_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_estudiantes_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_estudiantes_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_estudiantes_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_estudiantes_mob']['masterValue']))
{
